...
public class ConsultarMatrizRastreabilidadeRequisito implements InterfaceCommand {
	
	private InterfaceMatrizRastreabilidadeRequisitoDAO matrizRastreabilidadeRequisitoDAO;
	public ConsultarMatrizRastreabilidadeRequisito(InterfaceMatrizRastreabilidadeRequisitoDAO matrizRastreabilidadeRequisitoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - MATRIZ DE RASTREABILIDADE DOS REQUISITOS");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("matrizRastreabilidadeRequisitos", matrizRastreabilidadeRequisitoDAO.getMatrizRastreabilidadeRequisitos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_matriz_rastreabilidade_requisito.jsp";//se não ouver erro, retorne a pagina.
	}
