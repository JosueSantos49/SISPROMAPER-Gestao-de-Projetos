...
public class ConsultarTermoAberturaProjeto implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)throws SQLException {	
			...
			request.setAttribute("titulo", "Consultar - Termo de Abertura do Projeto");//Processamento que será executado pelo comando
		...
		{			
			...
			return "consulta_termo_abertura_projeto.jsp";//se não ouver erro, retorne a pagina.
	}
