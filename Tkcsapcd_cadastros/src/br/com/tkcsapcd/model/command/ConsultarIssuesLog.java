...
public class ConsultarIssuesLog implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - ISSUES LOG (Registro das questões)");//Processamento que será executado pelo comando
			...
			return "consulta_issues_log.jsp";//se não ouver erro, retorne a pagina.
	}
