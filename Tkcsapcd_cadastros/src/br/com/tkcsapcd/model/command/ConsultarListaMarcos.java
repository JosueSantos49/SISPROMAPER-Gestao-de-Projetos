...
public class ConsultarListaMarcos implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Lista dos Marcos");//Processamento que será executado pelo comando
			...
			return "consulta_lista_marcos.jsp";//se não ouver erro, retorne a pagina.
	}
