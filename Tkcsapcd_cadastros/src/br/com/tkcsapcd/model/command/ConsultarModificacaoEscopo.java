...
public class ConsultarModificacaoEscopo implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - SOLICITAÇÃO DE MODIFICAÇÃO DE ESCOPO - ME");//Processamento que será executado pelo comando
			...
			return "consulta_modificacao_escopo.jsp";//se não ouver erro, retorne a pagina.
	}
