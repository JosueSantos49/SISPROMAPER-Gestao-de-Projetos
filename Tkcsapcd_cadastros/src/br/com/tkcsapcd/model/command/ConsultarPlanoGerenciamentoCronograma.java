...
public class ConsultarPlanoGerenciamentoCronograma implements InterfaceCommand {
	
	private InterfacePlanoGerenciamentoCronogramaDAO planoGerenciamentoCronogramaDAO;
	public ConsultarPlanoGerenciamentoCronograma(InterfacePlanoGerenciamentoCronogramaDAO planoGerenciamentoCronogramaDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - PLANO DE GERENCIAMENTO DO CRONOGRAMA");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("planoGerenciamentoCronogramas", planoGerenciamentoCronogramaDAO.getPlanoGerenciamentoCronogramas());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_plano_gerenciamento_cronograma.jsp";//se não ouver erro, retorne a pagina.
	}
