...
public class ConsultarRegistroParteInteressada implements InterfaceCommand {
	
	private InterfaceRegistroParteInteressadaDAO registroParteInteressadaDAO;
	public ConsultarRegistroParteInteressada(InterfaceRegistroParteInteressadaDAO registroParteInteressadaDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - REGISTRO DAS PARTES INTERESSADAS");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("registroParteInteressadas", registroParteInteressadaDAO.getRegistroParteInteressadas());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_registro_parte_interessada.jsp";//se não ouver erro, retorne a pagina.
	}
