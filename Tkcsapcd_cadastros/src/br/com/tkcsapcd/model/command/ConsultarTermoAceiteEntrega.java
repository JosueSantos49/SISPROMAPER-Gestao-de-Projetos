...
public class ConsultarTermoAceiteEntrega implements InterfaceCommand {
	
	private InterfaceTermoAceiteEntregaDAO termoAceiteEntregaDAO;
	public ConsultarTermoAceiteEntrega(InterfaceTermoAceiteEntregaDAO termoAceiteEntregaDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - TERMO DE ACEITE DA ENTREGA");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("termoAceiteEntregas", termoAceiteEntregaDAO.getTermoAceiteEntregas());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_termo_aceite_entrega.jsp";//se não ouver erro, retorne a pagina.
	}
