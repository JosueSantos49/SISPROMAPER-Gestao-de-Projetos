...
public class ConsultarPortfolioProjeto implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Portfólio de Projeto");//Processamento que será executado pelo comando
			...
			return "consulta_portfolio_projeto.jsp";//se não ouver erro, retorne a pagina.
	}
