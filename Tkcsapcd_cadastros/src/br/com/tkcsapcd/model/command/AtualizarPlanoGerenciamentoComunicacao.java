...
public class AtualizarPlanoGerenciamentoComunicacao implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception{
		try {			
					...
					planoGerenciamentoComunicacao.setCodigo(Integer.valueOf(request.getParameter("codigo")));//Necessario, para essa cituação
		...
		if(ValidationHelper.validar(planoGerenciamentoComunicacao)){			
			...
			request.setAttribute("mensagem", "PLANO DE GERENCIAMENTO DAS COMUNICAÇÕES: ("+planoGerenciamentoComunicacao.getCodigoprojeto()+") atualizado com sucesso!");
		}
		else{
			...
			request.setAttribute("titulo", "Atualização - PLANO DE GERENCIAMENTO DAS COMUNICAÇÕES");
