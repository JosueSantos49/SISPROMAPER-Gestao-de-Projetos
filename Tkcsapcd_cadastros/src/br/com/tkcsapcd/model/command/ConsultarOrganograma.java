...
public class ConsultarOrganograma implements InterfaceCommand {
	
	private InterfaceOrganogramaDAO organogramaDAO;
	public ConsultarOrganograma(InterfaceOrganogramaDAO organogramaDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Organograma");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("organogramas", organogramaDAO.getOrganogramas());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_organograma.jsp";//se não ouver erro, retorne a pagina.
	}
