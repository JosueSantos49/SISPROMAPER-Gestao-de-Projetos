...
public class AtualizarLicoesAprendida implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception{
		try {			
					...
					licoesAprendida.setCodigo(Integer.valueOf(request.getParameter("codigo")));//Necessario, para essa cituação
		...
		if(ValidationHelper.validar(licoesAprendida)){			
			...
			request.setAttribute("mensagem", "Lições Aprendidas: ("+licoesAprendida.getCodigoprojeto()+") atualizado com sucesso!");
		}
		else{
