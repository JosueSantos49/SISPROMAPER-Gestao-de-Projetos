...
public class ConsultarPlanoGerenciamentoCusto implements InterfaceCommand {
	
	private InterfacePlanoGerenciamentoCustoDAO planoGerenciamentoCustoDAO;
	public ConsultarPlanoGerenciamentoCusto(InterfacePlanoGerenciamentoCustoDAO planoGerenciamentoCustoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - PLANO DE GERENCIAMENTO DOS CUSTOS");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("planoGerenciamentoCustos", planoGerenciamentoCustoDAO.getPlanoGerenciamentoCustos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_plano_gerenciamento_custo.jsp";//se não ouver erro, retorne a pagina.
	}
