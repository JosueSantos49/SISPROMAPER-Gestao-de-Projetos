...
public class EditarOrganogramaMapaStatus implements InterfaceCommand {

	private InterfaceOrganogramaMapaDAO organogramaMapaDAO;
	public EditarOrganogramaMapaStatus(InterfaceOrganogramaMapaDAO organogramaMapaDAO) {
		super();
	...
	public String execute(HttpServletRequest request,	HttpServletResponse response)throws Exception  {			
			try{						
					if(request.getParameter("codigo") == null)
					{
						...
						return "cadastro_organograma_mapa_status.jsp";
					}
					...
					request.setAttribute("organogramaMapa", organogramaMapaDAO.getOrganogramaMapa(Integer.valueOf(request.getParameter("codigo"))));
						...
						return "consulta_organograma_mapa_status.jsp";
			}
	}
