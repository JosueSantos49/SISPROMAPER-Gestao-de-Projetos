...
public class ConsultarAtributoAtividade implements InterfaceCommand {
	
	private InterfaceAtributoAtividadeDAO atributoAtividadeDAO;
	public ConsultarAtributoAtividade(InterfaceAtributoAtividadeDAO atributoAtividadeDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Atributos das Atividades");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("atributoAtividades", atributoAtividadeDAO.getAtributoAtividades());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_atributo_atividade.jsp";//se não ouver erro, retorne a pagina.
	}
