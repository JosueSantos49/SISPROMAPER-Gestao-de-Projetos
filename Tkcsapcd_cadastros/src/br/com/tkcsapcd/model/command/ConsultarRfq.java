...
public class ConsultarRfq implements InterfaceCommand {
	
	private InterfaceRfqDAO rfqDAO;
	public ConsultarRfq(InterfaceRfqDAO rfqDAO) {
		super();
		this.rfqDAO = rfqDAO;
	}
	@Override
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Pedido de Cotação");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("rfqs", rfqDAO.getRfqs());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_rfq.jsp";//se não ouver erro, retorne a pagina.
	}
