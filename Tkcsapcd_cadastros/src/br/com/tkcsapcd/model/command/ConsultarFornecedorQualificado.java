...
public class ConsultarFornecedorQualificado implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Fornecedor Qualificado");//Processamento que será executado pelo comando
			...
			return "consulta_fornecedor_qualificado.jsp";//se não ouver erro, retorne a pagina.
	}
