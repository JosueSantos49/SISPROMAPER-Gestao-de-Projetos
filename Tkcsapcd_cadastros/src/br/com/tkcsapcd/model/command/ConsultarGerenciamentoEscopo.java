...
public class ConsultarGerenciamentoEscopo implements InterfaceCommand {
	
	private InterfaceGerenciamentoEscopoDAO gerenciamentoEscopoDAO;
	public ConsultarGerenciamentoEscopo(InterfaceGerenciamentoEscopoDAO gerenciamentoEscopoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Gerenciamento do Escopo");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("gerenciamentoEscopos", gerenciamentoEscopoDAO.getGerenciamentoEscopos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_gerenciamento_escopo.jsp";//se não ouver erro, retorne a pagina.
	}
