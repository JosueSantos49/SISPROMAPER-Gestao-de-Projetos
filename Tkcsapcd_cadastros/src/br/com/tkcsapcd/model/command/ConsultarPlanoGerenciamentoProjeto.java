...
public class ConsultarPlanoGerenciamentoProjeto implements InterfaceCommand {
	
	private InterfacePlanoGerenciamentoProjetoDAO planoGerenciamentoProjetoDAO;
	public ConsultarPlanoGerenciamentoProjeto(InterfacePlanoGerenciamentoProjetoDAO planoGerenciamentoProjetoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - PLANO DE GERENCIAMENTO DO PROJETO");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("planoGerenciamentoProjetos", planoGerenciamentoProjetoDAO.getPlanoGerenciamentoProjetos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_plano_gerenciamento_projeto.jsp";//se não ouver erro, retorne a pagina.
	}
