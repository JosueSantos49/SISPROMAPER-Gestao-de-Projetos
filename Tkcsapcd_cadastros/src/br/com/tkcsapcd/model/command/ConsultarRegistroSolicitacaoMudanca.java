...
public class ConsultarRegistroSolicitacaoMudanca implements InterfaceCommand {
	
	private InterfaceRegistroSolicitacaoMudancaDAO registroSolicitacaoMudancaDAO;
	public ConsultarRegistroSolicitacaoMudanca(InterfaceRegistroSolicitacaoMudancaDAO registroSolicitacaoMudancaDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - REGISTRO SOLICITAÇÃO DE MUDANÇA");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("registroSolicitacaoMudancas", registroSolicitacaoMudancaDAO.getRegistroSolicitacaoMudancas());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_registro_solicitacao_mudanca.jsp";//se não ouver erro, retorne a pagina.
	}
