...
public class ConsultarOrganogramaMapa implements InterfaceCommand {
	
	private InterfaceOrganogramaMapaDAO organogramaMapaDAO;
	public ConsultarOrganogramaMapa(InterfaceOrganogramaMapaDAO organogramaMapaDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Organograma Mapa");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("organogramaMapas", organogramaMapaDAO.getOrganogramaMapas());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_organograma_mapa.jsp";//se não ouver erro, retorne a pagina.
	}
