...
public class ConsultarAtaReuniao implements InterfaceCommand {
	
	private InterfaceAtaReuniaoDAO ataReuniaoDAO;
	public ConsultarAtaReuniao(InterfaceAtaReuniaoDAO ataReuniaoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Ata de Reunião");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("ataReuniaos", ataReuniaoDAO.getAtaReuniaos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_ata_reuniao.jsp";//se não ouver erro, retorne a pagina.
	}
