...
public class ConsultarBusinessCase implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - BUSINESS CASE");//Processamento que será executado pelo comando
			...
			return "consulta_business_case.jsp";//se não ouver erro, retorne a pagina.
	}
