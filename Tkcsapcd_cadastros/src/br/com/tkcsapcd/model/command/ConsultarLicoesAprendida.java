...
public class ConsultarLicoesAprendida implements InterfaceCommand {
	
	private InterfaceLicoesAprendidaDAO licoesAprendidaDAO;
	public ConsultarLicoesAprendida(InterfaceLicoesAprendidaDAO licoesAprendidaDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Lições Aprendidas");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("licoesAprendidas", licoesAprendidaDAO.getLicoesAprendidas());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_licoes_aprendida.jsp";//se não ouver erro, retorne a pagina.
	}
