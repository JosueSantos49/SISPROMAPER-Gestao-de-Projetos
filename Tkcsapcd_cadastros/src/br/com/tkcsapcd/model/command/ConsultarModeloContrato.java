...
public class ConsultarModeloContrato implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Adjudicação do contrato de aquisição");//Processamento que será executado pelo comando
			...
			return "consulta_modelo_contrato.jsp";//se não ouver erro, retorne a pagina.
	}
