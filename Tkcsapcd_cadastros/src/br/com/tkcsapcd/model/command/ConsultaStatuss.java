...
public class ConsultaStatuss implements InterfaceCommand {
	
	private InterfaceStatussDAO statussDAO;	
	public ConsultaStatuss(InterfaceStatussDAO statussDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Status");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("statusss", statussDAO.getStatusss());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_statuss.jsp";//se não ouver erro, retorne a pagina.
	}
