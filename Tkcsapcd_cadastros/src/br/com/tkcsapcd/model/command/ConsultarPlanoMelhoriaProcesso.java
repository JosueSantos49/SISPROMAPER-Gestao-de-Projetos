...
public class ConsultarPlanoMelhoriaProcesso implements InterfaceCommand {
	
	private InterfacePlanoMelhoriaProcessoDAO planoMelhoriaProcessoDAO;
	public ConsultarPlanoMelhoriaProcesso(InterfacePlanoMelhoriaProcessoDAO planoMelhoriaProcessoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - PLANO DE MELHORIA PROCESSO");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("planoMelhoriaProcessos", planoMelhoriaProcessoDAO.getPlanoMelhoriaProcessos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_plano_melhoria_processo.jsp";//se não ouver erro, retorne a pagina.
	}
