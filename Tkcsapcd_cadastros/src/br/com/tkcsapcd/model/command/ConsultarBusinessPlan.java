...
public class ConsultarBusinessPlan implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - BUSINESS PLAN");//Processamento que será executado pelo comando
			...
			return "consulta_business_plan.jsp";//se não ouver erro, retorne a pagina.
	}
