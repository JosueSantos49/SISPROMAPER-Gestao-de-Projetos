...
public class ConsultarDiagramaGantt implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Diagrama Gantt");//Processamento que será executado pelo comando
			...
			return "consulta_diagrama_gantt.jsp";//se não ouver erro, retorne a pagina.
	}
