...
public class ConsultarPlanoGerenciamentoRH implements InterfaceCommand {
	
	private InterfacePlanoGerenciamentoRHDAO planoGerenciamentoRHDAO;
	public ConsultarPlanoGerenciamentoRH(InterfacePlanoGerenciamentoRHDAO planoGerenciamentoRHDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - PLANO DE GERENCIAMENTO DOS RERCURSOS HUMANOS");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("planoGerenciamentoRHs", planoGerenciamentoRHDAO.getPlanoGerenciamentoRHs());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_plano_gerenciamento_rh.jsp";//se não ouver erro, retorne a pagina.
	}
