...
public class ConsultarSolicitacaoProjetovBSC implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Solicitação do Projeto - Balanced Scorecard");//Processamento que será executado pelo comando
			...
			return "consulta_solicitacao_projeto_vbsc.jsp";//se não ouver erro, retorne a pagina.
	}
