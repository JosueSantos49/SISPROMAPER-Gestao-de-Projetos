...
public class ConsultarDecisoesComprar implements InterfaceCommand {
	
	private InterfaceDecisoesComprarDAO decisoesComprarDAO;
	public ConsultarDecisoesComprar(InterfaceDecisoesComprarDAO decisoesComprarDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Decisões de Comprar");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("decisoesComprars", decisoesComprarDAO.getDecisoesComprars());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_decisoes_comprar.jsp";//se não ouver erro, retorne a pagina.
	}
