...
public class ConsultarPlanoGerenciamentoQualidade implements InterfaceCommand {
	
	private InterfacePlanoGerenciamentoQualidadeDAO planoGerenciamentoQualidadeDAO;
	public ConsultarPlanoGerenciamentoQualidade(InterfacePlanoGerenciamentoQualidadeDAO planoGerenciamentoQualidadeDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - PLANO DE GERENCIAMENTO DA QUALIDADE");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("planoGerenciamentoQualidades", planoGerenciamentoQualidadeDAO.getPlanoGerenciamentoQualidades());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_plano_gerenciamento_qualidade.jsp";//se não ouver erro, retorne a pagina.
	}
