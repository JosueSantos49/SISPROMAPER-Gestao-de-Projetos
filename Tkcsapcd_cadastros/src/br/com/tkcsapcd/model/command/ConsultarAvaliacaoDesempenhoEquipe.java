...
public class ConsultarAvaliacaoDesempenhoEquipe implements InterfaceCommand {
	
	private InterfaceAvaliacaoDesempenhoEquipeDAO avaliacaoDesempenhoEquipeDAO;
	public ConsultarAvaliacaoDesempenhoEquipe(InterfaceAvaliacaoDesempenhoEquipeDAO avaliacaoDesempenhoEquipeDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - AVALIAÇÃO DO DESEMPENHO DA EQUIPE");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("avaliacaoDesempenhoEquipes", avaliacaoDesempenhoEquipeDAO.getAvaliacaoDesempenhoEquipes());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_avaliacao_desempenho_equipe.jsp";//se não ouver erro, retorne a pagina.
	}
