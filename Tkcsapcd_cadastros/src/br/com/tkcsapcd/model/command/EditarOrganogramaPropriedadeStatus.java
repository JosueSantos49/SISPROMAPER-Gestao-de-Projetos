...
public class EditarOrganogramaPropriedadeStatus implements InterfaceCommand {

	private InterfaceOrganogramaPropriedadeDAO organogramaPropriedadeDAO;
	public EditarOrganogramaPropriedadeStatus(InterfaceOrganogramaPropriedadeDAO organogramaPropriedadeDAO) {
		super();
	...
	public String execute(HttpServletRequest request,	HttpServletResponse response)throws Exception  {			
			try{						
					...
					request.setAttribute("organogramaPropriedade", organogramaPropriedadeDAO.getOrganogramaPropriedade(Integer.valueOf(request.getParameter("codigo"))));
						...
						return "consulta_organograma_propriedade_status.jsp";
			}
	}
