...
public class ConsultarFilebeanProjeto implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - File Projeto");//Processamento que será executado pelo comando
			...
			return "list_projeto.jsp";//se não ouver erro, retorne a pagina.
	}
