...
public class EditarPlanoGerenciamentoParteInteressada implements InterfaceCommand {

	private InterfacePlanoGerenciamentoParteInteressadaDAO planoGerenciamentoParteInteressadaDAO;
	private InterfaceProjetoInicioDAO projetoInicioDAO;
	public EditarPlanoGerenciamentoParteInteressada(InterfacePlanoGerenciamentoParteInteressadaDAO planoGerenciamentoParteInteressadaDAO,
			...
			try{		
				...
				request.setAttribute("projetoInicios", projetoInicioDAO.getProjetoInicios());
					...
					if(request.getParameter("codigo") == null)
					{
						...
						return "cadastro_plano_gerenciamento_parte_interessada.jsp";
					}
					
					//Grande jogada				
					request.setAttribute("planoGerenciamentoParteInteressada", planoGerenciamentoParteInteressadaDAO.getPlanoGerenciamentoParteInteressada(Integer.valueOf(request.getParameter("codigo"))));
						...
						return "atualiza_plano_gerenciamento_parte_interessada.jsp";
			}
	}
