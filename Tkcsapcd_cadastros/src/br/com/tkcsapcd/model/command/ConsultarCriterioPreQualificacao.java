...
public class ConsultarCriterioPreQualificacao implements InterfaceCommand {
	
	private InterfaceCriterioPreQualificacaoDAO criterioPreQualificacaoDAO;
	public ConsultarCriterioPreQualificacao(InterfaceCriterioPreQualificacaoDAO criterioPreQualificacaoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - SELEÇÃO DE FONTE (PRÉ QUALIFICAÇÃO)");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("criterioPreQualificacaos", criterioPreQualificacaoDAO.getCriterioPreQualificacaos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_criterio_pre_qualificacao.jsp";//se não ouver erro, retorne a pagina.
	}
