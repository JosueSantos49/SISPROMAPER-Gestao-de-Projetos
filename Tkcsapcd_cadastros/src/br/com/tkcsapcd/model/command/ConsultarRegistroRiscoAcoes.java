...
public class ConsultarRegistroRiscoAcoes implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - REGISTRO DOS RISCOS AÇÕES");//Processamento que será executado pelo comando
			...
			return "consulta_registro_risco_acoes.jsp";//se não ouver erro, retorne a pagina.
	}
