...
public class ConsultarListaQualidade implements InterfaceCommand {
	
	private InterfaceListaQualidadeDAO listaQualidadeDAO;
	public ConsultarListaQualidade(InterfaceListaQualidadeDAO listaQualidadeDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Lista de Verificação da Qualidade");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("listaQualidades", listaQualidadeDAO.getListaQualidades());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_lista_qualidade.jsp";//se não ouver erro, retorne a pagina.
	}
