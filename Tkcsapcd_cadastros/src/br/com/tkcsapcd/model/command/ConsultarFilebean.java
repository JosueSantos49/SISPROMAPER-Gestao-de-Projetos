...
public class ConsultarFilebean implements InterfaceCommand {
	
	private InterfaceFileBeanDAO fileBeanDAO;
	public ConsultarFilebean(InterfaceFileBeanDAO fileBeanDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - File");//Processamento que será executado pelo comando
			...
			return "list.jsp";//se não ouver erro, retorne a pagina.
	}
