...
public class EditarOrganogramaStatus implements InterfaceCommand {

	private InterfaceOrganogramaDAO organogramaDAO;
	public EditarOrganogramaStatus(InterfaceOrganogramaDAO organogramaDAO) {
		super();
	...
	public String execute(HttpServletRequest request,	HttpServletResponse response)throws Exception  {			
			try{						
					...
					request.setAttribute("organograma", organogramaDAO.getOrganograma(Integer.valueOf(request.getParameter("codigo"))));
						...
						return "consulta_organograma_status.jsp";
			}
	}
