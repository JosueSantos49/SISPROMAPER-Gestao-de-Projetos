...
public class ConsultarTabelaParteInteressada implements InterfaceCommand {
	
	private InterfaceTabelaParteInteressadaDAO tabelaParteInteressadaDAO;
	public ConsultarTabelaParteInteressada(InterfaceTabelaParteInteressadaDAO tabelaParteInteressadaDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Tabela Parte Interessadas");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("tabelaParteInteressadas", tabelaParteInteressadaDAO.getTabelaParteInteressadas());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_tabela_parte_interessada.jsp";//se não ouver erro, retorne a pagina.
	}
