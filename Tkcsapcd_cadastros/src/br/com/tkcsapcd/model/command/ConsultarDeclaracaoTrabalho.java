...
public class ConsultarDeclaracaoTrabalho implements InterfaceCommand {
	
	private InterfaceDeclaracaoTrabalhoDAO declaracaoTrabalhoDAO;
	public ConsultarDeclaracaoTrabalho(InterfaceDeclaracaoTrabalhoDAO declaracaoTrabalhoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - DECLARAÇÃO DE TRABALHO");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("declaracaoTrabalhos", declaracaoTrabalhoDAO.getDeclaracaoTrabalhos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_declaracao_trabalho.jsp";//se não ouver erro, retorne a pagina.
	}
