...
public class ConsultarPlanoGerenciamentoComunicacao implements InterfaceCommand {
	
	private InterfacePlanoGerenciamentoComunicacaoDAO planoGerenciamentoComunicacaoDAO;
	public ConsultarPlanoGerenciamentoComunicacao(InterfacePlanoGerenciamentoComunicacaoDAO planoGerenciamentoComunicacaoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - PLANO DE GERENCIAMENTO DA COMUNICAÇÃO");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("planoGerenciamentoComunicacaos", planoGerenciamentoComunicacaoDAO.getPlanoGerenciamentoComunicacaos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_plano_gerenciamento_comunicacao.jsp";//se não ouver erro, retorne a pagina.
	}
