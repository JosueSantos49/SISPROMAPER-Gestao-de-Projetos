...
public class ConsultarOrganogramaPropriedade implements InterfaceCommand {
	
	private InterfaceOrganogramaPropriedadeDAO organogramaPropriedadeDAO;
	public ConsultarOrganogramaPropriedade(InterfaceOrganogramaPropriedadeDAO organogramaPropriedadeDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Organograma Propriedade");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("organogramaPropriedades", organogramaPropriedadeDAO.getOrganogramaPropriedades());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_organograma_propriedade.jsp";//se não ouver erro, retorne a pagina.
	}
