...
public class ConsultarPlanoGerenciamentoRisco implements InterfaceCommand {
	
	private InterfacePlanoGerenciamentoRiscoDAO planoGerenciamentoRiscoDAO;
	public ConsultarPlanoGerenciamentoRisco(InterfacePlanoGerenciamentoRiscoDAO planoGerenciamentoRiscoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - PLANO DE GERENCIAMENTO DOS RISCOS");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("planoGerenciamentoRiscos", planoGerenciamentoRiscoDAO.getPlanoGerenciamentoRiscos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_plano_gerenciamento_risco.jsp";//se não ouver erro, retorne a pagina.
	}
