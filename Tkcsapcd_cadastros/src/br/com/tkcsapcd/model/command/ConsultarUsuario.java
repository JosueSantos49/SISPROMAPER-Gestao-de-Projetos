...
public class ConsultarUsuario implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Usuário");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("usuarios", usuarioDAO.getUsuarios());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_usuarios.jsp";//se não ouver erro, retorne a pagina.
	}
