...
public class ConsultarFilebeanAjuda implements InterfaceCommand {
	
	private InterfaceFileBeanAjudaDAO fileBeanAjudaDAO;
	public ConsultarFilebeanAjuda(InterfaceFileBeanAjudaDAO fileBeanAjudaDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - File Ajuda");//Processamento que será executado pelo comando
			...
			return "list_ajuda.jsp";//se não ouver erro, retorne a pagina.
	}
