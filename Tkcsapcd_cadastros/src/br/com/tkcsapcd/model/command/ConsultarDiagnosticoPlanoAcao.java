...
public class ConsultarDiagnosticoPlanoAcao implements InterfaceCommand {
	
	private InterfaceDiagnosticoPlanoAcaoDAO diagnosticoPlanoAcaoDAO;
	public ConsultarDiagnosticoPlanoAcao(InterfaceDiagnosticoPlanoAcaoDAO diagnosticoPlanoAcaoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Diagnóstico e Plano de Ação");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("diagnosticoPlanoAcaos", diagnosticoPlanoAcaoDAO.getDiagnosticoPlanoAcaos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_diagnostico_plano_acao.jsp";//se não ouver erro, retorne a pagina.
	}
