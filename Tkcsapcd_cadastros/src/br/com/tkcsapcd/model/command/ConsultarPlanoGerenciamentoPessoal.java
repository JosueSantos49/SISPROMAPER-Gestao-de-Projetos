...
public class ConsultarPlanoGerenciamentoPessoal implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - PLANO DE GERENCIAMENTO DO PESSOAL");//Processamento que será executado pelo comando
			...
			return "consulta_plano_gerenciamento_pessoal.jsp";//se não ouver erro, retorne a pagina.
	}
