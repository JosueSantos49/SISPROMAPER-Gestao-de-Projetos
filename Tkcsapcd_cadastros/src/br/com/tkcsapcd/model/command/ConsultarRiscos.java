...
public class ConsultarRiscos implements InterfaceCommand {
	
	private InterfaceRiscosDAO riscosDAO;
	public ConsultarRiscos(InterfaceRiscosDAO riscosDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Riscos");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("riscoss", riscosDAO.getRiscoss());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_riscos.jsp";//se não ouver erro, retorne a pagina.
	}
