...
public class ConsultarOrcamentoProjeto implements InterfaceCommand {
	
	private InterfaceOrcamentoProjetoDAO orcamentoProjetoDAO;
	public ConsultarOrcamentoProjeto(InterfaceOrcamentoProjetoDAO orcamentoProjetoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Orçamento do projeto");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("orcamentoProjetos", orcamentoProjetoDAO.getOrcamentoProjetos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_orcamento_projeto.jsp";//se não ouver erro, retorne a pagina.
	}
