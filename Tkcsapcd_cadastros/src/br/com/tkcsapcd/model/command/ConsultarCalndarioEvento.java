...
public class ConsultarCalndarioEvento implements InterfaceCommand {
	
	private InterfaceCalendarioEventoDAO calendarioEventoDAO;
	public ConsultarCalndarioEvento(InterfaceCalendarioEventoDAO calendarioEventoDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - Calenário Evento");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("calendarioEventos", calendarioEventoDAO.getCalendarioEventos());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_calendario_evento.jsp";//se não ouver erro, retorne a pagina.
	}
