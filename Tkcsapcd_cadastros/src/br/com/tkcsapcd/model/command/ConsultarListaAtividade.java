...
public class ConsultarListaAtividade implements InterfaceCommand {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - LISTA DAS ATIVIDADES");//Processamento que será executado pelo comando
			...
			return "consulta_lista_atividade.jsp";//se não ouver erro, retorne a pagina.
	}
