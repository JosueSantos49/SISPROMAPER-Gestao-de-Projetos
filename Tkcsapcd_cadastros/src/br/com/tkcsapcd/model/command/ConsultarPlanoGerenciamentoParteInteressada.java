...
public class ConsultarPlanoGerenciamentoParteInteressada implements InterfaceCommand {
	
	private InterfacePlanoGerenciamentoParteInteressadaDAO planoGerenciamentoParteInteressadaDAO;
	public ConsultarPlanoGerenciamentoParteInteressada(InterfacePlanoGerenciamentoParteInteressadaDAO planoGerenciamentoParteInteressadaDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - PLANO DE GERENCIAMENTO DAS PARTES INTERESSADAS");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("planoGerenciamentoParteInteressadas", planoGerenciamentoParteInteressadaDAO.getPlanoGerenciamentoParteInteressadas());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_plano_gerenciamento_parte_interessada.jsp";//se não ouver erro, retorne a pagina.
	}
