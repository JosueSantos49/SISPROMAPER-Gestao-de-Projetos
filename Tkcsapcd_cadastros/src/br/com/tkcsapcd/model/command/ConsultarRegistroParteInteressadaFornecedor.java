...
public class ConsultarRegistroParteInteressadaFornecedor implements InterfaceCommand {
	
	private InterfaceRegistroParteInteressadaFornecedorDAO registroParteInteressadaFornecedorDAO;
	public ConsultarRegistroParteInteressadaFornecedor(InterfaceRegistroParteInteressadaFornecedorDAO registroParteInteressadaFornecedorDAO) {
		super();
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
				...
				request.setAttribute("titulo", "Consultar - REGISTRO DAS PARTES INTERESSADA FORNECEDOR");//Processamento que será executado pelo comando
			...
			try {
				 ...
				 * 
				 */
				request.setAttribute("registroParteInteressadaFornecedors", registroParteInteressadaFornecedorDAO.getRegistroParteInteressadaFornecedors());//atributo recuperado no consulta_statuss.jsp
			...
			return "consulta_registro_parte_interessada_fornecedor.jsp";//se não ouver erro, retorne a pagina.
	}
