...
public class PlanoGerenciamentoQualidadeDAO implements InterfacePlanoGerenciamentoQualidadeDAO{	
	
	@SuppressWarnings("unused")
	private InterfacePool pool;//ProjetoDAO solicita o pool.
	public PlanoGerenciamentoQualidadeDAO(InterfacePool pool) {
		super();
		this.pool = pool;
	}
	@Override
