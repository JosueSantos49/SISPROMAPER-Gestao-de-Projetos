...
<title>Cadastrar Plano de Melhoria de Processo</title>
			...
			<fieldset>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> O Plano de melhorias no processo descreve como analisar os processos e identificar as atividades que agregam valor. Ele é um plano auxiliar do plano de gerenciamento do projeto ou faz parte do Plano de gerenciamento do projeto ou do Plano de gerenciamento da qualidade.
				    </div>
				        ...
				        <div class="modal-dialog">
				            <div class="modal-content">
				                <div class="modal-header">
				                    ...
				                    <h2 class="modal-title">Plano de Melhoria de Processos</h2>
				                </div>
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	O plano de melhorias no processo é um plano auxiliar do plano de gerenciamento do projeto. O plano de melhorias no processo detalha as etapas de análise de processos para identificar as atividades que aumentam o seu valor. <br><br>				                    	
										Saída de: Planejar o gerenciamento da qualidade<br>
										Entrada para: Realizar a garantia da qualidade				                    	
				                    </div>
				                </div>
				...
				<br> <input type="hidden" name="cmd" value="cadastrarPlanoMelhoriaProcesso"></input>
