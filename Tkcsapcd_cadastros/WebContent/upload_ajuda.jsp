...
<title>Upload de Arquivo Ajuda</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000);" >
	...
	<div align="center">
		...
		<form action="uploadAjuda.do" id="formulario" name="formulario" enctype="multipart/form-data" method="post">

			<fieldset>
				<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">UPLOAD DE ARQUIVO AJUDA</font></th></tr></table><br>				
