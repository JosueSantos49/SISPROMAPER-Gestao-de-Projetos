<!-- 
	...
	Ano: 2015
 -->
<%@page import="br.com.tkcsapcd.model.bean.OrganogramaPropriedade"%>
...
<title>Consultar Organograma Propriedade</title>	
...
<div class="container">
		...
		<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<OrganogramaPropriedade> organogramaPropriedades = (List<OrganogramaPropriedade>) request.getAttribute("organogramaPropriedades");
								for (OrganogramaPropriedade organogramaPropriedade : organogramaPropriedades) {
							%>
						<tr>							
							<td><%=organogramaPropriedade.getCodigoprojeto()%></td>
							<td><%=organogramaPropriedade.getData()%></td>
							<td><%=organogramaPropriedade.getDescricao()%></td>
							<td><a 	href='TkcsapcdController?cmd=editarOrganogramaPropriedadeStatus&codigo=<%=organogramaPropriedade.getCodigo()%>'><img
									alt="" title="Consultar Status" height="20" width="27"
									src="img/ok.jpg"></a></td>
							
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarOrganogramaPropriedade&codigo=<%=organogramaPropriedade.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirOrganogramaPropriedade&codigo=<%=organogramaPropriedade.getCodigo()%>'><img
