...
<%@ page import="java.util.List,br.com.tkcsapcd.model.bean.ListaMarcos"%>
<html>
...
<title>Atualizar Lista dos Marcos</title>
...
<script language="javascript" src="js/TexteareListaMarcos.js"></script>
...
<script>
	function show_confirm() {
		...
		if (r == true) {
			...
			location.href = "TkcsapcdController?cmd=consultarListaMarcos";
...
<script type="text/javascript">
	function setFocus() {
		document.getElementById("listaMarcos").focus();
	}
</script>
...
<%@include file="menuperantecssadm.jsp"%>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">LISTA DOS MARCOS</font></th></tr></table><br>				
				<center>
					<h3>
				...
				<br> 
				<input type="hidden" name="cmd" value="atualizarListaMarcos"></input>
				...
				<table border="0" cellspacing="3" cellpadding="3" width="80%" bgcolor="#FFFFFF">
					...
					<tr class="field">
						<td><p align="justify"><b>Lista dos Marcos <font color="red">*</font></b></p>
						<p align="justify">
								<input id="listamarcos" name="listamarcos"
									style="height: 30px; width: 379px" maxlength="150"
									value="${listaMarcos.listamarcos}" class="input" required="true"></input>
							<p class="hint">[Informar Lista dos Marcos.]</p></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="projeto" name="projeto"
									...
									Placeholder=""
									value="${listaMarcos.projeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="codigoprojeto" name="codigoprojeto"
									...
									value="${listaMarcos.codigoprojeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="versao" name="versao"
									...
									value="${listaMarcos.versao}" class="input" required="true"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="data" name="data"
									style="height: 30px; width: 100px"
									value="${listaMarcos.data}" class="input" required="true"
									onkeypress="return numbers(event);"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="autor" name="autor"
									style="height: 30px; width: 379px"
									Placeholder="" 
									value="${listaMarcos.autor}" class="input" required="true"
									onkeypress="return Letras(event);"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="notarevisao" name="notarevisao"
									style="height: 30px; width: 379px"
									Placeholder=""
									value="${listaMarcos.notarevisao}" class="input" required="true"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa1(this.value,400,'spcontando0');contarCaracteresEtapa1(this.value,600,'sprestante0')">${listaMarcos.objetivo}</textarea>
					...
					<tr class="field">
						<td><p align="justify">
								<b>2	Fases - Marcos  <font color="red">*</font></b>
						<p align="justify">
							<font color="blue"></font>
							</p> <textarea id="fases" name="fases" required="true"
								onkeyup="mostrarResultadoEtapa2(this.value,400,'spcontando');contarCaracteresEtapa2(this.value,4000,'sprestante')">${listaMarcos.fases}</textarea>
							<p class="hint">[Identifique para cada fase, seus marcos e sua previsão.]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa19(this.value,400,'spcontando17');contarCaracteresEtapa19(this.value,600,'sprestante17')">${listaMarcos.aprovacao}</textarea>
