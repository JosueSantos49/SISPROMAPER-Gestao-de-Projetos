...
<!-- <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.2/jquery.min.js"></script>Configuracao suir top pagina -->

<%@include file="autocompletar.jsp" %><!-- Configuração autocompletar. Esta configuração esta acessando a servelet mapeada no web.xml buscar -->
...
<!-- Função Zoom da página. Deve ser adicionado um id na div e chamar a função no body da página -->
  ...
  <div class="navbar navbar-fixed-top">
        ...
        <div id="body-container">
			...
			<div id="conteudo"><!-- Tratando o zoo da página. Esta fechando no rodape. -->    
				<div class="container">    
...
<div class="wow fadeInDown top__element" data-wow-delay="1s"><!-- Efeito surgir. Esta fechando no ropadé. -->
