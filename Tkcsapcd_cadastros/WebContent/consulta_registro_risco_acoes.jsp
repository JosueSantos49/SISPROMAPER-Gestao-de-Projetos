...
<%@page import="br.com.tkcsapcd.model.bean.RegistroRiscoAcoes"%>
...
<title>Consultar Registro dos Risco Ações</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Registro dos Risco Ações</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_registro_risco_acoes.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							<th>Registro Risco</th>
							<th>Reg. Risco Ações</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							<%
								List<RegistroRiscoAcoes> registroRiscoAcoess = (List<RegistroRiscoAcoes>) request.getAttribute("registroRiscoAcoess");
								for (RegistroRiscoAcoes registroRiscoAcoes : registroRiscoAcoess) {
							%>
						<tr>							
							<td><%=registroRiscoAcoes.getRegistrorisco().getCodigo()%></td>
							<td><%=registroRiscoAcoes.getRegistroriscoacoes()%></td>
							<td><%=registroRiscoAcoes.getVersao()%></td>
							<td><%=registroRiscoAcoes.getData()%></td>
							<td><%=registroRiscoAcoes.getAutor()%></td>
							<td><%=registroRiscoAcoes.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarRegistroRiscoAcoes&codigo=<%=registroRiscoAcoes.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirRegistroRiscoAcoes&codigo=<%=registroRiscoAcoes.getCodigo()%>'><img
