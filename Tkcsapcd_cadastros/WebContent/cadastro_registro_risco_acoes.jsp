...
<title>Cadastrar Registro dos Risco Ações</title>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscoAcoess()">
			...
			<fieldset>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarRegistroRiscoAcoes"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
								<td><p align="justify"><b>Registro Risco <font color="red">*</font></b>
								<p align="justify">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa6(this.value,1400,'spcontando4');contarCaracteresEtapa6(this.value,1400,'sprestante4')"></textarea>
