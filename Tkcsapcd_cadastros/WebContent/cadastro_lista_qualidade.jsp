...
<%@ page import="java.util.List,br.com.tkcsapcd.model.bean.ListaQualidade"%>
<html>
...
<title>Cadastrar Lista de Qualidade</title>
...
<script language="javascript" src="js/TexteareListaQualidade.js"></script>
...
<script>
	function show_confirm() {
		...
		if (r == true) {
			...
			location.href = "TkcsapcdController?cmd=consultarListaQualidade";
...
<script type="text/javascript">
	function setFocus() {
		document.getElementById("listaQualidade").focus();
	}
</script>
...
<%@include file="menuperantecssadm.jsp"%>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">LISTA DE QUALIDADE</font></th></tr></table><br>				
				
				<!-- Modal explicando o objetivo da transação -->
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        <a href="#" class="close" data-dismiss="alert">&times;</a>
				        <strong>Nota!</strong>A lista de verificação de qualidade é mais conhecida pelo seu termo em inglês, Checklist.
				    </div>
				        ...
				        <div class="modal-dialog">
				            <div class="modal-content">
				                <div class="modal-header">
				                    ...
				                    <h2 class="modal-title">Checklist ou Listas de verificação da qualidade</h2>
				                </div>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarListaQualidade"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						<td><p align="justify"><b>Lista de Qualidade <font color="red">*</font></b></p>
						<p align="justify">
								<input id="listaqualiade" name="listaqualiade"
									style="height: 30px; width: 379px" maxlength="150"
									value="${listaQualidade.listaqualiade}" class="input" required="true"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="projeto" name="projeto"
									...
									Placeholder=""
									value="${listaQualidade.projeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								...
								<!-- <input id="codigoprojeto" name="codigoprojeto"
									...
									Placeholder=""
									value="${listaQualidade.codigoprojeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="versao" name="versao"
									...
									value="${listaQualidade.versao}" class="input" required="true"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="data" name="data"
									style="height: 30px; width: 100px"
									value="${listaQualidade.data}" class="input" required="true"
									onkeypress="return numbers(event);"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="autor" name="autor"
									style="height: 30px; width: 379px"
									Placeholder="" 
									value="${listaQualidade.autor}" class="input" required="true"
									onkeypress="return Letras(event);"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="notarevisao" name="notarevisao"
									style="height: 30px; width: 379px"
									Placeholder=""
									value="${listaQualidade.notarevisao}" class="input" required="true"></input>
					...
					<tr class="field">
						<td><p align="justify">
								<b>Produto ou grupo de produtos <font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="produto" name="produto" required="true"
								onkeyup="mostrarResultadoEtapa1(this.value,500,'spcontando0');contarCaracteresEtapa1(this.value,500,'sprestante0')"></textarea>
							<p class="hint">[Produto ou grupo de produtos]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>Critério de Aceitação <font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[Critério de Aceitação]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>Método de Verificação <font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[Método de Verificação]</p>
							<br>
						<br>
							<h5 align="left">
