...
<title>Atualizar Matriz de Restarbilidade dos Requisitos</title>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				...
				<br> 
				<input type="hidden" name="cmd" value="atualizarMatrizRastreabilidadeRequisito"></input>
				...
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="prioridade" name="prioridade"
									...
									value="${matrizRastreabilidadeRequisito.prioridade}" class="input" required="true"></input>
							<p class="hint">[Prioridade.]</p></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
					...
					<tr class="field">
						<td><p align="justify"><b>Tipo <font color="red">*</font></b></p>
						<p align="justify">
								<input id="tipo" name="tipo"
									style="height: 30px; width: 379px" maxlength="150"
									value="${matrizRastreabilidadeRequisito.tipo}" class="input" required="true"></input>
							<p class="hint">[Tipo.]</p></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa1(this.value,1400,'spcontando0');contarCaracteresEtapa1(this.value,1400,'sprestante0')">${matrizRastreabilidadeRequisito.descricao}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
							<font color="blue"></font>
								...
								onkeyup="mostrarResultadoEtapa2(this.value,1400,'spcontando');contarCaracteresEtapa2(this.value,1400,'sprestante')">${matrizRastreabilidadeRequisito.justificativa}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa3(this.value,1400,'spcontando1');contarCaracteresEtapa3(this.value,1400,'sprestante1')">${matrizRastreabilidadeRequisito.criterio}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="status" name="status"
									style="height: 30px; width: 379px" maxlength="150"
									value="${matrizRastreabilidadeRequisito.status}" class="input" required="true"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa4(this.value,1400,'spcontando2');contarCaracteresEtapa4(this.value,1400,'sprestante2')">${matrizRastreabilidadeRequisito.eap}</textarea>
							<p class="hint">[EAP]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa5(this.value,1400,'spcontando3');contarCaracteresEtapa5(this.value,1400,'sprestante3')">${matrizRastreabilidadeRequisito.comentario}</textarea>
