...
<title>Consultar Registro das Partes Interessadas</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<h5>
					<img src="img/prancheta.jpg" height="40px" width="50px"><font color="grenn"> ${mensagem}</font><br>					 	
				</h5>
			</div>
			...
			<div align="center">
				<p>
					<font color="red">Consultar Registros das Partes Interessadas</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_registro_parte_interessada.jsp"
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							<th>Cód. Projeto</th>
							<th>Desc. Projeto</th>
							<th>Código R. Parte Interessada</th>
							<th>R. Parte Interessada</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							...
							%>
						<tr>							
							<td><%=registroParteInteressada.getProjetoinicio().getCodigoprojeto()%></td>
							<td><%=registroParteInteressada.getProjetoinicio().getProjeto()%></td>
							<td><%=registroParteInteressada.getCodigoparteinteressada()%></td>
							<td><%=registroParteInteressada.getRegistroparteinteressada()%></td>
							<td><%=registroParteInteressada.getVersao()%></td>
							<td><%=registroParteInteressada.getData()%></td>
							<td><%=registroParteInteressada.getAutor()%></td>
							<td><%=registroParteInteressada.getNotarevisao()%></td>
							<td><%=registroParteInteressada.getEmail()%></td>
							<td><%=registroParteInteressada.getCelular()%></td>
							<td><%=registroParteInteressada.getFone()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarRegistroParteInteressada&codigo=<%=registroParteInteressada.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirRegistroParteInteressada&codigo=<%=registroParteInteressada.getCodigo()%>'><img
