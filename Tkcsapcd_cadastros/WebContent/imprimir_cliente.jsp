...
<table border="0" width="1100" align="center" >
		<tr>			
			<td width="350" height="70" align="center">
				...
				<font color="#0404B4"><h3>RELATÓRIO GERAL DE CLIENTE</h3></font>
								<div align="right">
...
<div class="table-responsive">
   <table class="table" id="tableID"> 
    <tr class="info">
      <td><div align="center" class="style6"><a href="imprimir_cliente.jsp?ordenacao=crescente">CÓDIGO</a></div></td>
      <td><div align="center" class="style6"><a href="imprimir_cliente.jsp?ordenacao=alfabetica">NOME</a></div></td>
      <td><div align="center" class="style5"><strong>PROFISSÃO</strong></div></td>
      <td><div align="center" class="style5"><strong>RG</strong></div></td>
      <td><div align="center" class="style5"><strong>CPF</strong></div></td>
      <td><div align="center" class="style5"><strong>CELULAR</strong></div></td>
      <td><div align="center" class="style5"><strong>E-MAIL</strong></div></td>
      <td><div align="center" class="style5"><strong>EMPRESA</strong></div></td>     
    </tr>
    <%
    Connection con = null;
	...
	try
	{
		...
		String sql1 = "select * from cliente LIMIT 30 OFFSET 0"+offset;
		...
		if(request.getParameter("acao") != null)
		{
			...
			st.executeUpdate("delete from cliente where codigo = "+request.getParameter("codigo"));
		}
	...
	<tr class="default">
        ...
        <tr class="success">
          ...
          <td><div align="left"><%=rs.getString("profissao")%></div></td>
          <td><div align="left"><%=rs.getString("rg")%></div></td>
          <td><div align="left"><%=rs.getString("cpf")%></div></td>
	...
	<%
		...
		//Processo Paginação
	    String sqlConta = "select count(*) AS contaRegistros from cliente";
		...
		if(Integer.parseInt(numPagina) > 1){
			...
			out.println("<li><a href=imprimir_cliente.jsp?numpagina="+pagAnterior+"> << Anterior </a></li>");
			out.println("</ul>");
		}			
		for(int i=1;i<=totalPaginas;i++){
			if(i == Integer.parseInt(numPagina))
				...
				out.println("<a href=imprimir_cliente.jsp?numpagina="+i+"></a>");
				out.println("<ul class='pagination'>");
				out.println("<li><a href=imprimir_cliente.jsp?numpagina="+i+">"+ i +"</a></li>");
				out.println("</ul>");
		}											
		int proximaPag;
		if(totalRegistros - (Integer.parseInt(numPagina) * limite) > 0){
			...
			out.println("<ul class='pagination'>");
			out.println("<li><a href=imprimir_cliente.jsp?numpagina="+proximaPag+"> Próxima >> </a></li>");
			out.println("</ul>");
		}
  ...
  <table width="400" border="0">
    <tr>
      <td><div align="center"> <span class="style1 style2 style5">
        ...
        <input type="button" name="imprimir" id="imprimir" value="Impressão em tela" onclick="window.open('imprimir_cliente.jsp')"/>
       <input type="button" name="imprimir" id="imprimir" value="Relatório pop up" onclick="window.open('imprimir_cliente.jsp','relatorio','toolbar=0,scrollbars=1,location=0,directories=0,copyhistory=0,status=0,menubar=0,resizable=0,width=800,height=600,z-lock,screenX=90,screenY=100,Left=100,Top=20')"/>
      </span></div></td>
    </tr>
  </table>
</div>
