...
<%@page import="br.com.tkcsapcd.model.bean.SolicitacaoProjeto"%>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Solicitação do Projeto</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_solicitacao_projeto.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<SolicitacaoProjeto> solicitacaoProjetos = (List<SolicitacaoProjeto>) request.getAttribute("solicitacaoProjetos");
								for (SolicitacaoProjeto solicitacaoProjeto : solicitacaoProjetos) {
							%>
						<tr>							
							<td><%=solicitacaoProjeto.getCodigoprojeto()%></td>
							<td><%=solicitacaoProjeto.getProjeto()%></td>
							<td><%=solicitacaoProjeto.getSolicitacaoprojeto()%></td>
							<td><%=solicitacaoProjeto.getVersao()%></td>
							<td><%=solicitacaoProjeto.getData()%></td>
							<td><%=solicitacaoProjeto.getAutor()%></td>
							<td><%=solicitacaoProjeto.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarSolicitacaoProjeto&codigo=<%=solicitacaoProjeto.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirSolicitacaoProjeto&codigo=<%=solicitacaoProjeto.getCodigo()%>'><img
