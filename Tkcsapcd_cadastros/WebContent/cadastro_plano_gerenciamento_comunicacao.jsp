...
<title>Cadastrar Plano de Gerenciamento das Comunicações</title>
			...
			<fieldset>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> O plano de gerenciamento das comunicações descreve como os processos de comunicação serão gerenciados desde a identificação das partes interessadas até o encerramento do projeto.
				    </div>
				        ...
				        <div class="modal-dialog">
				            <div class="modal-content">
				                <div class="modal-header">
				                    ...
				                    <h2 class="modal-title">Plano de Gerenciamento das Comunicações</h2>
				                </div>
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	O Plano de Gerenciamento das Comunicações é um componente do plano de gerenciamento do projeto baseado nas necessidades de comunicação do projeto.<br><br>
				                    	Deve ser de fácil entendimento e pode incluir, entre outros:
