...
<title>Imprimir Requerimento</title>
...
<table border="0" width="900" align="center" >
		<tr>			
			<td width="350" height="70" align="center">
				...
				<font color="#0404B4"><h3>RELATÓRIO GERAL DE REQUERIMENTO</h3></font>			
			</td>
		</tr>
			<tr>
...
<div class="table-responsive">
   <table class="table" > 
    <tr class="info">
      <td width="124"><div class="style6">NOME</div></td>
      <td width="124"><div class="style5"><strong>DESCRIÇÃO</strong></div></td>
      <td width="95"><div  class="style5"><strong>RESUMO</strong></div></td>
      <td width="95"><div  class="style5"><strong>RQ FUNCIONAL</strong></div></td>
      <td width="95"><div  class="style5"><strong>RQ TECNOLOGICA</strong></div></td>
      <td width="95"><div  class="style5"><strong>RQ STATUS</strong></div></td>
	...
	try
	{
		...
		String sql1 = "select * from requerimento LIMIT 30 OFFSET 0"+offset;
		...
		if(request.getParameter("acao") != null)
		{
			...
			st.executeUpdate("delete from requerimento where codigo = "+request.getParameter("codigo"));
		}
		...
		if(request.getParameter("ordenacao") == null)
			{
				rs = st.executeQuery("select * from requerimento order by nome");
			}
		else if(request.getParameter("ordenacao").equals("crescente"))
			{
				rs = st.executeQuery("select * from requerimento");
			}		
	...
	<tr class="default">
        ...
        <tr class="success">
         	...
         	<td><div align="left"><%=rs.getString("resumo")%></div></td>  
          	<td><div align="left"><%=rs.getString("rqfuncional")%></div></td>  
         	<td><div align="left"><%=rs.getString("rqtecnologico")%></div></td>  
         	<td><div align="left"><%=rs.getString("rqstatus")%></div></td>                    
        </tr>
	...
	<%
		...
		//Processo Paginação
	    String sqlConta = "select count(*) AS contaRegistros from requerimento";
		...
		if(Integer.parseInt(numPagina) > 1){
			...
			out.println("<li><a href=imprimir_requerimento.jsp?numpagina="+pagAnterior+"> << Anterior </a></li>");
			out.println("</ul>");
		}			
		for(int i=1;i<=totalPaginas;i++){
			if(i == Integer.parseInt(numPagina))
				...
				out.println("<a href=imprimir_requerimento.jsp?numpagina="+i+"></a>");
				out.println("<ul class='pagination'>");
				out.println("<li><a href=imprimir_requerimento.jsp?numpagina="+i+">"+ i +"</a></li>");
				out.println("</ul>");
		}											
		int proximaPag;
		if(totalRegistros - (Integer.parseInt(numPagina) * limite) > 0){
			...
			out.println("<ul class='pagination'>");
			out.println("<li><a href=imprimir_requerimento.jsp?numpagina="+proximaPag+"> Próxima >> </a></li>");
			out.println("</ul>");
		}
	...
	<div align="center"><br>
	        <input class="button" type="button" name="imprimir" id="imprimir" value="Imprimir" onclick="window.print();"/>
	        <input class="button" type="button" name="imprimir" id="imprimir" value="Impressão em tela" onclick="window.open('imprimir_requerimento.jsp')"/>
	       <input class="button" type="button" name="imprimir" id="imprimir" value="Relatório pop up" onclick="window.open('imprimir_requerimento.jsp','relatorio','toolbar=0,scrollbars=1,location=0,directories=0,copyhistory=0,status=0,menubar=0,resizable=0,width=800,height=600,z-lock,screenX=90,screenY=100,Left=100,Top=20')"/>
