...
<%@page import="br.com.tkcsapcd.model.bean.MatrizRastreabilidadeRequisito"%>
...
<title>Consultar Matriz de Rastreabilidade dos Requisitos</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<%@include file="menuperantecssadm.jsp"%>
			...
			<div align="center">
				<p>
					<font color="red">Consultar Matriz de Rastreabilidade dos Requisitos</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_matriz_rastreabilidade_requisito.jsp"
					...
					<strong>Relatório..:</strong> <input name="consProjeto" type="text"
						...
						required="true" 
						Placeholder="Código da Matriz!"> <input
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							...
							<th>Status</th>
							<th>Data</th>
							<th>ID requisitos relacionados</th>
							<th>Editar</th>
							<th>Excluir</th>
						</tr>
					</thead>
					<tbody>
							<%
								List<MatrizRastreabilidadeRequisito> matrizRastreabilidadeRequisitos = (List<MatrizRastreabilidadeRequisito>) request.getAttribute("matrizRastreabilidadeRequisitos");
								for (MatrizRastreabilidadeRequisito matrizRastreabilidadeRequisito : matrizRastreabilidadeRequisitos) {
							%>
						<tr>							
							<td><%=matrizRastreabilidadeRequisito.getCodigomatriz()%></td>
							<td><%=matrizRastreabilidadeRequisito.getPrioridade()%></td>
							<td><%=matrizRastreabilidadeRequisito.getTipo()%></td>
							<td><%=matrizRastreabilidadeRequisito.getNome()%></td>
							<td><%=matrizRastreabilidadeRequisito.getSolicitante()%></td>
							<td><%=matrizRastreabilidadeRequisito.getStatus()%></td>
							<td><%=matrizRastreabilidadeRequisito.getData()%></td>
							<td><%=matrizRastreabilidadeRequisito.getId()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarMatrizRastreabilidadeRequisito&codigo=<%=matrizRastreabilidadeRequisito.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirMatrizRastreabilidadeRequisito&codigo=<%=matrizRastreabilidadeRequisito.getCodigo()%>'><img
