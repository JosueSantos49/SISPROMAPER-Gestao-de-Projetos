...
<title>Consultar Plano de Gerenciamento do Projeto</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamento do Projeto</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_gerenciamento_projeto.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							...
							%>
						<tr>							
							<td><%=planoGerenciamentoProjeto.getProjetoinicio().getCodigo()%></td>
							<td><%=planoGerenciamentoProjeto.getProjetoinicio().getCodigoprojeto()%></td>
							<td><%=planoGerenciamentoProjeto.getProjetoinicio().getProjeto()%></td>
							<td><%=planoGerenciamentoProjeto.getPlanogerenciamentoprojeto()%></td>
							<td><%=planoGerenciamentoProjeto.getVersao()%></td>
							<td><%=planoGerenciamentoProjeto.getData()%></td>
							<td><%=planoGerenciamentoProjeto.getAutor()%></td>
							<td><%=planoGerenciamentoProjeto.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoGerenciamentoProjeto&codigo=<%=planoGerenciamentoProjeto.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoGerenciamentoProjeto&codigo=<%=planoGerenciamentoProjeto.getCodigo()%>'><img
