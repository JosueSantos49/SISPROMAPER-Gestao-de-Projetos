...
%>
<head>
<title>Atualizar Organograma Mapa</title>
...
<script id="code">
  ...
  /*Dentro da aspas duplas é possível adicionar comentário na linha do mapa que aparece dentro do conteiner. 
  Também em cada linha do mapa é possível adicionar texto automático.  	
  */
...
<form action="TkcsapcdController" name="formulario" id="formulario" onsubmit="">
	...
	<input type="hidden" name="cmd" value="atualizarOrganogramaMapa"></input>
	...
	<div id="sample">
	    ...
	    Código Projeto:
	    				<select id="codigoprojeto"	name="codigoprojeto" style="width: 379px" class="form-control" required="true">
								<option id="codigoprojeto">${organogramaMapa.codigoprojeto}</option>
								<%
		...
		<br>Data: 		<input id="data" name="data" value="${organogramaMapa.data}" style="width: 379px" value="00/00/0000" class="form-control"><br>	   
		Descrição: 		<input id="descricao" name="descricao" value="${organogramaMapa.descricao}" style="width: 379px" maxlength="300" class="form-control"><br>	
		E-mail:			<br><input type="text" name="para" style="height: 30px; width: 379px" maxlength="150" placeholder="Destinatário" class="form-control">
	    <br>Comentário: <br><textarea id="comentario" name="comentario" rows="10" cols="80" maxlength="5000">${organogramaMapa.comentario}</textarea><br><br>
	    <a href="#" id="mostrar">Exibir conteúdo</a>
	    <a href="#" id="ocultar">Ocultar conteúdo</a>
	    <div id="conteudo">
	    
	    <textarea name="mySavedModel" id="mySavedModel" style="width:100%;height:250px" required="true" class="form-control">${organogramaMapa.mySavedModel}</textarea>	    
	    </div>
	
			<br>
	
				<div class="btn-group">
					<input class="btn btn-success" type="submit" name="gravar" id="gravar" value="Atualizar" onclick=""></input>
				</div>
			</div>
		</div>
	</form>
