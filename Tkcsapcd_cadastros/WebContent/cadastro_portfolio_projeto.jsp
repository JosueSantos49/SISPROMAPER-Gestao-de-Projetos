...
<head>
    ...
    <title>Registrar Portfólio</title>
	...
	<div class="page-header">
		...
		<form action="TkcsapcdController" onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarPortfolioProjeto"></input>
				...
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<p align="justify">
							...
							<select id="codigoprojeto"	name="codigoprojeto" style="width: 150px" class="form-control">
					...
					<tr class="field">
						...
						<p align="justify">	
							<select id="prioridade"	name="prioridade" style="width: 200px" class="form-control">
								<option value=""></option>
					...
					<tr class="field">
						...
						<p align="justify">	
							<select id="fase"	name="fase" style="width: 379px" class="form-control">
								<option value=""></option>
								<option value="Iniciação">Iniciação</option>
								<option value="Plano de Gerenciamento do Projeto">Plano de Gerenciamento do Projeto</option>	
					...
					<tr class="field">
						...
						<p align="justify">	
							<select id="faseatual"	name="faseatual" style="width: 379px" class="form-control">
								<option value=""></option>
								<option value="Iniciação">Iniciação</option>
								<option value="Plano de Gerenciamento do Projeto">Plano de Gerenciamento do Projeto</option>	
								<option value="Execução">Execução</option>	
					...
					<tr class="field">
						...
						<p align="justify">
								...
								<select id="parteinteressada" name="parteinteressada" style="width: 379px" class="form-control">
										<option id="parteinteressada">Selecione</option>
										<%
					...
					<tr class="field">
						...
						<p align="justify">
								...
								<select id="planoprojeto" name="planoprojeto" style="width: 379px" class="form-control">
										<option id="planoprojeto">Selecione</option>
										<%
					...
					<tr class="field">
						...
						<p align="justify">
								...
								<select id="declaracaoescopo" name="declaracaoescopo" style="width: 379px" class="form-control">
										<option id="declaracaoescopo">Selecione</option>
										<%
					...
					<tr class="field">
						...
						<p align="justify">
								...
								<select id="dicionarioeap" name="dicionarioeap" style="width: 379px" class="form-control">
										<option id="dicionarioeap">Selecione</option>
										<%
					...
					<tr class="field">
						...
						<p align="justify">
								...
								<select id="registrorisco" name="registrorisco" style="width: 379px" class="form-control">
										<option id="registrorisco">Selecione</option>
										<%
					...
					<tr class="field">
						...
						<p align="justify">
								...
								<select id="statusreport" name="statusreport" style="width: 379px" class="form-control">
										<option id="statusreport">Selecione</option>
										<%
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa7(this.value,800,'spcontando5');contarCaracteresEtapa7(this.value,800,'sprestante5')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa8(this.value,800,'spcontando6');contarCaracteresEtapa8(this.value,800,'sprestante6')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa9(this.value,800,'spcontando7');contarCaracteresEtapa9(this.value,800,'sprestante7')"></textarea>
							<p class="hint">[EAP]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa10(this.value,800,'spcontando8');contarCaracteresEtapa10(this.value,800,'sprestante8')"></textarea>
				...
				<br>
				<br> 
					<input class="btn btn-success" type="submit" value="Cadastrar" onclick="show_confirm();" onchange="validaCadastrarRiscos();"/>
					<input class="btn btn-success" type="reset" value="Limpar"></input>
			</fieldset>
		</form>
