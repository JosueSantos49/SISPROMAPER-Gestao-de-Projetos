...
<%@page import="br.com.tkcsapcd.model.bean.PlanoGerenciamentoComunicacao"%>
...
<title>Consultar Plano de Gerenciamento das Comunicações</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamento das Comunicações</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_gerenciamento_comunicacao.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<PlanoGerenciamentoComunicacao> planoGerenciamentoComunicacaos = (List<PlanoGerenciamentoComunicacao>) request.getAttribute("planoGerenciamentoComunicacaos");
								for (PlanoGerenciamentoComunicacao planoGerenciamentoComunicacao : planoGerenciamentoComunicacaos) {
							%>
						<tr>							
							<td><%=planoGerenciamentoComunicacao.getCodigoprojeto()%></td>
							<td><%=planoGerenciamentoComunicacao.getProjeto()%></td>
							<td><%=planoGerenciamentoComunicacao.getPlanogerenciamentocomunicacao()%></td>
							<td><%=planoGerenciamentoComunicacao.getVersao()%></td>
							<td><%=planoGerenciamentoComunicacao.getData()%></td>
							<td><%=planoGerenciamentoComunicacao.getAutor()%></td>
							<td><%=planoGerenciamentoComunicacao.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoGerenciamentoComunicacao&codigo=<%=planoGerenciamentoComunicacao.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoGerenciamentoComunicacao&codigo=<%=planoGerenciamentoComunicacao.getCodigo()%>'><img
