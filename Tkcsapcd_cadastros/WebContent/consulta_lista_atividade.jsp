...
<%@page import="br.com.tkcsapcd.model.bean.ListaAtividade"%>
...
<title>Consultar Lista das Atividades</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Lista das Atividades</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_lista_atividade.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<ListaAtividade> listaAtividades = (List<ListaAtividade>) request.getAttribute("listaAtividades");
								for (ListaAtividade listaAtividade : listaAtividades) {
							%>
						<tr>							
							<td><%=listaAtividade.getCodigoprojeto()%></td>
							<td><%=listaAtividade.getProjeto()%></td>
							<td><%=listaAtividade.getListaatividade()%></td>
							<td><%=listaAtividade.getVersao()%></td>
							<td><%=listaAtividade.getData()%></td>
							<td><%=listaAtividade.getAutor()%></td>
							<td><%=listaAtividade.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarListaAtividade&codigo=<%=listaAtividade.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirListaAtividade&codigo=<%=listaAtividade.getCodigo()%>'><img
