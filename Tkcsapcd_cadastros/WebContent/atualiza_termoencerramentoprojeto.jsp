...
<jsp:useBean id="projetotermoencerramento" scope="request" class="br.com.tkcsapcd.model.bean.ProjetoTermoEncerramento"></jsp:useBean><!-- Deve ser importado cada pacote, para resgatar os valores do BD. Ex: Value="" -->
...
<title>Atualizar Termo de Encerramento do Projeto</title>
...
<script type="text/javascript">
	function setFocus() {document.getElementById("nomeprojeto").focus();}
</script>
	...
	<div align="center">
		<form action="TkcsapcdController" id="formulario" name="formulario" onsubmit="validaCadastrarProjetoTermoEncerramento()">
			...
			<fieldset>
				...
				<input type="hidden" name="cmd" value="atualizarProjetoTermoEncerramento"></input>
				...
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">					
					...
					<tr class="field">
						...
						<td><p align="justify">
								<input id="codigoprojeto" name="codigoprojeto"
									style="height: 30px; width: 379px"
									Placeholder="Informe o código do projeto corretamente!"
									value="${projetotermoencerramento.codigoprojeto}" 
									class="input"
									required="true"
					...
					<tr>
						<td><br></td>
						<td>
							<div class="required-asterisk" aria-hidden="true">Atenção: para executar a atualização do Tipo de Projeto deve ser selecionados novamente.</div>
						</td>
					</tr>
					<tr class="field">
						<td><p align="justify">
						...
						<td><p align="justify">
								...
								<font color="red">Valor atual:</font><input id="tipoprojeto"  name="tipoprojeto" value="${projetotermoencerramento.tipoprojeto}"></input>
					...
					<td><br></td>
						<td>
							<div class="required-asterisk" aria-hidden="true">Atenção: para executar a atualização do Status da Conclusão deve ser selecionados novamente.</div>
						</td>
					</tr>
					<tr class="field">
						<td><p align="justify">
								<b>Status da Conclusão <font color="red">*</font></b></td>
						<td><p align="justify">
								...
								<font color="red">Valor atual:</font><input id="tipoprojeto"  name="tipoprojeto" value="${projetotermoencerramento.statusconclusao}"></input>
					...
					<tr class="field">
						<td><p align="justify">
								<b>Objetivo do Projeto <font color="red">*</font></b></td>
						<td><p align="justify">
								<font color="blue"></font>
							</p> <textarea id="objetivoprojeto" name="objetivoprojeto" required="true" onkeyup="mostrarResultadoDescricao(this.value,400,'spcontando0');contarCaracteresDescricao(this.value,400,'sprestante0')">${projetotermoencerramento.objetivoprojeto}</textarea>
					...
					<tr class="field">
						<td><p align="justify"><b>Justificativa <font color="red">*</font></b></td>
						<td><p align="justify"><font color="blue"></font>
							</p> <textarea id="justificativaprojeto" name="justificativaprojeto" required="true" onkeyup="mostrarResultadoJustificativa(this.value,400,'spcontando');contarCaracteresJustificativa(this.value,400,'sprestante')">${projetotermoencerramento.justificativaprojeto}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								<font color="blue"></font>
							</p> <textarea id="resultadoprevisto" name="resultadoprevisto" required="true" onkeyup="mostrarResultadoResultado(this.value,400,'spcontando1');contarCaracteresResultado(this.value,400,'sprestante1')">${projetotermoencerramento.resultadoprevisto}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								<font color="blue"></font>
							</p> <textarea id="detalhamento" name="detalhamento" required="true" onkeyup="mostrarResultadoDetalhamento(this.value,400,'spcontando2');contarCaracteresDetalhamento(this.value,400,'sprestante2')">${projetotermoencerramento.detalhamento}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								<font color="blue"></font>
							</p> <textarea id="analiseefetividade" name="analiseefetividade" required="true" onkeyup="mostrarResultadoEfetividade(this.value,400,'spcontando3');contarCaracteresEfetividade(this.value,400,'sprestante3')">${projetotermoencerramento.analiseefetividade}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								<font color="blue"></font>
							</p> <textarea id="documentacaofisica" name="documentacaofisica" required="true" onkeyup="mostrarResultadoDocumentacao(this.value,400,'spcontando4');contarCaracteresDocumentacao(this.value,400,'sprestante4')">${projetotermoencerramento.documentacaofisica}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								<font color="blue"></font>
							</p> <textarea id="documentacaoeletronica" name="documentacaoeletronica" required="true" onkeyup="mostrarResultadoDocumentacaoeletronica(this.value,400,'spcontando5');contarCaracteresDocumentacaoeletronica(this.value,400,'sprestante5')">${projetotermoencerramento.documentacaoeletronica}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								<font color="blue"></font>
							</p> <textarea id="concideracaocoordenador" name="concideracaocoordenador" required="true" onkeyup="mostrarResultadoCoordenador(this.value,400,'spcontando6');contarCaracteresCoordenador(this.value,400,'sprestante6')">${projetotermoencerramento.concideracaocoordenador}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								<font color="blue"></font>
							</p> <textarea id="concideracaogestor" name="concideracaogestor" required="true" onkeyup="mostrarResultadoGestor(this.value,400,'spcontando7');contarCaracteresGestor(this.value,400,'sprestante7')">${projetotermoencerramento.concideracaogestor}</textarea>
				...
				<br>
				<br> <input class="prev acao" type="submit" value="Atualizar" onclick="show_confirm();" onchange="validaCadastrarProjetoTermoEncerramento();"></input>
