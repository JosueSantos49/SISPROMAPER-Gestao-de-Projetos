...
<title>Consultar Orçamento do Projeto</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<%@include file="menuperantecssadm.jsp"%>
			...
			<div align="center">
				<p>
					<font color="red">Consultar Orçamento do Projeto</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_orcamento_projeto.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<OrcamentoProjeto> orcamentoProjetos = (List<OrcamentoProjeto>) request.getAttribute("orcamentoProjetos");
								for (OrcamentoProjeto orcamentoProjeto : orcamentoProjetos) {
							%>
						<tr>							
							<td><%=orcamentoProjeto.getCodigoprojeto()%></td>
							<td><%=orcamentoProjeto.getProjeto()%></td>
							<td><%=orcamentoProjeto.getOrcamento()%></td>
							<td><%=orcamentoProjeto.getVersao()%></td>
							<td><%=orcamentoProjeto.getData()%></td>
							<td><%=orcamentoProjeto.getAutor()%></td>
							<td><%=orcamentoProjeto.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarOrcamentoProjeto&codigo=<%=orcamentoProjeto.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirOrcamentoProjeto&codigo=<%=orcamentoProjeto.getCodigo()%>'><img
