...
<title>Consultar Relatório de Encerramento do Contrato</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Relatório de Encerramento do Contrato</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_relatorio_encerramento_contrato.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<RelatorioEncerramentoContrato> relatorioEncerramentoContratos = (List<RelatorioEncerramentoContrato>) request.getAttribute("relatorioEncerramentoContratos");
								for (RelatorioEncerramentoContrato relatorioEncerramentoContrato : relatorioEncerramentoContratos) {
							%>
						<tr>							
							<td><%=relatorioEncerramentoContrato.getCodigoprojeto()%></td>
							<td><%=relatorioEncerramentoContrato.getProjeto()%></td>
							<td><%=relatorioEncerramentoContrato.getRelatorio()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarRelatorioEncerramentoContrato&codigo=<%=relatorioEncerramentoContrato.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirRelatorioEncerramentoContrato&codigo=<%=relatorioEncerramentoContrato.getCodigo()%>'><img
