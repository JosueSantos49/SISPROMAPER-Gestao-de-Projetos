...
<%@page import="br.com.tkcsapcd.model.bean.GerenciamentoEscopo"%>
...
<title>Consultar Plano de Gerenciamento do Escopo</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamnto do Escopo</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_gerenciamento_escopo.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<GerenciamentoEscopo> gerenciamentoEscopos = (List<GerenciamentoEscopo>) request.getAttribute("gerenciamentoEscopos");
								for (GerenciamentoEscopo gerenciamentoEscopo : gerenciamentoEscopos) {
							%>
						<tr>							
							<td><%=gerenciamentoEscopo.getProjetoinicio().getCodigo()%></td>
							<td><%=gerenciamentoEscopo.getEmpresa()%></td>
							<td><%=gerenciamentoEscopo.getOrgao()%></td>
							<td><%=gerenciamentoEscopo.getSetor()%></td>
							<td><%=gerenciamentoEscopo.getPrograma()%></td>
							<td><%=gerenciamentoEscopo.getGerente()%></td>
							<td><%=gerenciamentoEscopo.getFuncao()%></td>
							<td><%=gerenciamentoEscopo.getAprovado()%></td>
							<td><%=gerenciamentoEscopo.getVersao()%></td>							
							<td><%=gerenciamentoEscopo.getDataaprovacao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarGerenciamentoEscopo&codigo=<%=gerenciamentoEscopo.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirGerenciamentoEscopo&codigo=<%=gerenciamentoEscopo.getCodigo()%>'><img
