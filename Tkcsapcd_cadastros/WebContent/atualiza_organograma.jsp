...
<!DOCTYPE html>
<%@ page import="java.util.List,br.com.tkcsapcd.model.bean.Organograma"%>
<html>
...
%>
<head>
<title>Atualizar Organograma</title>
...
<script id="code">
  ...
  // Mostre o modelo do diagrama em formato JSON
  function save() {
...
<form class="rounded" name="formulario" id="formulario" action="TkcsapcdController">
	...
	<input type="hidden" name="cmd" value="atualizarOrganograma"></input>	
	      ...
	      <b>
	  		...
	  		<div class="container">
				  ...
				  <div>
				    ...
				    Data: 			<input id="data" name="data" value="${organograma.data}" onkeypress="return numbers(event);" class="form-control" style="width: 379px"><br>
					Descrição: 		<input id="descricao" name="descricao" value="${organograma.descricao}" style="width: 379px" maxlength="300" class="form-control" style="width: 379px"><br>	 
					E-mail:			<input type="text"  name="para" style="width: 379px" autocomplete="off" placeholder="E-mail" class="form-control">	   
				    <br>Comentário: <br><textarea id="comentario" name="comentario" rows="10" cols="80" maxlength="5000" class="form-control">${organograma.comentario}</textarea><br><br>
				    <a href="#" id="mostrar">Exibir conteúdo</a>
				    <a href="#" id="ocultar">Ocultar conteúdo</a>
				    <div id="conteudo">
				    <textarea name="mySavedModel" id="mySavedModel" style="width:100%;height:250px" class="form-control">${organograma.mySavedModel}</textarea>
			    </div>
			  </div>		
			<br>
