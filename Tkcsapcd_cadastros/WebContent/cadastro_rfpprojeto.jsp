...
<title>Cadastrar RFP Projeto</title>

<link rel="stylesheet" href="bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" href="bootstrap/css/estilos.css">

<link href="css/style1.css" rel="stylesheet" type="text/css"/>
<link rel="stylesheet" href="css/botao.css"><!-- Formatação do botão vermelho -->
...
<br><div class="resp"></div><!-- Resposta do Ajax -->

<div align="center"><center><h3><font color="green">${mensagem}</font></h3></center></div>

<form action="TkcsapcdController" id="formulario"	name="formulario" enctype="multipart/form-data" onsubmit="validaCadastrarRfpProjeto()">
		...
		<input type="hidden" name="cmd" value="cadastrarRfpProjeto"></input>		
		
		<fieldset>	
		
		<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">SOLICITAÇÃO DE PROPOSTA - RFP</font></th></tr></table><br>				
		...
		<div align="left"><p><font color="red">Com este RFP solicitamos informações sobre sua empresa e seus produtos / serviços. As mesmas informações serão recolhidas a partir de diferentes empresas e será usado para avaliar o que os fornecedores que irá acompanhar o processo de terceirização.</font></p></div>
			...
			<table	border="0" cellspacing="3" cellpadding="3" width="100%" bgcolor="#FFFFFF">							
							...
							<tr class="field">
								...
								<!-- <input id="codigoProjeto" name="codigoProjeto" class="input"
							...
							<tr class="field">
								<td><p align="justify"><b>Telefone Celular <font color="red">*</font></b></td>
							...
							<tr class="field">
								...
								<td><p align="justify"><input id="numero" name="numero"
									style="height: 30px; width: 150px" class="input" onkeypress="return numbers(event);" value="${rfpprojeto.numero}" required="true" maxlength="10"></input>
							...
							<tr class="field">
								...
								<td><p align="justify"><input id="cep" name="cep"
									style="height: 30px; width: 130px" class="input" value="${rfpprojeto.cep}" onkeypress="return numbers(event);" maxlength="8"></input>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font>
							 		<textarea  id="historicoempresa" name="historicoempresa" onkeyup="mostrarResultadoHistorico(this.value,200,'spcontando0');contarCaracteresHistorico(this.value,200,'sprestante0')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font>
							 		<textarea  id="produtoempresa" name="produtoempresa" onkeyup="mostrarObjetivoProduto(this.value,200,'spcontando1');contarCaracteresObjetivoProduto(this.value,200,'sprestante1')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="mercadoempresa" name="mercadoempresa" onkeyup="mostrarResultadoDescricaoMercado(this.value,200,'spcontando3');contarCaracteresDescricaoMercado(this.value,200,'sprestante3')" required="true"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="valoresempresa" name="valoresempresa" onkeyup="mostrarResultadoValor(this.value,200,'spcontando4');contarCaracteresValor(this.value,200,'sprestante4')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="aquisicao" name="aquisicao" onkeyup="mostrarResultadoAquisicao(this.value,200,'spcontando5');contarCaracteresAquisicao(this.value,200,'sprestante5')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="escopo" name="escopo" onkeyup="mostrarResultadoEscopo(this.value,200,'spcontando6');contarCaracteresEscopo(this.value,200,'sprestante6')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="restricao" name="restricao" onkeyup="mostrarResultadoRestricao(this.value,200,'spcontando7');contarCaracteresRestricao(this.value,200,'sprestante7')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="recurso" name="recurso" onkeyup="mostrarResultadoRecurso(this.value,200,'spcontando8');contarCaracteresRecurso(this.value,200,'sprestante8')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="avaliacao" name="avaliacao" onkeyup="mostrarResultadoAvaliacao(this.value,200,'spcontando9');contarCaracteresAvaliacao(this.value,200,'sprestante9')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="cronograma" name="cronograma" onkeyup="mostrarResultadoCronograma(this.value,200,'spcontando10');contarCaracteresCronograma(this.value,200,'sprestante10')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="proposta" name="proposta" onkeyup="mostrarResultadoProposta(this.value,200,'spcontando11');contarCaracteresProposta(this.value,200,'sprestante11')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="condicaoproposta" name="condicaoproposta" onkeyup="mostrarResultadoCondicaoproposta(this.value,200,'spcontando12');contarCaracteresCondicaoproposta(this.value,200,'sprestante12')"></textarea>
							...
							<tr class="field" >
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="observacao" name="observacao" onkeyup="mostrarResultadoObservacao(this.value,200,'spcontando13');contarCaracteresObservacao(this.value,200,'sprestante13')"></textarea>
					...
					<input type="button" name="prev" class="prev acao" value="Anterior"  onchange="validaCadastrarRfpProjeto()" onclick="validaCadastrarRfpProjeto()">
					<input class="acao" type="submit" value="Enviar"  onclick="show_confirm()" onchange="validaCadastrarRfpProjeto()" onclick="validaCadastrarRfpProjeto()"></input><!--  -->
