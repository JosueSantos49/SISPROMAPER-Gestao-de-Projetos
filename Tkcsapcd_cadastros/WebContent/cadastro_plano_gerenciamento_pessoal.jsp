...
<%@ page import="java.util.List,br.com.tkcsapcd.model.bean.PlanoGerenciamentoPessoal"%>
<html>
...
<title>Cadastrar Plano de Gerenciamento do Pessoal</title>
...
<script language="javascript" src="js/TexteareCadastroPlanoGerePessoal.js"></script>
...
<script>
	function show_confirm() {
		...
		if (r == true) {
			...
			location.href = "TkcsapcdController?cmd=consultarPlanoGerenciamentoPessoal";
...
<%@include file="menuperantecssadm.jsp"%>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">PLANO DE GRENCIAMENTO DO PESSOAL</font></th></tr></table><br>				
				<center>
					<h3>
				...
				<br> <input type="hidden" name="cmd" value="cadastrarPlanoGerenciamentoPessoal"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="90%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						<td><p align="justify"><b>Plano de Gerenciamento do Pessoal <font color="red">*</font></b></p>
						<p align="justify">
								<input id="planogerenciamentopessoal" name="planogerenciamentopessoal"
									style="height: 30px; width: 379px" maxlength="150"
									value="${planoGerenciamentoPessoal.planogerenciamentopessoal}" class="input" required="true"></input>
							<p class="hint">[Informar o Plano de Gerenciamento do Pessoal.]</p></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="projeto" name="projeto"
									...
									Placeholder=""
									value="${planoGerenciamentoPessoal.projeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="versao" name="versao"
									...
									value="${planoGerenciamentoPessoal.versao}" class="input" required="true"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="data" name="data"
									style="height: 30px; width: 100px"
									value="${planoGerenciamentoPessoal.data}" class="input" required="true"
									onkeypress="return numbers(event);"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="autor" name="autor"
									style="height: 30px; width: 379px"
									Placeholder="" 
									value="${planoGerenciamentoPessoal.autor}" class="input" required="true"
									onkeypress="return Letras(event);"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="notarevisao" name="notarevisao"
									style="height: 30px; width: 379px"
									Placeholder=""
									value="${planoGerenciamentoPessoal.notarevisao}" class="input" required="true"></input>
					...
					<tr class="field">
						<td><p align="justify"><b>1.1 Recrutamento e Seleção <font color="red">*</font></b><br>
						<p align="justify">	<font color="blue"></font></p>
							<textarea id="pergunta1" name="pergunta1" required="true" onkeyup="mostrarResultadoEtapa1(this.value,500,'spcontando0');contarCaracteresEtapa1(this.value,500,'sprestante0')"></textarea>
							<p class="hint">[descreva as fontes internas e/ou externas de recrutamento e as técnicas de seleção que serão utilizadas no projeto. O local de trabalho onde o contratado irá trabalhar, os beneficios previstos, a remuneração e qual a participação e que área de RH da empresa poderá oferecer à equipe de gerenciamento de projetos]</p>
							<br><br>
					...
					<tr class="field">
						<td><p align="justify">
								<b>1.2 Tabelas de horários <font color="red">*</font></b><br>
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="pergunta2" name="pergunta2" required="true" onkeyup="mostrarResultadoEtapa2(this.value,500,'spcontando');contarCaracteresEtapa2(this.value,500,'sprestante')"></textarea>
							<p class="hint">[citar e descrever os horários disponíveis para os membros da equipe de projeto, tanto individual quanto coletivamente, bem como definir quando as atividades de recrutamento e seleção devem ser iniciadas]</p>
							<br><br>
					...
					<tr class="field">
						<td><p align="justify">
								<b>1.3 Critérios de liberação <font color="red">*</font></b><br>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[definir o método e o momento em que cada membro deve ser liberado. Isto facilita a realocação em outro projeto ou em outra área da empresa e aumenta a eficiência do projeto]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>1.4 Necessidades de treinamento<font color="red">*</font></b><br>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[definir como a equipe poderia ser ajudada a obter certificações que beneficiaram o projeto e como uma competência específica poderia ser desenvolvida]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>1.5 Reconhecimento e premiações <font color="red">*</font></b><br>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[definir critérios claros de premiações como incentivos aos participantes. Lembramos que incentivos são diretamente ligados aos resultados obtidos, tais como redução de custos, entregas no prazo, decisões que afetam a qualidade das entregas etc]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>1.6 Segurança <font color="red">*</font></b><br>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[definir políticas e procedimentos de segurança que devem ser seguidas pela equipe]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>1.7 Informações complementares  <font color="red">*</font></b><br>
							<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[poderá apresentar o organograma do projeto, uma lista de recursos humanos disponíveis e a contratar, a matriz de responsabilidades, o quadro de horários e das Normas e Políticas de Recursos Humanos]</p>
							<br>
						<br>
							<h5 align="left">
