...
<%@page import="br.com.tkcsapcd.model.bean.PlanoGerenciamentoPessoal"%>
...
<title>Consultar Plano de Gerenciamento do Pessoal</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamento do Pessoal</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_gerenciamento_pessoal.jsp"
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							...
							<th>Plano Gerenciamento Pessoal</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							<%
								List<PlanoGerenciamentoPessoal> planoGerenciamentoPessoals = (List<PlanoGerenciamentoPessoal>) request.getAttribute("planoGerenciamentoPessoals");
								for (PlanoGerenciamentoPessoal planoGerenciamentoPessoal : planoGerenciamentoPessoals) {
							%>
						<tr>							
							<td><%=planoGerenciamentoPessoal.getCodigoprojeto()%></td>
							<td><%=planoGerenciamentoPessoal.getProjeto()%></td>
							<td><%=planoGerenciamentoPessoal.getPlanogerenciamentopessoal()%></td>
							<td><%=planoGerenciamentoPessoal.getVersao()%></td>
							<td><%=planoGerenciamentoPessoal.getData()%></td>
							<td><%=planoGerenciamentoPessoal.getAutor()%></td>
							<td><%=planoGerenciamentoPessoal.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoGerenciamentoPessoal&codigo=<%=planoGerenciamentoPessoal.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoGerenciamentoPessoal&codigo=<%=planoGerenciamentoPessoal.getCodigo()%>'><img
