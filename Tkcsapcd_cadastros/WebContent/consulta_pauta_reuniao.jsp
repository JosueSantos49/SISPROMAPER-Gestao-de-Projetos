...
<%@page import="br.com.tkcsapcd.model.bean.PautaReuniao"%>
...
<title>Consultar Pauta de Reunião</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<%@include file="menuperantecssadm.jsp"%>
			...
			<div align="center">
				<p>
					<font color="red">Consultar Pauta de Reunião</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_pauta_reuniao.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<PautaReuniao> pautaReuniaos = (List<PautaReuniao>) request.getAttribute("pautaReuniaos");
								for (PautaReuniao pautaReuniao : pautaReuniaos) {
							%>
						<tr>							
							<td><%=pautaReuniao.getCodigoprojeto()%></td>
							<td><%=pautaReuniao.getProjeto()%></td>
							<td><%=pautaReuniao.getPautareuniao()%></td>
							<td><%=pautaReuniao.getLocal()%></td>
							<td><%=pautaReuniao.getData()%></td>							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPautaReuniao&codigo=<%=pautaReuniao.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPautaReuniao&codigo=<%=pautaReuniao.getCodigo()%>'><img
