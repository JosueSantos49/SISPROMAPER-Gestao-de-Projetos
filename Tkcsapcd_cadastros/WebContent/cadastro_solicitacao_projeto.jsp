...
<title>Cadastrar Solicitação do Projeto</title>
			...
			<fieldset>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> Classificar o projeto dentro do portfólio de projetos.
				    </div>
				...
				<br> <input type="hidden" name="cmd" value="cadastrarSolicitacaoProjeto"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="90%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<p align="justify">	<font color="blue"></font></p>
							<textarea id="objetivo" name="objetivo" required="true" onkeyup="mostrarResultadoEtapa1(this.value,600,'spcontando0');contarCaracteresEtapa1(this.value,600,'sprestante0')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
							...
							</p> <textarea id="atual" name="atual" required="true" onkeyup="mostrarResultadoEtapa2(this.value,600,'spcontando');contarCaracteresEtapa2(this.value,600,'sprestante')"></textarea>
