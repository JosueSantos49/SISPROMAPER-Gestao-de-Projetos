...
<%@page import="br.com.tkcsapcd.model.bean.PlanoGerenciamentoRisco"%>
...
<title>Consultar Plano de Gerenciamento dos Riscos</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamento dos Riscos</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_gerenciamento_risco.jsp"
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							...
							<th>Plano Gerenciamento Risco</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							<%
								List<PlanoGerenciamentoRisco> planoGerenciamentoRiscos = (List<PlanoGerenciamentoRisco>) request.getAttribute("planoGerenciamentoRiscos");
								for (PlanoGerenciamentoRisco planoGerenciamentoRisco : planoGerenciamentoRiscos) {
							%>
						<tr>							
							<td><%=planoGerenciamentoRisco.getCodigoprojeto()%></td>
							<td><%=planoGerenciamentoRisco.getProjeto()%></td>
							<td><%=planoGerenciamentoRisco.getPlanogerenciamentorisco()%></td>
							<td><%=planoGerenciamentoRisco.getVersao()%></td>
							<td><%=planoGerenciamentoRisco.getData()%></td>
							<td><%=planoGerenciamentoRisco.getAutor()%></td>
							<td><%=planoGerenciamentoRisco.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoGerenciamentoRisco&codigo=<%=planoGerenciamentoRisco.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoGerenciamentoRisco&codigo=<%=planoGerenciamentoRisco.getCodigo()%>'><img
