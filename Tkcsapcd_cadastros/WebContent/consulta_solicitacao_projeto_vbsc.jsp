...
<title>Consultar Solicitação do Projeto vBSC</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Solicitação do Projeto vBSC</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_solicitacao_projeto_vbsc.jsp"
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							...
							<th>Solicitação Projeto vBSC</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							<%
								List<SolicitacaoProjetovBSC> solicitacaoProjetovBSCs = (List<SolicitacaoProjetovBSC>) request.getAttribute("solicitacaoProjetovBSCs");
								for (SolicitacaoProjetovBSC solicitacaoProjetovBSC : solicitacaoProjetovBSCs) {
							%>
						<tr>							
							<td><%=solicitacaoProjetovBSC.getCodigoprojeto()%></td>
							<td><%=solicitacaoProjetovBSC.getProjeto()%></td>
							<td><%=solicitacaoProjetovBSC.getSolicitacaoprojetovbsc()%></td>
							<td><%=solicitacaoProjetovBSC.getVersao()%></td>
							<td><%=solicitacaoProjetovBSC.getData()%></td>
							<td><%=solicitacaoProjetovBSC.getAutor()%></td>
							<td><%=solicitacaoProjetovBSC.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarSolicitacaoProjetovBSC&codigo=<%=solicitacaoProjetovBSC.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirSolicitacaoProjetovBSC&codigo=<%=solicitacaoProjetovBSC.getCodigo()%>'><img
