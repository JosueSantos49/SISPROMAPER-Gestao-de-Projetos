...
<%@page import="br.com.tkcsapcd.model.bean.Stakeholders"%>
...
<title>Consultar Stakeholders</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Stakeholders</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_stakeholders.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<Stakeholders> stakeholderss = (List<Stakeholders>) request.getAttribute("stakeholderss");
								for (Stakeholders stakeholders : stakeholderss) {
							%>
						<tr>							
							<td><%=stakeholders.getCodigoprojeto()%></td>
							<td><%=stakeholders.getEmpresa()%></td>
							<td><%=stakeholders.getOrgao()%></td>
							<td><%=stakeholders.getSetor()%></td>
							<td><%=stakeholders.getPrograma()%></td>
							<td><%=stakeholders.getProjeto()%></td>
							<td><%=stakeholders.getGerente()%></td>
							<td><%=stakeholders.getFuncao()%></td>
							<td><%=stakeholders.getAprovado()%></td>
							<td><%=stakeholders.getVersao()%></td>							
							<td><%=stakeholders.getDataaprovacao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarStakeholders&codigo=<%=stakeholders.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirStakeholders&codigo=<%=stakeholders.getCodigo()%>'><img
