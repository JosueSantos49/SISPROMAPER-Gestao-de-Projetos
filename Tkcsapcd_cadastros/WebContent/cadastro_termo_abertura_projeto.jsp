...
<title>Cadastrar Termo de Abertura do Projeto</title>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario" onsubmit="validaCadastrarProjeto()">
			...
			<fieldset>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarTermoAberturaProjeto"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								falsamente os dados preenchidos. <input id="concordo"
									name="concordo" type="checkbox" value="C" />
				...
				<br>
				<br> <input class="prev acao" type="submit" value="Cadastrar" onclick="show_confirm();" onchange="validaCadastrarProjeto();"></input>
