				        ...
				        <div class="col-md-10">                             
				          <div class="ajax" style="position: relative; overflow: hidden">            
							...
							Olá, 
								...
								%>
								 você pode envolver pessoas em projetos de forma fácil e prática. É permitido adicionar até seis (6) pessoas em cada registro. Outra transação <strong><a href="consulta_transacao.jsp" target="_parent">Clique aqui!</a></strong> 
							</div>
