...
<%@page import="br.com.tkcsapcd.model.bean.PlanoGerenciamentoCusto"%>
...
<title>Consultar Plano de Gerenciamento dos Custos</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamento dos Custos</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_gerenciamento_custo.jsp"
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							...
							<th>Plano Gerenciamento Custo</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							<%	
								List<PlanoGerenciamentoCusto> planoGerenciamentoCustos = (List<PlanoGerenciamentoCusto>) request.getAttribute("planoGerenciamentoCustos");
								for (PlanoGerenciamentoCusto planoGerenciamentoCusto : planoGerenciamentoCustos) {
							%>
						<tr>							
							<td><%=planoGerenciamentoCusto.getCodigoprojeto()%></td>
							<td><%=planoGerenciamentoCusto.getProjeto()%></td>
							<td><%=planoGerenciamentoCusto.getPlanogerenciamentocusto()%></td>
							<td><%=planoGerenciamentoCusto.getVersao()%></td>
							<td><%=planoGerenciamentoCusto.getData()%></td>
							<td><%=planoGerenciamentoCusto.getAutor()%></td>
							<td><%=planoGerenciamentoCusto.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoGerenciamentoCusto&codigo=<%=planoGerenciamentoCusto.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoGerenciamentoCusto&codigo=<%=planoGerenciamentoCusto.getCodigo()%>'><img
