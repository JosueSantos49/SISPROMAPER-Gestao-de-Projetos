...
<title>Cadastrar Declaração Escopo</title>
			...
			<fieldset>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> A Declaração do escopo do projeto, ou especificação do escopo do projeto, é essencial para o sucesso do projeto, pois, descreve as entregas do projeto e o trabalho necessário para criá-las.
				    </div>
				        ...
				        <div class="modal-dialog">
				            <div class="modal-content">
				                <div class="modal-header">
				                    ...
				                    <h2 class="modal-title">Declaração do escopo do projeto</h2>
				                </div>
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	Desenvolvida a partir das principais entregas, do termo de abertura, dos requisitos, premissas e restrições.<br><br>
										
										Saída de: Definir o escopo<br><br>
										Entrada para: <br>										
										Criar a EAP <br>
				...
				<br> <input type="hidden" name="cmd" value="cadastrarDeclaracaoescopo"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="100%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<td><p align="justify">
							...
							<p class="hint">[Citar a razão pela qual o projeto é necessário, os objetivos estratégicos associados, e os benefícios que o projeto trará.]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa12(this.value,200,'spcontando10');contarCaracteresEtapa12(this.value,200,'sprestante10')"></textarea>
