...
<title>Cadastrar Diagnóstico e Plano de Ação</title>
			...
			<fieldset>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> O Diagnóstico e Plano de Ação tem como objetivo apresentar os pontos e problemas levantados, suas principais causas e um plano de ação para a solução dos mesmos.
				    </div>
				        ...
				        <div class="modal-dialog">
				            <div class="modal-content">
				                <div class="modal-header">
				                    ...
				                    <h2 class="modal-title"> Diagnóstico e Plano de Ação</h2>
				                </div>
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	O Diagnóstico e Plano de Ação tem como objetivo apresentar os pontos e problemas levantados, suas principais causas e um plano de ação para a solução dos mesmos.
				                    </div>
				                </div>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarDiagnosticoPlanoAcao"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa1(this.value,650,'spcontando0');contarCaracteresEtapa1(this.value,650,'sprestante0')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
							<font color="blue"></font>
								...
								onkeyup="mostrarResultadoEtapa2(this.value,650,'spcontando');contarCaracteresEtapa2(this.value,650,'sprestante')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa3(this.value,650,'spcontando1');contarCaracteresEtapa3(this.value,650,'sprestante1')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa4(this.value,650,'spcontando2');contarCaracteresEtapa4(this.value,650,'sprestante2')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa5(this.value,650,'spcontando3');contarCaracteresEtapa5(this.value,650,'sprestante3')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa6(this.value,650,'spcontando4');contarCaracteresEtapa6(this.value,650,'sprestante4')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa7(this.value,650,'spcontando5');contarCaracteresEtapa7(this.value,650,'sprestante5')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa8(this.value,650,'spcontando6');contarCaracteresEtapa8(this.value,650,'sprestante6')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa9(this.value,650,'spcontando7');contarCaracteresEtapa9(this.value,650,'sprestante7')"></textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa19(this.value,650,'spcontando17');contarCaracteresEtapa19(this.value,650,'sprestante17')"></textarea>
