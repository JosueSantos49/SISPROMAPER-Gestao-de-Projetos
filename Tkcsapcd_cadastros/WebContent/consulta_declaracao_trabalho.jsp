...
<%@page import="br.com.tkcsapcd.model.bean.DeclaracaoTrabalho"%>
...
<title>Consultar Declaração de Trabalho</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Declaração de Trabalho</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_declaracao_trabalho.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<DeclaracaoTrabalho> declaracaoTrabalhos = (List<DeclaracaoTrabalho>) request.getAttribute("declaracaoTrabalhos");
								for (DeclaracaoTrabalho declaracaoTrabalho : declaracaoTrabalhos) {
							%>
						<tr>							
							<td><%=declaracaoTrabalho.getCodigoprojeto()%></td>
							<td><%=declaracaoTrabalho.getProjeto()%></td>
							<td><%=declaracaoTrabalho.getDeclaracaotrabalho()%></td>
							<td><%=declaracaoTrabalho.getVersao()%></td>
							<td><%=declaracaoTrabalho.getData()%></td>
							<td><%=declaracaoTrabalho.getAutor()%></td>
							<td><%=declaracaoTrabalho.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarDeclaracaoTrabalho&codigo=<%=declaracaoTrabalho.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirDeclaracaoTrabalho&codigo=<%=declaracaoTrabalho.getCodigo()%>'><img
