...
<%@page import="br.com.tkcsapcd.model.bean.CriterioPreQualificacao"%>
...
<title>Consultar Seleção Fonte (Pré-qualificação)</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Seleção Fonte (Pré-qualificação)</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_criterio_pre_qualificacao.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<CriterioPreQualificacao> criterioPreQualificacaos = (List<CriterioPreQualificacao>) request.getAttribute("criterioPreQualificacaos");
								for (CriterioPreQualificacao criterioPreQualificacao : criterioPreQualificacaos) {
							%>
						<tr>							
							<td><%=criterioPreQualificacao.getCodigoprojeto()%></td>
							<td><%=criterioPreQualificacao.getProjeto()%></td>
							<td><%=criterioPreQualificacao.getRfp()%></td>
							<td><%=criterioPreQualificacao.getGp()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarCriterioPreQualificacao&codigo=<%=criterioPreQualificacao.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirCriterioPreQualificacao&codigo=<%=criterioPreQualificacao.getCodigo()%>'><img
