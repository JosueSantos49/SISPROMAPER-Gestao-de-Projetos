<!-- 
	...
	Ano: 2015
 -->
<%@page import="br.com.tkcsapcd.model.bean.BusinessCase"%>
...
<title>Consultar Business Case</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Business Case</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_business_case.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<BusinessCase> businessCases = (List<BusinessCase>) request.getAttribute("businessCases");
								for (BusinessCase businessCase : businessCases) {
							%>
						<tr>							
							<td><%=businessCase.getProjetoinicio().getCodigo()%></td>
							<td><%=businessCase.getBusinesscase()%></td>
							<td><%=businessCase.getVersao()%></td>
							<td><%=businessCase.getData()%></td>
							<td><%=businessCase.getAutor()%></td>
							<td><%=businessCase.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarBusinessCase&codigo=<%=businessCase.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirBusinessCase&codigo=<%=businessCase.getCodigo()%>'><img
