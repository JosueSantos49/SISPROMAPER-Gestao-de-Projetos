...
<%@page import="br.com.tkcsapcd.model.bean.MatrizComunicacao"%>
...
<title>Consultar Matriz da Comunicações</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Matriz das Comunicações</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_matriz_comunicacao.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<MatrizComunicacao> matrizComunicacaos = (List<MatrizComunicacao>) request.getAttribute("matrizComunicacaos");
								for (MatrizComunicacao matrizComunicacao : matrizComunicacaos) {
							%>
						<tr>							
							<td><%=matrizComunicacao.getCodigomatriz()%></td>
							<td><%=matrizComunicacao.getPergunta1()%></td>
							<td><%=matrizComunicacao.getPergunta2()%></td>
							<td><%=matrizComunicacao.getPergunta3()%></td>
							<td><%=matrizComunicacao.getPergunta4()%></td>
							<td><%=matrizComunicacao.getPergunta5()%></td>
							<td><%=matrizComunicacao.getPergunta6()%></td>
							<td><%=matrizComunicacao.getPergunta7()%></td>
							<td><%=matrizComunicacao.getPergunta8()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarMatrizComunicacao&codigo=<%=matrizComunicacao.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirMatrizComunicacao&codigo=<%=matrizComunicacao.getCodigo()%>'><img
