...
<title>Atualizar Business Plan</title>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				...
				<br> 
				<input type="hidden" name="cmd" value="atualizarBusinessPlan"></input>
				...
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa1(this.value,550,'spcontando0');contarCaracteresEtapa1(this.value,550,'sprestante0')">${businessPlan.situacaomercado}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
							<font color="blue"></font>
								...
								onkeyup="mostrarResultadoEtapa2(this.value,550,'spcontando');contarCaracteresEtapa2(this.value,550,'sprestante')">${businessPlan.situacaoservico}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa3(this.value,550,'spcontando1');contarCaracteresEtapa3(this.value,550,'sprestante1')">${businessPlan.situacaocompetividade}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa4(this.value,550,'spcontando2');contarCaracteresEtapa4(this.value,550,'sprestante2')">${businessPlan.situacaodistribuicao}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa5(this.value,550,'spcontando3');contarCaracteresEtapa5(this.value,550,'sprestante3')">${businessPlan.situacaomacro}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa6(this.value,550,'spcontando4');contarCaracteresEtapa6(this.value,550,'sprestante4')">${businessPlan.analiseexterno}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa7(this.value,550,'spcontando5');contarCaracteresEtapa7(this.value,550,'sprestante5')">${businessPlan.analiseinterno}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa8(this.value,550,'spcontando6');contarCaracteresEtapa8(this.value,550,'sprestante6')">${businessPlan.analiserelacionada}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa9(this.value,550,'spcontando7');contarCaracteresEtapa9(this.value,550,'sprestante7')">${businessPlan.objetivofinanceiro}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa10(this.value,550,'spcontando17');contarCaracteresEtapa10(this.value,550,'sprestante17')">${businessPlan.objetivomarketing}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa11(this.value,550,'spcontando9');contarCaracteresEtapa11(this.value,550,'sprestante9')">${businessPlan.cronograma}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa12(this.value,550,'spcontando10');contarCaracteresEtapa12(this.value,550,'sprestante10')">${businessPlan.estrategia}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa13(this.value,550,'spcontando11');contarCaracteresEtapa13(this.value,550,'sprestante11')">${businessPlan.segmento}</textarea>
					...
					<tr class="field">
						<td><p align="justify">
							...
							<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa14(this.value,300,'spcontando12');contarCaracteresEtapa14(this.value,300,'sprestante12')">${businessPlan.aprovacao}</textarea>
