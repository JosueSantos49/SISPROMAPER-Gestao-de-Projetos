...
<%@page import="br.com.tkcsapcd.model.bean.RegistroParteInteressadaFornecedor"%>
...
<title>Consultar Registro das Partes Interessada Fornecedores</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Registros das Partes Interessadas Fornecedores</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_registro_parte_interessada_fornecedor.jsp"
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							...
							<th>Código Fornecedore</th>
							<th>Nome do Projeto</th>
							<th>R. Parte Interessada Fornecedor</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							<%
								List<RegistroParteInteressadaFornecedor> registroParteInteressadaFornecedors = (List<RegistroParteInteressadaFornecedor>) request.getAttribute("registroParteInteressadaFornecedors");
								for (RegistroParteInteressadaFornecedor registroParteInteressadaFornecedor : registroParteInteressadaFornecedors) {
							%>
						<tr>
							<td><%=registroParteInteressadaFornecedor.getCodigoprojeto()%></td>
							<td><%=registroParteInteressadaFornecedor.getCodigofornecedor()%></td>
							<td><%=registroParteInteressadaFornecedor.getProjeto()%></td>
							<td><%=registroParteInteressadaFornecedor.getRegistroparteinteressada()%></td>
							<td><%=registroParteInteressadaFornecedor.getVersao()%></td>
							<td><%=registroParteInteressadaFornecedor.getData()%></td>
							<td><%=registroParteInteressadaFornecedor.getAutor()%></td>
							<td><%=registroParteInteressadaFornecedor.getNotarevisao()%></td>
							<td><%=registroParteInteressadaFornecedor.getFone()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarRegistroParteInteressadaFornecedor&codigo=<%=registroParteInteressadaFornecedor.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirRegistroParteInteressadaFornecedor&codigo=<%=registroParteInteressadaFornecedor.getCodigo()%>'><img
