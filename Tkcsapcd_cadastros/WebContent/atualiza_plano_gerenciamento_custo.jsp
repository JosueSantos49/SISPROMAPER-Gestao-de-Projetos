...
<title>Atualizar Plano de Gerenciamento dos Custos</title>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				...
				<br> 
				<input type="hidden" name="cmd" value="atualizarPlanoGerenciamentoCusto"></input>
				...
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="codigoprojeto" name="codigoprojeto"
									...
									Placeholder=""
									value="${planoGerenciamentoCusto.codigoprojeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa1(this.value,500,'spcontando0');contarCaracteresEtapa1(this.value,500,'sprestante0')">${planoGerenciamentoCusto.objetivo}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
							<font color="blue"></font>
								...
								onkeyup="mostrarResultadoEtapa2(this.value,500,'spcontando');contarCaracteresEtapa2(this.value,500,'sprestante')">${planoGerenciamentoCusto.metodo}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa3(this.value,500,'spcontando1');contarCaracteresEtapa3(this.value,500,'sprestante1')">${planoGerenciamentoCusto.processo}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa4(this.value,500,'spcontando2');contarCaracteresEtapa4(this.value,500,'sprestante2')">${planoGerenciamentoCusto.documento}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa5(this.value,500,'spcontando3');contarCaracteresEtapa5(this.value,500,'sprestante3')">${planoGerenciamentoCusto.ferramenta}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa6(this.value,500,'spcontando4');contarCaracteresEtapa6(this.value,500,'sprestante4')">${planoGerenciamentoCusto.papeis}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa7(this.value,500,'spcontando5');contarCaracteresEtapa7(this.value,500,'sprestante5')">${planoGerenciamentoCusto.objetivo}plano</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa8(this.value,500,'spcontando6');contarCaracteresEtapa8(this.value,500,'sprestante6')">${planoGerenciamentoCusto.custo}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa9(this.value,500,'spcontando7');contarCaracteresEtapa9(this.value,500,'sprestante7')">${planoGerenciamentoCusto.orcamento}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa10(this.value,500,'spcontando8');contarCaracteresEtapa10(this.value,500,'sprestante8')">${planoGerenciamentoCusto.controlarcusto}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa19(this.value,500,'spcontando17');contarCaracteresEtapa19(this.value,500,'sprestante17')">${planoGerenciamentoCusto.aprovacao}</textarea>
