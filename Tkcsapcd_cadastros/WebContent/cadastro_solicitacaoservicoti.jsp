...
<div class="resp"></div><!-- Esta configurado com ajax -->
...
<form action="TkcsapcdController" id="formulario"	name="formulario" enctype="multipart/form-data" onsubmit="validaCadastrarSolicicatcaoServicoTI()">	
		...
		<input type="hidden" name="cmd" value="cadastrarSolicitacaoServicoTI"></input>	
			...
			<table	border="0" cellspacing="3" cellpadding="3" width="100%" bgcolor="#FFFFFF">							
							...
							<tr class="field">
								...
								<td><p align="justify">
									<select id="codigoprojeto" name="codigoprojeto">
										...
										%>	
									</select><p class="hint">[Informar o projeto da SSTI.]</p></p>
								</td>
							</tr>
							<tr>
								<td><br></td>
							...
							<tr class="field">
								...
								<td><p align="justify"><input id="telefonecontato" name="telefonecontato"
									style="height: 30px; width: 150px" class="input" onkeypress="return numbers(event);" value="${solicitacaoServicoTI.telefonecontato}"
									maxlength="13" required="true"></input>(xx.xxxxx.xxxx)
							...
							<tr class="field">
								...
								<td><p align="justify"><input id="id" name="id"
									style="height: 30px; width: 130px" class="input" onkeypress="return numbers(event);" value="${solicitacaoServicoTI.id}" maxlength="8"></input>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font>
							 		<textarea  id="nomedemanda" name="nomedemanda" onkeyup="mostrarResultadoNomedemanda(this.value,200,'spcontando0');contarCaracteresNomedemanda(this.value,200,'sprestante0')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font>
							 		<textarea  id="objetivodemanda" name="objetivodemanda" onkeyup="mostrarObjetivoDemanda(this.value,200,'spcontando1');contarCaracteresObjetivoDemanda(this.value,200,'sprestante1')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="decricaoproblema" name="decricaoproblema" onkeyup="mostrarResultadoDescricaoProblema(this.value,200,'spcontando3');contarCaracteresDescricaoProblema(this.value,200,'sprestante3')" required="true"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="desenhoprocesso" name="desenhoprocesso" onkeyup="mostrarResultadoDesenhoProcesso(this.value,200,'spcontando4');contarCaracteresDesenhoProcesso(this.value,200,'sprestante4')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="funcionalidade" name="funcionalidade" onkeyup="mostrarResultadoFuncionalidade(this.value,200,'spcontando5');contarCaracteresFuncionalidade(this.value,200,'sprestante5')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="parteenvolvida" name="parteenvolvida" onkeyup="mostrarResultadoParteenvolvida(this.value,200,'spcontando6');contarCaracteresParteenvolvida(this.value,200,'sprestante6')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="parteenvolvidarepresentante" name="parteenvolvidarepresentante" onkeyup="mostrarResultadoParteenvolvidaRepresentante(this.value,200,'spcontando7');contarCaracteresParteenvolvidaRepresentante(this.value,200,'sprestante7')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="parteenvolvidaformacontato" name="parteenvolvidaformacontato" onkeyup="mostrarResultadoParteenvolvidaFormaContato(this.value,200,'spcontando8');contarCaracteresParteenvolvidaFormaContato(this.value,200,'sprestante8')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="estimativacustoglobal" name="estimativacustoglobal" onkeyup="mostrarResultadoEstimativacustoglobal(this.value,200,'spcontando9');contarCaracteresEstimativacustoglobal(this.value,200,'sprestante9')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="fontefinanciamento" name="fontefinanciamento" onkeyup="mostrarResultadoFontefinaciamento(this.value,200,'spcontando10');contarCaracteresFontefinaciamento(this.value,200,'sprestante10')"></textarea>
							 		<p class="hint">[Informe a fonte de financiamento que deverá ser utilizada para custeá a demanda.]</p><br><br>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="metodolevantamentocusto" name="metodolevantamentocusto" onkeyup="mostrarResultadoMetodolevantamentocusto(this.value,200,'spcontando11');contarCaracteresMetodolevantamentocusto(this.value,200,'sprestante11')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="numerousuarioprevisto" name="numerousuarioprevisto" onkeyup="mostrarResultadoNumerousuarioprevisto(this.value,200,'spcontando12');contarCaracteresNumerousuarioprevisto(this.value,200,'sprestante12')"></textarea>
							...
							<tr class="field">
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="restricaoprojeto" name="restricaoprojeto" onkeyup="mostrarResultadoRestricaoprojeto(this.value,200,'spcontando13');contarCaracteresRestricaoprojeto(this.value,200,'sprestante13')"></textarea>
							...
							<tr class="field">
								...
								<td><p align="justify"><select id="principaisusuarios" name="principaisusuarios">
									  		<option value="">......</option>
									  		<option value="Nível Central">Nível Central</option>
									  		<option value="GRS">GRS</option>
									  		<option value="Outros">Outros</option>
									 </select><p class="hint">[Informar os principais.]</p>				
							 	</td>
							</tr>
							<tr>
								<td><br></td>
							...
							<tr class="field" >
							 	...
							 	<td><p align="justify"><font color="blue"></font></p>
							 		<textarea  id="necessidadeusuario" name="necessidadeusuario" onkeyup="mostrarResultadoNecessidadeusuario(this.value,200,'spcontando14');contarCaracteresNecessidadeusuario(this.value,200,'sprestante14')"></textarea>
					...
					<input type="button" name="prev" class="prev acao" value="Anterior"  onchange="validaCadastrarSolicicatcaoServicoTI()" onclick="validaCadastrarSolicicatcaoServicoTI()">
					<input class="acao" type="submit" value="Enviar"  onclick="show_confirm()" onchange="validaCadastrarSolicicatcaoServicoTI()" onclick="validaCadastrarSolicicatcaoServicoTI()"></input><!--  -->
