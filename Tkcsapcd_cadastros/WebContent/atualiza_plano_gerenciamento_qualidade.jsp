...
<title>Atualizar Plano de Gerenciamento da Qualidade</title>
...
<%@include file="menuperantecssadm.jsp"%>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">PLANO DE GERENCIAMENTO DA QUALIADDE</font></th></tr></table><br>				
				<center>
					<h3>
				...
				<br> 
				<input type="hidden" name="cmd" value="atualizarPlanoGerenciamentoQualidade"></input>
				...
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<p align="justify">
							...
							<p class="hint">[Informar Plano de Gerenciamento da Qualidade.]</p></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="codigoprojeto" name="codigoprojeto"
									...
									Placeholder=""
									value="${planoGerenciamentoQualidade.codigoprojeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa1(this.value,400,'spcontando0');contarCaracteresEtapa1(this.value,400,'sprestante0')">${planoGerenciamentoQualidade.objetivo}</textarea>
							<p class="hint">[O plano de Gerenciamento da qualidade do projeto descreve como a equipe de gerenciamento de projetos implementará a política de qualidade da organização executora. O Plano de gerenciamento da qualidade define requisitos e padrões da qualidade aplicáveis ao projeto e as suas entregas e descreve como será verificado a conformidade das entregas respeitando a política de qualidade da empresa.]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>2 Método de Gerenciamento da Qualidade  <font color="red">*</font></b>
						<p align="justify">
							<font color="blue"></font>
							</p> <textarea id="metodo" name="metodo" required="true"
								onkeyup="mostrarResultadoEtapa2(this.value,400,'spcontando');contarCaracteresEtapa2(this.value,400,'sprestante')">${planoGerenciamentoQualidade.metodo}</textarea>
							<p class="hint">[Gerenciar a qualidade do projeto requer um plano de qualidade aprovado englobando os principais processos de qualidade. O plano de qualidade é desenvolvido e aprovado durante a fase de planejamento do projeto para confirmar requisitos e padrões da qualidade aplicáveis ao projeto e as suas entregas e gerenciar os processos de projeto aprovados.]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa3(this.value,400,'spcontando1');contarCaracteresEtapa3(this.value,400,'sprestante1')">${planoGerenciamentoQualidade.processoqualidade}</textarea>
							<p class="hint">[Auditoria dos requisitos de qualidade e dos resultados das medições do controle da qualidade para garantir que sejam usados os padrões de qualidade e definições operacionais apropriados. Monitoramento e registro dos resultados da execução das atividades de qualidade para avaliar o desempenho e recomendar as mudanças necessárias. ]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa4(this.value,400,'spcontando2');contarCaracteresEtapa4(this.value,400,'sprestante2')">${planoGerenciamentoQualidade.justificativa}</textarea>
							<p class="hint">[Como será determinado se o projeto foi um sucesso ou um fracasso, justificativa do projeto e quais indicadores serão usados. Exemplo: O projeto será considerado um sucesso se atender a todos os critérios de aceitação das entregas, respeitar as restrições e cumprir o cronograma de execução e principalmente atender os requisitos e padrões de qualidade detalhados nesse plano.]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>2.3	Métricas da Qualidade <font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="metrica" name="metrica" required="true"
								onkeyup="mostrarResultadoEtapa5(this.value,400,'spcontando3');contarCaracteresEtapa5(this.value,400,'sprestante3')">${planoGerenciamentoQualidade.metrica}</textarea>
							<p class="hint">[Uma métrica de qualidade é uma definição operacional que descreve, em termos bem específicos, um atributo do projeto ou do produto, e como o processo de controle da qualidade irá medi-lo. Uma métrica é medida e possui um valor real. Liste os padrões e requisitos de qualidade usados e como serão satisfeitos. Para os padrões de mercado, referenciar a Norma ABNT ou Internacional, e para os padrões da empresa, referenciar o procedimento do SGQ (Sistema de Gestão da Qualidade) ou documento de referência. Anexar os documentos referenciados. Lembre-se, requisito da qualidade é uma condição ou aptidão de um atributo do projeto. Para atender um requisito da qualidade, você pode usar um ou mais indicadores.]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa6(this.value,400,'spcontando4');contarCaracteresEtapa6(this.value,400,'sprestante4')">${planoGerenciamentoQualidade.ferramentaqualidade}</textarea>
							<p class="hint">[Lista as ferramentas de qualidade que o projeto empregará. Descreve como serão usadas e o responsável por isso. Exemplo: Ferramenta, descrição da aplicação, quando aplicar e responsável.]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa7(this.value,400,'spcontando5');contarCaracteresEtapa7(this.value,400,'sprestante5')">${planoGerenciamentoQualidade.entregaprojetoaceitacao}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa8(this.value,400,'spcontando6');contarCaracteresEtapa8(this.value,400,'sprestante6')">${planoGerenciamentoQualidade.garantiaqualidade}</textarea>
							<p class="hint">[Define atividades do processo Realizar a garantia da qualidade incluindo auditorias, e melhoria contínua. ]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>3.1	Auditorias do Projeto & Revisões de Qualidade<font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="auditoria" name="auditoria" required="true"
								onkeyup="mostrarResultadoEtapa9(this.value,400,'spcontando7');contarCaracteresEtapa9(this.value,400,'sprestante7')">${planoGerenciamentoQualidade.auditoria}</textarea>
							<p class="hint">[Análise estruturada e independente que busca identificar políticas, processos e procedimentos ineficientes e ineficazes em uso no projeto e não aderentes às políticas e procedimentos do projeto e da empresa. Exemplo: Revisão de qualidade, data prevista, auditor responsável e comentários.]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>3.2	Processos de Melhoria Contínua<font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="processomelhoria" name="processomelhoria" required="true"
								onkeyup="mostrarResultadoEtapa10(this.value,400,'spcontando8');contarCaracteresEtapa10(this.value,400,'sprestante8')">${planoGerenciamentoQualidade.processomelhoria}</textarea>
							<p class="hint">[Meio iterativo de melhorar a qualidade de todos os processos. Reduz o desperdício e elimina as atividades que não agregam valor, permitindo que os processos sejam operados com níveis mais altos de eficiência e eficácia. ]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa11(this.value,400,'spcontando9');contarCaracteresEtapa11(this.value,400,'sprestante9')">${planoGerenciamentoQualidade.responsabilidadequalidade}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa12(this.value,400,'spcontando10');contarCaracteresEtapa12(this.value,400,'sprestante10')">${planoGerenciamentoQualidade.logauditoria}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa16(this.value,400,'spcontando14');contarCaracteresEtapa16(this.value,400,'sprestante14')">${planoGerenciamentoQualidade.controlequalidade}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa17(this.value,400,'spcontando15');contarCaracteresEtapa17(this.value,400,'sprestante15')">${planoGerenciamentoQualidade.procedimentoinspecao}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa18(this.value,400,'spcontando16');contarCaracteresEtapa18(this.value,400,'sprestante16')">${planoGerenciamentoQualidade.procedimentomonitoramento}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa19(this.value,400,'spcontando17');contarCaracteresEtapa19(this.value,400,'sprestante17')">${planoGerenciamentoQualidade.aprovacao}</textarea>
