...
<%@page import="br.com.tkcsapcd.model.bean.PlanoGerenciamentoCronograma"%>
...
<title>Consultar Plano de Gerenciamento do Cronograma</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamento do Cronograma</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_gerenciamento_cronograma.jsp"
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							...
							<th>Plano Gerenciamento Cronograma</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							<%
								List<PlanoGerenciamentoCronograma> planoGerenciamentoCronogramas = (List<PlanoGerenciamentoCronograma>) request.getAttribute("planoGerenciamentoCronogramas");
								for (PlanoGerenciamentoCronograma planoGerenciamentoCronograma : planoGerenciamentoCronogramas) {
							%>
						<tr>							
							<td><%=planoGerenciamentoCronograma.getProjetoinicio().getCodigoprojeto()%></td>
							<td><%=planoGerenciamentoCronograma.getProjetoinicio().getProjeto()%></td>
							<td><%=planoGerenciamentoCronograma.getPlanogerenciamentocronograma()%></td>
							<td><%=planoGerenciamentoCronograma.getVersao()%></td>
							<td><%=planoGerenciamentoCronograma.getData()%></td>
							<td><%=planoGerenciamentoCronograma.getAutor()%></td>
							<td><%=planoGerenciamentoCronograma.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoGerenciamentoCronograma&codigo=<%=planoGerenciamentoCronograma.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoGerenciamentoCronograma&codigo=<%=planoGerenciamentoCronograma.getCodigo()%>'><img
