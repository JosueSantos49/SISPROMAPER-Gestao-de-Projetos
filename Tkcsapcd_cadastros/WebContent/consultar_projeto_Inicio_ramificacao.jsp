...
<head>
    ...
    <title>Ramificação Projeto</title>
            ...
            <ul id="tree1">                
				...
				%>
                 <li>                 		
                    ...
                    <ul>
                        <li><font color="#000">CÓDIGO</font> - <%=projetoInicio.getCodigoprojeto()%></li>
                        <li><font color="red">ATRIBUIÇÃO</font> - <%=projetoInicio.getAtribuiprojeto()%>
                            <ul>
                                <li><font color="#000">DADOS</font>
                                    <ul>
                                        ...
                                        <li><font color="#000">ÁREA</font> - <%=projetoInicio.getArea()%></li>
                                        <li><font color="#000">ROI</font> - <%=projetoInicio.getRoi()%></li>
                                    </ul>
                                </li>
                                <li><font color="red">FIM ATRIUIÇÃO</font></li>
                            </ul>
                        </li>
