...
<title>Cadastrar Pauta de Reunião</title>
...
<script language="javascript" src="js/TextearePautaReuniao.js"></script>
...
<script>
	function show_confirm() {
		...
		if (r == true) {
			...
			location.href = "TkcsapcdController?cmd=consultarPautaReuniao";
...
<script type="text/javascript">
	function setFocus() {
		document.getElementById("pautaReuniao").focus();
	}
</script>
...
<%@include file="menuperantecssadm.jsp"%>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">PAUTA DE REUNIÃO</font></th></tr></table><br>				
				
				<!-- Modal explicando o objetivo da transação -->
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        <a href="#" class="close" data-dismiss="alert">&times;</a>
				        <strong>Nota!</strong> Pauta de reunião: Convoca os participantes deixando claro objetivo da reunião e tópicos a serem discutidos
				    </div>
				        ...
				        <div class="modal-dialog">
				            <div class="modal-content">
				                <div class="modal-header">
				                    ...
				                    <h2 class="modal-title">Pauta de reunião</h2>
				                </div>
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	Pauta de reunião: Convoca os participantes deixando claro objetivo da reunião e tópicos a serem discutidos
				                    </div>
				                </div>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarPautaReuniao"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						<td><p align="justify"><b>Pauta de Reunião <font color="red">*</font></b></p>
						<p align="justify">
								<input id="pautareuniao" name="pautareuniao"
									style="height: 30px; width: 379px" maxlength="150"
									value="${pautaReuniao.pautareuniao}" class="input" required="true"></input>
							<p class="hint">[Informar Pauta de Reunião.]</p></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="projeto" name="projeto"
									...
									Placeholder=""
									value="${pautaReuniao.projeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								...
								<!-- <input id="codigoprojeto" name="codigoprojeto"
									...
									Placeholder=""
									value="${pautaReuniao.codigoprojeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="data" name="data"
									...
									value="${pautaReuniao.data}" class="input" required="true"
									onkeypress="return numbers(event);"></input>
					...
					<tr class="field">
						<td><p align="justify">
								<b>Local <font color="red">*</font></b></p>
						<p align="justify">
								<input id="local" name="local"
									style="height: 30px; width: 379px"
									Placeholder="" 
									value="${pautaReuniao.local}" class="input" required="true"
									onkeypress="return Letras(event);"></input>
							<p class="hint">[Informar o local]</p></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
					...
					<tr class="field">
						...
						<p align="justify">
							...
							</p> <textarea id="participantes" name="participantes" required="true"
					...
					<tr class="field">
						<td><p align="justify">
								<b>Objetivos da reunião  <font color="red">*</font></b>
						<p align="justify">
							<font color="blue"></font>
							...
							<p class="hint">[Objetivos da reunião.]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>Tópicos a serem discutidos <font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[Tópicos a serem discutidos.]</p>
							<br>
						<br>
							<h5 align="left">
