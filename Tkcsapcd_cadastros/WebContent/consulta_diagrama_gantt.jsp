...
<head>
    ...
    <title>Consultar Diagrama Gantt</title>
		...
		%>, seja bem vindo a etapa de consultar portfólio de projeto.
			   ...
			   <a download="somedata.csv" href="#" onclick="return ExcellentExport.csv(this, 'tabela');"><img alt="" title="Export to Excel" height="20" width="27" src="img/csv.jpg"></a>				
					...
					<table id="tabela" cellspacing="5" cellspacing="5" class="display">
								...
								<tbody>
									<%
										List<DiagramaGantt> diagramaGantts = (List<DiagramaGantt>) request.getAttribute("diagramaGantts");
										for (DiagramaGantt diagramaGantt : diagramaGantts) {
									%>
								<tr>
										
									<td><%=diagramaGantt.getCodigo()%></td>
									<td><%=diagramaGantt.getTa()%></td>
									<td><a class="link_atualizar" href='TkcsapcdController?cmd=editarDiagramaGantt&codigo=<%=diagramaGantt.getCodigo()%>'><img alt="" title="Atualizar" height="20" width="27" src="img/alterar.gif"></a></td>
									<td><a class="link_delete" href='TkcsapcdController?cmd=excluirDiagramaGantt&codigo=<%=diagramaGantt.getCodigo()%>'><img alt="" title="Excluir" height="20" width="27" src="img/delete.gif"></a></td>
								</tr>
								<%
									}
								%>
