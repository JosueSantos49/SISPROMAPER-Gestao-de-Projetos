...
<title>Consultar Registro dos Riscos</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Registro dos Riscos</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_registro_risco.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							...
							%>
						<tr>							
							<td><%=registroRisco.getProjetoinicio().getCodigo()%></td>
							<td><%=registroRisco.getRegistrorisco()%></td>
							<td><%=registroRisco.getVersao()%></td>
							<td><%=registroRisco.getData()%></td>
							<td><%=registroRisco.getAutor()%></td>
							<td><%=registroRisco.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarRegistroRisco&codigo=<%=registroRisco.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirRegistroRisco&codigo=<%=registroRisco.getCodigo()%>'><img
