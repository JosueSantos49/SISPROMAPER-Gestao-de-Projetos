...
<%@ page import="java.util.List,br.com.tkcsapcd.model.bean.MatrizComunicacao"%>
<html>
...
<title>Cadastrar Matriz das Comunicações</title>
...
<script language="javascript" src="js/TexteareaMatrizComunicacao.js"></script>
...
<script>
	function show_confirm() {
		...
		if (r == true) {
			...
			location.href = "TkcsapcdController?cmd=consultarMatrizComunicacao";
...
<%@include file="menuperantecssadm.jsp"%>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">MATRIZ DAS COMUNICAÇÕES</font></th></tr></table><br>				
				<center>
					<h3>
				...
				<br> <input type="hidden" name="cmd" value="cadastrarMatrizComunicacao"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="90%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						<td><p align="justify">
								<b>Código Matriz <font color="red">*</font></b>
							</p>
						<p align="justify">
								<input id="codigomatriz" name="codigomatriz"
									style="height: 30px; width: 400px"
									Placeholder=""
									value="${matrizComunicacao.codigomatriz}" class="input" required="true"
									onkeypress="return numbers(event);"></input>
							<p class="hint">[Informar o código matriz.]</p></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
					...
					<tr class="field">
						<td><p align="justify"><b>What? <font color="red">*</font></b><br>
						<p align="justify">	<font color="blue"></font></p>
							<textarea id="pergunta1" name="pergunta1" required="true" onkeyup="mostrarResultadoEtapa1(this.value,400,'spcontando0');contarCaracteresEtapa1(this.value,400,'sprestante0')"></textarea>
							<p class="hint">[Qual informação?]</p>
							<br><br>
					...
					<tr class="field">
						<td><p align="justify">
								<b>Why? <font color="red">*</font></b><br>
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="pergunta2" name="pergunta2" required="true" onkeyup="mostrarResultadoEtapa2(this.value,400,'spcontando');contarCaracteresEtapa2(this.value,400,'sprestante')"></textarea>
							<p class="hint">[Qual propósito?]</p>
							<br><br>
					...
					<tr class="field">
						<td><p align="justify">
								<b>Who? <font color="red">*</font></b><br>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[Quem é o responsável?]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
							...
							<p class="hint">[Quem precisa da informação?]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>When?<font color="red">*</font></b><br>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[Quando e Qual periodicidade?]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>Where?<font color="red">*</font></b><br>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[Onde serão armazenadas?]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>How? <font color="red">*</font></b><br>
							<p align="justify">
								<font color="blue"></font>
					...
					<tr class="field">
						...
						<p align="justify">
							...
							<p class="hint">[Procedimento, Best Practices?]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>Comentários<font color="red">*</font></b><br>
						<p align="justify">
								<font color="blue"></font>
