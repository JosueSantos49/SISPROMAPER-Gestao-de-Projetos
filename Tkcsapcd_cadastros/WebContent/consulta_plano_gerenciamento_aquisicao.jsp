...
<%@page import="br.com.tkcsapcd.model.bean.PlanoGerenciamentoAquisicao"%>
...
<title>Consultar Plano de Gerenciamento de Aquisição</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamento de Aquisição</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_gerenciamento_aquisicao.jsp"
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							...
							<th>Plano Gerenciamento Aquisição</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							<%
								List<PlanoGerenciamentoAquisicao> planoGerenciamentoAquisicaos = (List<PlanoGerenciamentoAquisicao>) request.getAttribute("planoGerenciamentoAquisicaos");
								for (PlanoGerenciamentoAquisicao planoGerenciamentoAquisicao : planoGerenciamentoAquisicaos) {
							%>
						<tr>							
							<td><%=planoGerenciamentoAquisicao.getCodigoprojeto()%></td>
							<td><%=planoGerenciamentoAquisicao.getProjeto()%></td>
							<td><%=planoGerenciamentoAquisicao.getPlanogerenciamentoaquisicao()%></td>
							<td><%=planoGerenciamentoAquisicao.getVersao()%></td>
							<td><%=planoGerenciamentoAquisicao.getData()%></td>
							<td><%=planoGerenciamentoAquisicao.getAutor()%></td>
							<td><%=planoGerenciamentoAquisicao.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoGerenciamentoAquisicao&codigo=<%=planoGerenciamentoAquisicao.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoGerenciamentoAquisicao&codigo=<%=planoGerenciamentoAquisicao.getCodigo()%>'><img
