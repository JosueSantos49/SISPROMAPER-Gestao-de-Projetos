...
<%@page import="java.util.List,br.com.tkcsapcd.model.bean.PlanoMelhoriaProcesso"%>
<%@page import="br.com.tkcsapcd.model.bean.PlanoMelhoriaProcesso"%>
...
<title>Consultar Plano de Melhoria de Processo</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Melhoria de Processo</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_melhoria_processo.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<PlanoMelhoriaProcesso> planoMelhoriaProcessos = (List<PlanoMelhoriaProcesso>) request.getAttribute("planoMelhoriaProcessos");
								for (PlanoMelhoriaProcesso planoMelhoriaProcesso : planoMelhoriaProcessos) {
							%>
						<tr>							
							<td><%=planoMelhoriaProcesso.getCodigoprojeto()%></td>
							<td><%=planoMelhoriaProcesso.getProjeto()%></td>
							<td><%=planoMelhoriaProcesso.getPlanomelhoriaprocesso()%></td>
							<td><%=planoMelhoriaProcesso.getVersao()%></td>
							<td><%=planoMelhoriaProcesso.getData()%></td>
							<td><%=planoMelhoriaProcesso.getAutor()%></td>
							<td><%=planoMelhoriaProcesso.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoMelhoriaProcesso&codigo=<%=planoMelhoriaProcesso.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoMelhoriaProcesso&codigo=<%=planoMelhoriaProcesso.getCodigo()%>'><img
