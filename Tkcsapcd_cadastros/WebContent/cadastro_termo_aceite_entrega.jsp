			...
			<fieldset>			
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> O Termo de aceite da entrega formaliza o aceite da entrega considerando-a em conformidade com os requisitos e os critérios de aceitação definidos. Formalização ou Aceite da Entrega do Projeto. Pode ser usada tanto para entregas parciais ou a entrega final do projeto.
				    </div>
				            ...
				            <div class="modal-content">
				                ...
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	Entregas Aceitas: as entregas aceitas e validadas do ponto de vista de qualidade serão entregues ao cliente do projeto, que pode ser interno ou externo, essas entregas devem ser devidamente documentadas para que não restem dúvidas sobre a conclusão do projeto.
				                    </div>
				                </div>
