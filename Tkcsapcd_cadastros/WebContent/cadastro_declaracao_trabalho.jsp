...
<%@ page import="java.util.List,br.com.tkcsapcd.model.bean.DeclaracaoTrabalho"%>
<html>
...
<title>Cadastrar Declaração Trabalho</title>
...
<script language="javascript" src="js/TexteareDeclaracaoTrabalho.js"></script>
...
<script>
	function show_confirm() {
		...
		if (r == true) {
			...
			location.href = "TkcsapcdController?cmd=consultarDeclaracaoTrabalho";
...
<script type="text/javascript">
	function setFocus() {
		document.getElementById("declaracaoTrabalho").focus();
	}
</script>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">DECLARAÇÃO DE TRABALHO</font></th></tr></table><br>				
				<center>
					<h3>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarDeclaracaoTrabalho"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						<td><p align="justify"><b>Declaração Trabalho <font color="red">*</font></b></p>
						<p align="justify">
								<input id="declaracaotrabalho" name="declaracaotrabalho"
									style="height: 30px; width: 379px" maxlength="150"
									value="${declaracaoTrabalho.declaracaotrabalho}" class="input" required="true"></input>
							<p class="hint">[Declaração Trabalho]</p></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="projeto" name="projeto"
									...
									Placeholder=""
									value="${declaracaoTrabalho.projeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="codigoprojeto" name="codigoprojeto"
									...
									Placeholder=""
									value="${declaracaoTrabalho.codigoprojeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="versao" name="versao"
									...
									value="${declaracaoTrabalho.versao}" class="input" required="true"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="data" name="data"
									style="height: 30px; width: 100px"
									value="${declaracaoTrabalho.data}" class="input" required="true"
									onkeypress="return numbers(event);"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="autor" name="autor"
									style="height: 30px; width: 379px"
									Placeholder="" 
									value="${declaracaoTrabalho.autor}" class="input" required="true"
									onkeypress="return Letras(event);"></input>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="notarevisao" name="notarevisao"
									style="height: 30px; width: 379px"
									Placeholder=""
									value="${declaracaoTrabalho.notarevisao}" class="input" required="true"></input>
					...
					<tr class="field">
						<td><p align="justify">
								<b>2	Escopo do Trabalho  <font color="red">*</font></b>
						<p align="justify">
							<font color="blue"></font>
							...
							<p class="hint">[Descreva o trabalho a ser feito em detalhe suficiente. ]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>2.1	Cronograma de Entregas do Projeto e Critérios de Aceitação <font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[Identifique as entregas requeridas, seus critérios de aceitação e quando deverão ser entregues. Sempre que possível atrelar os pagamentos e incentivos com os critérios de aceitação e previsão de término. ]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>2.2	Padrões Aplicáveis <font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="padrao" name="padrao" required="true"
								onkeyup="mostrarResultadoEtapa4(this.value,400,'spcontando2');contarCaracteresEtapa4(this.value,400,'sprestante2')"></textarea>
							<p class="hint">[Especifique qualquer padrão de indústria ou padrões próprios a serem seguidos que são relevantes ao trabalho a ser realizado. ]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>2.3	Requisitos e Indicadores <font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[Liste os requisitos de qualidade usados e como serão satisfeitos. ]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>3	Local de Trabalho<font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[Descreva onde o trabalho será realizado. ]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>4	Período de Trabalho<font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							...
							<p class="hint">[Especifique quando o trabalho dever começar e terminar, horas de trabalho, número de horas semanais que podem ser faturadas e informações sobre as agendas de trabalho local. ]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>5	Requisitos Especiais<font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="requisitoespecial" name="requisitoespecial" required="true"
								onkeyup="mostrarResultadoEtapa8(this.value,400,'spcontando6');contarCaracteresEtapa8(this.value,400,'sprestante6')"></textarea>
							<p class="hint">[Especifica qualquer requisito especial como mínimo grau de experiência dos profissionais, requisitos de viagens, etc.]</p>
							<br>
						<br>
							<h5 align="left">
