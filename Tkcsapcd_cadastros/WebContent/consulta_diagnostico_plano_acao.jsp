...
<title>Consultar Diagnóstico e Plano de Ação</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Diagnóstico e Plano de Ação</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_diagnostico_plano_acao.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<DiagnosticoPlanoAcao> diagnosticoPlanoAcaos = (List<DiagnosticoPlanoAcao>) request.getAttribute("diagnosticoPlanoAcaos");
								for (DiagnosticoPlanoAcao diagnosticoPlanoAcao : diagnosticoPlanoAcaos) {
							%>
						<tr>							
							<td><%=diagnosticoPlanoAcao.getCodigoprojeto()%></td>
							<td><%=diagnosticoPlanoAcao.getProjeto()%></td>
							<td><%=diagnosticoPlanoAcao.getDiagnosticoplanoacao()%></td>
							<td><%=diagnosticoPlanoAcao.getVersao()%></td>
							<td><%=diagnosticoPlanoAcao.getData()%></td>
							<td><%=diagnosticoPlanoAcao.getAutor()%></td>
							<td><%=diagnosticoPlanoAcao.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarDiagnosticoPlanoAcao&codigo=<%=diagnosticoPlanoAcao.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirDiagnosticoPlanoAcao&codigo=<%=diagnosticoPlanoAcao.getCodigo()%>'><img
