<!-- 
	...
	Ano: 2015
 -->
<%@page import="br.com.tkcsapcd.model.bean.BusinessPlan"%>
...
<%@page import="br.com.tkcsapcd.model.bean.PlanoGerenciamentoQualidade"%>
...
<title>Consultar Business Plan</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Business Plan</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_business_plan.jsp"
					...
					<strong>Relatório..:</strong> <input name="consProjeto" type="text"
						...
						required="true" Placeholder="Código FK!"> <input
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<BusinessPlan> businessPlans = (List<BusinessPlan>) request.getAttribute("businessPlans");
								for (BusinessPlan businessPlan : businessPlans) {
							%>
						<tr>							
							<td><%=businessPlan.getCodigo()%></td>							
							<td><%=businessPlan.getProjetoinicio().getCodigo()%></td>
							<td><%=businessPlan.getProjetoinicio().getCodigoprojeto()%></td>							
							<td><%=businessPlan.getProjetoinicio().getProjeto()%></td>
							<td><%=businessPlan.getBusinessplan()%></td>
							<td><%=businessPlan.getVersao()%></td>
							<td><%=businessPlan.getData()%></td>
							<td><%=businessPlan.getAutor()%></td>
							<td><%=businessPlan.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarBusinessPlan&codigo=<%=businessPlan.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirBusinessPlan&codigo=<%=businessPlan.getCodigo()%>'><img
