...
<%@page import="br.com.tkcsapcd.model.bean.ModificacaoEscopo"%>
...
<title>Consultar Solicitação de Modificação de Escopo - ME</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Solicitação de Modificação de Escopo - ME</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_modificacao_escopo.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<ModificacaoEscopo> modificacaoEscopos = (List<ModificacaoEscopo>) request.getAttribute("modificacaoEscopos");
								for (ModificacaoEscopo modificacaoEscopo : modificacaoEscopos) {
							%>
						<tr>							
							<td><%=modificacaoEscopo.getCodigoprojeto()%></td>
							<td><%=modificacaoEscopo.getEmpresa()%></td>
							<td><%=modificacaoEscopo.getOrgao()%></td>
							<td><%=modificacaoEscopo.getSetor()%></td>
							<td><%=modificacaoEscopo.getPrograma()%></td>
							<td><%=modificacaoEscopo.getProjeto()%></td>
							<td><%=modificacaoEscopo.getGerente()%></td>
							<td><%=modificacaoEscopo.getRequerido()%></td>
							<td><%=modificacaoEscopo.getNumero_me()%></td>
							<td><%=modificacaoEscopo.getDataemissao()%></td>
							<td><a class="link_atualizar" href='TkcsapcdController?cmd=editarModificacaoEscopo&codigo=<%=modificacaoEscopo.getCodigo()%>'><img alt="" title="Atualizar" height="20" width="27" src="img/alterar.gif"></a></td>
							<td><a class="link_delete" href='TkcsapcdController?cmd=excluirModificacaoEscopo&codigo=<%=modificacaoEscopo.getCodigo()%>'><img alt="" title="Excluir" height="20" width="27" src="img/delete.gif"></a></td>
						</tr>
						<%
							}
						%>
