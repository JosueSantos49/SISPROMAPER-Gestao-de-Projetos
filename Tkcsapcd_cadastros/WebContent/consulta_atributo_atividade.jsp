...
<%@page import="br.com.tkcsapcd.model.bean.AtributoAtividade"%>
...
<title>Consultar Atributo das Atividades</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Atributo das Atividades</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_atributo_atividade.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<AtributoAtividade> atributoAtividades = (List<AtributoAtividade>) request.getAttribute("atributoAtividades");
								for (AtributoAtividade atributoAtividade : atributoAtividades) {
							%>
						<tr>							
							<td><%=atributoAtividade.getId()%></td>
							<td><%=atributoAtividade.getOrganograma().getData()%></td>
							<td><%=atributoAtividade.getOrganograma().getDescricao()%></td>
							<td><%=atributoAtividade.getResponsavel()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarAtributoAtividade&codigo=<%=atributoAtividade.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirAtributoAtividade&codigo=<%=atributoAtividade.getCodigo()%>'><img
