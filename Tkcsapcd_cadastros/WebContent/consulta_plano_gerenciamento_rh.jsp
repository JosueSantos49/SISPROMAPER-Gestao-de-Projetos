...
<%@page import="br.com.tkcsapcd.model.bean.PlanoGerenciamentoRH"%>
...
<title>Consultar Plano de Gerenciamento dos Recusos Humanos</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamento dos Recursos Humanos</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_gerenciamento_rh.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<PlanoGerenciamentoRH> planoGerenciamentoRHs = (List<PlanoGerenciamentoRH>) request.getAttribute("planoGerenciamentoRHs");
								for (PlanoGerenciamentoRH planoGerenciamentoRH : planoGerenciamentoRHs) {
							%>
						<tr>							
							<td><%=planoGerenciamentoRH.getCodigoprojeto()%></td>
							<td><%=planoGerenciamentoRH.getProjeto()%></td>
							<td><%=planoGerenciamentoRH.getPlanogerenciamentorh()%></td>
							<td><%=planoGerenciamentoRH.getVersao()%></td>
							<td><%=planoGerenciamentoRH.getData()%></td>
							<td><%=planoGerenciamentoRH.getAutor()%></td>
							<td><%=planoGerenciamentoRH.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoGerenciamentoRH&codigo=<%=planoGerenciamentoRH.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoGerenciamentoRH&codigo=<%=planoGerenciamentoRH.getCodigo()%>'><img
