// Highlight.js:
if (window.require) {
  require(["orgcharteditor/js/highlight.js"], function() {
    //This function is called after some/script.js has loaded.
  });
} else {
  document.write('<script src="orgcharteditor/js/highlight.js"></script>');
}

var link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "orgcharteditor/css/highlight.css";
...
function goSamples() {
  ...
  p.innerHTML = "<a href='javascript:goViewSource()'></a>";
  hdr.appendChild(p);
  var p1 = document.createElement("p");
  var samplename = location.pathname.substring(location.pathname.lastIndexOf("/") + 1);
  p1.innerHTML = "<a href='" + samplename + "' target='_blank'></a>";
  hdr.appendChild(p1);
