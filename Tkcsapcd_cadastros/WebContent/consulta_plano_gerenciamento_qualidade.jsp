...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamento de Qualidade</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_gerenciamento_qualidade.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<PlanoGerenciamentoQualidade> planoGerenciamentoQualidades = (List<PlanoGerenciamentoQualidade>) request.getAttribute("planoGerenciamentoQualidades");
								for (PlanoGerenciamentoQualidade planoGerenciamentoQualidade : planoGerenciamentoQualidades) {
							%>
						<tr>							
							<td><%=planoGerenciamentoQualidade.getCodigoprojeto()%></td>
							<td><%=planoGerenciamentoQualidade.getProjeto()%></td>
							<td><%=planoGerenciamentoQualidade.getPlanogerenciamentoqualidade()%></td>
							<td><%=planoGerenciamentoQualidade.getVersao()%></td>
							<td><%=planoGerenciamentoQualidade.getData()%></td>
							<td><%=planoGerenciamentoQualidade.getAutor()%></td>
							<td><%=planoGerenciamentoQualidade.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoGerenciamentoQualidade&codigo=<%=planoGerenciamentoQualidade.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoGerenciamentoQualidade&codigo=<%=planoGerenciamentoQualidade.getCodigo()%>'><img
