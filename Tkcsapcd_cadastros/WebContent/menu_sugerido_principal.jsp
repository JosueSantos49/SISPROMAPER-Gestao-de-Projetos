							...
							<div id="main">							
								<div class="wow slideInLeft" data-wow-duration="1s">
						            ...
						            <div class="alert alert-success">
										...
										<p><strong>Nota!</strong> Iniciar um projeto de qualquer tipo de ramo profissional ou proposta de projeto de forma fácil e prática com uma infraestrutura de formulário digital e salvar em um banco de dados do servidor.</p>
