...
<title>Adjudicação do contrato de aquisição</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Adjudicação do contrato de aquisição</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_modelo_contrato.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<ModeloContrato> modeloContratos = (List<ModeloContrato>) request.getAttribute("modeloContratos");
								for (ModeloContrato modeloContrato : modeloContratos) {
							%>
						<tr>							
							<td><%=modeloContrato.getCodigoprojeto()%></td>
							<td><%=modeloContrato.getProjeto()%></td>
							<td><%=modeloContrato.getModelocontrato()%></td>
							<td><%=modeloContrato.getVersao()%></td>
							<td><%=modeloContrato.getData()%></td>
							<td><%=modeloContrato.getAutor()%></td>
							<td><%=modeloContrato.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarModeloContrato&codigo=<%=modeloContrato.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirModeloContrato&codigo=<%=modeloContrato.getCodigo()%>'><img
