...
<%@page import="br.com.tkcsapcd.model.bean.ListaQualidade"%>
...
<title>Consultar Lista de Qualidade</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Lista de Qualidade</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_lista_qualidade.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<ListaQualidade> listaQualidades = (List<ListaQualidade>) request.getAttribute("listaQualidades");
								for (ListaQualidade listaQualidade : listaQualidades) {
							%>
						<tr>							
							<td><%=listaQualidade.getCodigoprojeto()%></td>
							<td><%=listaQualidade.getProjeto()%></td>
							<td><%=listaQualidade.getListaqualiade()%></td>
							<td><%=listaQualidade.getVersao()%></td>
							<td><%=listaQualidade.getData()%></td>
							<td><%=listaQualidade.getAutor()%></td>
							<td><%=listaQualidade.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarListaQualidade&codigo=<%=listaQualidade.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirListaQualidade&codigo=<%=listaQualidade.getCodigo()%>'><img
