...
<%@page import="br.com.tkcsapcd.model.bean.FornecedorQualificado"%>
...
<title>Listar Fornecedor Qualificado</title>
		            ...
		            <div class="container-fluid">
		                ...
		                <div class="row">
							...
							Olá, 
								...
								%>
								esta etapa permite listar fornecedor qualificado. Através do menu superior a esquerda, você pode executar outras transações. Fique atento você pode envolver pessoa, altera e excluir dado do registro. Outra transação <strong><a href="consulta_transacao.jsp" target="_parent">Clique aqui!</a></strong> 
							</div>
		                        ...
		                        <ol class="breadcrumb">
		                            ...
		                            <li class="active">
		                                <i class="fa fa-table"></i><font color="red">listar Fornecedor Qualificado</font>
		                            </li>
		                        </ol>
		                    </div>
		                </div>
                        ...
                        <div class="table-responsive"> 
								...
								<div class="table-responsive">
									<table id="tabela" cellspacing="5" cellspacing="5" class="display" class="table table-bordered table-hover">
										...
										<tbody>
												<%
													List<FornecedorQualificado> fornecedorQualificados = (List<FornecedorQualificado>) request.getAttribute("fornecedorQualificados");
													for (FornecedorQualificado fornecedorQualificado : fornecedorQualificados) {
												%>
											<tr>
																		
												<td><%=fornecedorQualificado.getRazaosocial()%></td>
												<td><%=fornecedorQualificado.getTelefone()%></td>
												<td><%=fornecedorQualificado.getFax()%></td>
												<td><%=fornecedorQualificado.getEndereco()%></td>
												<td><%=fornecedorQualificado.getBairro()%></td>
												<td><%=fornecedorQualificado.getCidade()%></td>
												<td><%=fornecedorQualificado.getEstado()%></td>
												<td><%=fornecedorQualificado.getCep()%></td>
												<td><%=fornecedorQualificado.getCnpj()%></td>
												<td><a class="link_atualizar" href='TkcsapcdController?cmd=editarFornecedorQualificado&codigo=<%=fornecedorQualificado.getCodigo()%>'><img alt="" title="Atualizar" height="20" width="27" src="img/alterar.gif"></a></td>
												<td><a class="link_delete"    href='TkcsapcdController?cmd=excluirFornecedorQualificado&codigo=<%=fornecedorQualificado.getCodigo()%>'><img alt="" title="Excluir" height="20" width="27" src="img/delete.gif"></a></td>
											</tr>
											<%
												}
											%>
