...
<%@ page import="java.util.List,br.com.tkcsapcd.model.bean.RelatorioEncerramentoContrato"%>
<html>
...
<title>Cadastrar Relatório de Encerramento do Contrato</title>
...
<script language="javascript" src="js/TexteareRelatorioEncerramentoContrato.js"></script>
...
<script>
	function show_confirm() {
		...
		if (r == true) {
			...
			location.href = "TkcsapcdController?cmd=consultarrelatorioEncerramentoContrato";
...
<script type="text/javascript">
	function setFocus() {
		document.getElementById("relatorioEncerramentoContrato").focus();
	}
</script>
...
<%@include file="menuperantecssadm.jsp"%>
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">Relatório de Encerramento do Contrato</font></th></tr></table><br>				
				<center>
					<h3>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarRelatorioEncerramentoContrato"></input>
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						<td><p align="justify"><b>Relatório <font color="red">*</font></b></p>
						<p align="justify">
								<input id="relatorio" name="relatorio"
									style="height: 30px; width: 379px" maxlength="150"
									value="${relatorioEncerramentoContrato.relatorio}" class="input" required="true"></input>
							<p class="hint">[Informar o relatorio.]</p></td>
					</tr>
					<tr>
						<td><br></td>
						<td><br></td>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="projeto" name="projeto"
									...
									Placeholder=""
									value="${relatorioEncerramentoContrato.projeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<p align="justify">
								...
								<!-- <input id="codigoprojeto" name="codigoprojeto"
									...
									value="${relatorioEncerramentoContrato.codigoprojeto}" class="input" required="true"
					...
					<tr class="field">
						<td><p align="justify">
								<b>Identificação do contrato  <font color="red">*</font></b>
						<p align="justify">
							<font color="blue"></font>
							</p> <textarea id="identificacao" name="identificacao" required="true"
								onkeyup="mostrarResultadoEtapa2(this.value,800,'spcontando');contarCaracteresEtapa2(this.value,800,'sprestante')"></textarea>
							<p class="hint">[Identifique o contrato com código, nome de forma clara e sem ambiguidade]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						<td><p align="justify">
								<b>Entregas realizadas <font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="entrega" name="entrega" required="true"
								onkeyup="mostrarResultadoEtapa3(this.value,800,'spcontando1');contarCaracteresEtapa3(this.value,800,'sprestante1')"></textarea>
							<p class="hint">[Descrever as entregas realizadas pelo contratado e previstas no contrato. ]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="questoes" name="questoes" required="true"
								onkeyup="mostrarResultadoEtapa4(this.value,800,'spcontando2');contarCaracteresEtapa4(this.value,800,'sprestante2')"></textarea>
							<p class="hint">[Usar caso haja alguma questão pendente em relação às entregas do contrato. Ex.: Requisitos não entregues]</p>
							<br>
						<br>
							<h5 align="left">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa5(this.value,800,'spcontando3');contarCaracteresEtapa5(this.value,800,'sprestante3')"></textarea>
					...
					<tr class="field">
						<td><p align="justify">
								<b>Aceite do Contrato <font color="red">*</font></b>
						<p align="justify">
								<font color="blue"></font>
							</p> <textarea id="aceite" name="aceite" required="true"
								onkeyup="mostrarResultadoEtapa6(this.value,800,'spcontando4');contarCaracteresEtapa6(this.value,800,'sprestante4')"></textarea>
							<p class="hint">[Os participantes autorizam o encerramento do contrato e atestam o cumprimento de todas clausulas e a inexistência de qualquer reinvindicação futura.]</p>
							<br>
						<br>
							<h5 align="left">
