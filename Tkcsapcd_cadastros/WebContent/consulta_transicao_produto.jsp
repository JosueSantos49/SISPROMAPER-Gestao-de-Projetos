...
<%@page import="br.com.tkcsapcd.model.bean.TransicaoProduto"%>
...
<title>Consultar Transição do Produto</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Transição do Produto</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_transicao_produto.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<TransicaoProduto> transicaoProdutos = (List<TransicaoProduto>) request.getAttribute("transicaoProdutos");
								for (TransicaoProduto transicaoProduto : transicaoProdutos) {
							%>
						<tr>							
							<td><%=transicaoProduto.getCodigoprojeto()%></td>
							<td><%=transicaoProduto.getProjeto()%></td>
							<td><%=transicaoProduto.getTransicaoproduto()%></td>
							<td><%=transicaoProduto.getVersao()%></td>
							<td><%=transicaoProduto.getData()%></td>
							<td><%=transicaoProduto.getAutor()%></td>
							<td><%=transicaoProduto.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarTransicaoProduto&codigo=<%=transicaoProduto.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirTransicaoProduto&codigo=<%=transicaoProduto.getCodigo()%>'><img
