...
<title>Atualizar Acompanhamento do Projeto</title>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#dataplanejada").mask("9999-99-99"); 
		$("#dataefetiva").mask("9999-99-99"); 
	});
</script>
	...
	<div align="center"> 
		...
		<form action="TkcsapcdController" id="formulario" name="formulario" onSubmit="validaCadastrarAnalise()" onclick="validaCadastrarAnalise()">
			...
			<fieldset>
				...
				<br> 
				<input type="hidden" name="cmd" value="atualizarAcompanhamentoProjeto"></input>
				...
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa1(this.value,1750,'spcontando0');contarCaracteresEtapa1(this.value,1750,'sprestante0')">${acompanhamentoProjeto.especificacao}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
							<font color="blue"></font>
								...
								onkeyup="mostrarResultadoEtapa2(this.value,1750,'spcontando');contarCaracteresEtapa2(this.value,1750,'sprestante')">${acompanhamentoProjeto.nivel}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa3(this.value,1750,'spcontando1');contarCaracteresEtapa3(this.value,1750,'sprestante1')">${acompanhamentoProjeto.acao}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa4(this.value,1750,'spcontando2');contarCaracteresEtapa4(this.value,1750,'sprestante2')">${acompanhamentoProjeto.responsavel}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa19(this.value,300,'spcontando17');contarCaracteresEtapa19(this.value,300,'sprestante17')">${acompanhamentoProjeto.aprovacao}</textarea>
