...
<%@page import="br.com.tkcsapcd.model.bean.AcompanhamentoProjeto"%>
...
<title>Consultar Acompanhamento do Projeto</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Acompanhamento do Projeto</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"	action="pesquisar_acompanhamento_projeto.jsp" onSubmit="return validaPesquisarRelatorio(this)">
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							...
							<th>Cód. Projeto</th>
							<th>Desc. Projeto</th>
							<th>Plano Gerenciamento Qualidade</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							<%
								List<AcompanhamentoProjeto> acompanhamentoProjetos = (List<AcompanhamentoProjeto>) request.getAttribute("acompanhamentoProjetos");
								for (AcompanhamentoProjeto acompanhamentoProjeto : acompanhamentoProjetos) {
							%>
						<tr>							
							<td><%=acompanhamentoProjeto.getCodigo()%></td>
							<td><%=acompanhamentoProjeto.getProjetoinicio().getCodigo()%></td>
							<td><%=acompanhamentoProjeto.getProjetoinicio().getCodigoprojeto()%></td>
							<td><%=acompanhamentoProjeto.getProjetoinicio().getProjeto()%></td>
							<td><%=acompanhamentoProjeto.getAcompanhamentoprojeto()%></td>
							<td><%=acompanhamentoProjeto.getVersao()%></td>
							<td><%=acompanhamentoProjeto.getData()%></td>
							<td><%=acompanhamentoProjeto.getAutor()%></td>
							<td><%=acompanhamentoProjeto.getNotarevisao()%></td>
							<td><a class="link_atualizar" href='TkcsapcdController?cmd=editarAcompanhamentoProjeto&codigo=<%=acompanhamentoProjeto.getCodigo()%>'><img alt="" title="Atualizar" height="20" width="27" src="img/alterar.gif"></a></td>
							<td><a class="link_delete" href='TkcsapcdController?cmd=excluirAcompanhamentoProjeto&codigo=<%=acompanhamentoProjeto.getCodigo()%>'><img alt="" title="Excluir" height="20" width="27" src="img/delete.gif"></a></td>
						</tr>
						<%
							}
						%>
