...
<title>Consultar Status Report</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Status Report</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_status_report.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							...
							%>
						<tr>							
							<td><%=statusReport.getCodigoprojeto()%></td>
							<td><%=statusReport.getProjeto()%></td>
							<td><%=statusReport.getStatusreport()%></td>
							<td><%=statusReport.getPeriodoinicio()%></td>
							<td><%=statusReport.getPeriodofim()%></td>
							<td><%=statusReport.getIndicador()%></td>
							<td><%=statusReport.getStatus()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarStatusReport&codigo=<%=statusReport.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirStatusReport&codigo=<%=statusReport.getCodigo()%>'><img
