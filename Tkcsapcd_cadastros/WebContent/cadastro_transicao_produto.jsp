...
<title>Cadastrar Transição do Produto</title>
			...
			<fieldset>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> A transição do produto, serviço ou resultado final para a operação deve acontecer conforme as politicas adotadas pela empresa.
				    </div>
				        ...
				        <div class="modal-dialog">
				            <div class="modal-content">
				                <div class="modal-header">
				                    ...
				                    <h2 class="modal-title">Transição do produto, serviço ou resultado final</h2>
				                </div>
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	A Transição do produto, serviço ou resultado final normalmente, adota-se um período de dias e um padrão de documentação para minimizar os problemas da transição para a operação.<br>
										As empresas devem ter politicas de incentivo para o time de projeto entregar um produto com qualidade e livre de defeitos.<br>										
										Saída de: 4.6 Encerrar o projeto ou fase
				                    </div>
				                </div>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarTransicaoProduto"></input>
