...
<title>Cadastrar Dicionário da EAP</title>
			...
			<fieldset>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> O dicionário da EAP traz todo detalhe necessário para cada elemento da EAP de modo a orientar a equipe do projeto. Contém informações sobre como o trabalho será realizado, questões técnicas, etc.
				    </div>
				        ...
				        <div class="modal-dialog">
				            <div class="modal-content">
				                <div class="modal-header">
				                    ...
				                    <h2 class="modal-title">Dicionário da EAP</h2>
				                </div>
