<!-- 
	...
	Ano: 2015
 -->
<%@page import="br.com.tkcsapcd.model.bean.FileBeanAjuda"%>
...
<head>
    ...
    <title>Consultar Arquivo Ajuda</title>
        ...
        <%@include file="menuperantecssadm.jsp"%>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> Segue a identificação, nome, descrição e link para executar o download do arquivo Ajuda. 
				    </div>
				            ...
				            <div class="modal-content">
				                ...
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	...
				                    	<!-- Modal -->
				                    	O sistema permite executar download e upload de arquivos a serem salvos no banco de dados do servidor. A transação de consultar arquivo ajuda, permitir exibir a identificação, nome, descrição e link para executar o download do arquivo.
				...
				<div id="main">
						...
						<div class="table-responsive">	
                               <table id="tabela" cellspacing="5" cellspacing="5" class="display">
								...
								<%
									List<FileBeanAjuda> fileBeanAjudas = (List<FileBeanAjuda>) request.getAttribute("fileBeanAjudas");
									for (FileBeanAjuda fileBeanAjuda : fileBeanAjudas) {
								%>
								<tr>
									<td><%=fileBeanAjuda.getId()%></td>
									<td><%=fileBeanAjuda.getName()%></td>
									<td><%=fileBeanAjuda.getDescription()%></td>
									<td><a href="downloadAjuda.do?id=<%=fileBeanAjuda.getId()%>">Baixar</a></td>
								</tr>
								<%
									}
								%>
