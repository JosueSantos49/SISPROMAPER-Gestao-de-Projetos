...
<title>Cadastrar Plano de Gerenciamento das Partes Interessadas</title>
			...
			<fieldset>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> O plano de gerenciamento das partes interessadas tem como objetivo principal definir as estratégias para aumentar o apoio, reduzir as resistências e minimizar os impactos negativos das partes interessadas durante todo o ciclo de vida do projeto.
				    </div>
				        ...
				        <div class="modal-dialog">
				            <div class="modal-content">
				                <div class="modal-header">
				                    ...
				                    <h2 class="modal-title">Plano de gerenciamento das partes interessadas</h2>
				                </div>
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	Gerenciar as partes interessadas do projeto requer um plano de gerenciamento das partes interessadas desenvolvido e aprovado durante a fase inicial do projeto englobando os processos necessários para assegurar que as partes interessadas sejam identificadas, engajadas e atendidas de acordo com os objetivos do projeto.<br><br>
				                    	Inclui elementos como:

										Principais partes interessadas que podem afetar o projeto de modo significativo;<br>
										Nível de participação no projeto desejado para cada parte interessada identificada;<br>
										Grupos de partes interessadas e sua administração (como grupos);<br>
										Matriz de análise das partes interessadas.<br><br>
										Como nosso objetivo é reduzir as resistências, o plano normalmente contem informações confidenciais e deve ser manuseado somente pelas pessoas autorizadas.<br>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarPlanoGerenciamentoParteInteressada"></input>
