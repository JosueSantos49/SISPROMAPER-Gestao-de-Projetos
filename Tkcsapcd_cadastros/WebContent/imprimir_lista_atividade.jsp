...
<title>Imprimir Lista das Atividades</title>
	...
	<table border="0" width="900" align="center" >
		<tr>			
			<td width="350" height="70" align="center">
				...
				<font color="#0404B4"><h3>RELATÓRIO GERAL LISTA DAS ATIVIDADES</h3></font>	
								<div align="right">
...
<div align="center">
  <table width="1100" border="0">
    <tr bgcolor="#CCCCCC">
    	<td width="90"><div align="" class="style6"><a href="imprimir_lista_atividade.jsp?ordenacao=crescente">CÓDIGO PROJETO</a></div></td>
      	<td width="90"><div align="" class="style6"><a href="imprimir_lista_atividade.jsp?ordenacao=alfabetica">NOME DO PROJETO</a></div></td>
      	<td width="90"><div align="" class="style5"><strong>LISTA ATIVIDADE</strong></div></td>  
	...
	try
	{
		...
		if(request.getParameter("acao") != null)
		{
			...
			st.executeUpdate("delete from listaatividade where codigo = "+request.getParameter("codigo"));
		}
		...
		if(request.getParameter("ordenacao") == null)
			{
				rs = st.executeQuery("select * from listaatividade order by codigoprojeto");
			}
		else if(request.getParameter("ordenacao").equals("crescente"))
			{
				rs = st.executeQuery("select * from listaatividade");
			}		
		else if(request.getParameter("ordenacao").equals("alfabetica"))
			{
				rs = st.executeQuery("select * from listaatividade order by notarevisao");
			}
	...
	%>
        <tr bgcolor="#FFFFFF">
         	<td><div align="left"><%=rs.getString("codigoprojeto")%></div></td>
          	...
          	<td><div align="left"><%=rs.getString("listaatividade")%></div></td>
  ...
  <br>
	 <div align="center">
        ...
        <input type="button" name="imprimir" id="imprimir" value="Impressão em tela" onclick="window.open('imprimir_lista_atividade.jsp')"/>
       	<input type="button" name="imprimir" id="imprimir" value="Relatório pop up" onclick="window.open('imprimir_lista_atividade.jsp','relatorio','toolbar=0,scrollbars=1,location=0,directories=0,copyhistory=0,status=0,menubar=0,resizable=0,width=800,height=600,z-lock,screenX=90,screenY=100,Left=100,Top=20')"/>
 	</div>
</body>
</html>
