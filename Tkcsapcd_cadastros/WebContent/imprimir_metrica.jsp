...
<table border="0" width="900" align="center" >
		<tr>			
			<td width="350" height="45px" colspan="2" align="center">
				...
				<h3><font color="#0404B4">RELATÓRIO GERAl MÉTRICA</font></h3>	
								<div align="right">
...
<div class="table-responsive">
   <table class="table" id="tableID"> 
    <tr class="info">   
      <td><div align="center" class="style6"><a href="imprimir_metrica.jsp?ordenacao=crescente">ID MÉTRICA</a></div></td>
      <td><div align="center" class="style5"><strong><a href="imprimir_metrica.jsp?ordenacao=alfabetica">NOME MÉTRICA</a></strong></div></td>
      <td><div align="center" class="style5"><strong>ÍNDICE MÉTRICA</strong></div></td>
      <td><div align="center" class="style5"><strong>VALOR REFERÊCIA-HORA</strong></div></td>
	...
	<%
		...
		if(totalRegistros - (Integer.parseInt(numPagina) * limite) > 0){
			...
			out.println("<ul class='pagination'>");
			out.println("<li><a href=imprimir_metrica.jsp?numpagina="+proximaPag+"> Próxima >> </a></li>");
			out.println("</ul>");
		}
  ...
  <table width="400" border="0">
    <tr>
      <td><div align="center"> <span class="style1 style2 style5">
        ...
        <input type="button" name="imprimir" id="imprimir" value="Impressão em tela" onclick="window.open('imprimir_metrica.jsp')"/>
        <input type="button" name="imprimir" id="imprimir" value="Relatório pop up" onclick="window.open('imprimir_metrica.jsp','relatorio','toolbar=0,scrollbars=1,location=0,directories=0,copyhistory=0,status=0,menubar=0,resizable=0,width=800,height=600,z-lock,screenX=90,screenY=100,Left=100,Top=20')"/>
 	  </span></div></td>
    </tr>
  </table>
</div>
