...
<title>Consultar Business PlanDetalhe</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Business Plan Detalhes</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_business_plan_detalhe.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<BusinessPlanDetalhe> businessPlanDetalhes = (List<BusinessPlanDetalhe>) request.getAttribute("businessPlanDetalhes");
								for (BusinessPlanDetalhe businessPlanDetalhe : businessPlanDetalhes) {
							%>
						<tr>							
							<td><%=businessPlanDetalhe.getCodigoprojeto()%></td>
							<td><%=businessPlanDetalhe.getProjeto()%></td>
							<td><%=businessPlanDetalhe.getBusinessplan()%></td>
							<td><%=businessPlanDetalhe.getVersao()%></td>
							<td><%=businessPlanDetalhe.getData()%></td>
							<td><%=businessPlanDetalhe.getAutor()%></td>
							<td><%=businessPlanDetalhe.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarBusinessPlanDetalhe&codigo=<%=businessPlanDetalhe.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirBusinessPlanDetalhe&codigo=<%=businessPlanDetalhe.getCodigo()%>'><img
