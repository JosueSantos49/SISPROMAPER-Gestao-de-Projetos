...
<title>Cadastrar Plano de Gerenciamento dos Recursos Humanos</title>
			...
			<fieldset>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> O plano de recursos humanos, ou, plano de gerenciamento dos recursos humanos, é um dos planos auxiliares do plano de gerenciamento do projeto.
				    </div>
				        ...
				        <div class="modal-dialog">
				            <div class="modal-content">
				                <div class="modal-header">
				                    ...
				                    <h2 class="modal-title">Plano de gerenciamento dos recursos humanos</h2>
				                </div>
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	O plano de recursos humanos, também chamado de plano de gerenciamento dos recursos humanos, fornece orientação sobre como os recursos humanos do projeto devem ser definidos, mobilizados, gerenciados, controlados e, por fim, liberados.<br>
				                    	Saída de: Planejar o gerenciamento dos recursos humanos<br>
										Entrada para: Estimar os custos
				                    </div>
				                </div>
				...
				<br> 
				<input type="hidden" name="cmd" value="cadastrarPlanoGerenciamentoRH"></input>
