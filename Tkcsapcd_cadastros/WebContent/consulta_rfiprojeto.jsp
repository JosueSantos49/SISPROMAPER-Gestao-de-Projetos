	...
	<div align="center"></div>
		<br>
			...
			<form id="formConsRfpProjeto" name="formConsRfpProjeto" method="post" action="pesquisar_rfiprojeto.jsp" onSubmit="validaPesquisarRelatorioRfiprojeto()">
				...
				<input name="consRfiprojeto" type="text" id="consRfiprojeto" title="Digite o Código do Projeto para pesquisar" required="true" Placeholder="Código Registro!">				
				<input class="button" name="pesqRfiprojeto" type="submit" id="pesqRfiprojeto" value="Exibir" title="Digite o Código do Projeto para pesquisar" onclick="validaPesquisarRelatorioRfiprojeto();">				
			</form>
			</div> 
		<br>
		<br>
