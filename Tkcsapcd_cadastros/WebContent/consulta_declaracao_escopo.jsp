...
<title>Consultar Declaração do Escopo</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Declaração do Escopo</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_declaracao_escopo.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							...
							%>
						<tr>							
							<td><%=declaracaoEscopo.getCodigoprojeto()%></td>
							<td><%=declaracaoEscopo.getEmpresa()%></td>
							<td><%=declaracaoEscopo.getOrgao()%></td>
							<td><%=declaracaoEscopo.getSetor()%></td>
							<td><%=declaracaoEscopo.getPrograma()%></td>
							<td><%=declaracaoEscopo.getProjeto()%></td>
							<td><%=declaracaoEscopo.getGerente()%></td>
							<td><%=declaracaoEscopo.getFuncao()%></td>
							<td><%=declaracaoEscopo.getAprovado()%></td>
							<td><%=declaracaoEscopo.getVersao()%></td>							
							<td><%=declaracaoEscopo.getDataaprovacao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarDeclaracaoescopo&codigo=<%=declaracaoEscopo.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirDeclaracaoescopo&codigo=<%=declaracaoEscopo.getCodigo()%>'><img
