...
function contarCaracteresEtapa5(box,valor,campospan3){
	...
	if(box.length >= valor){
		...
		document.getElementById("responsabilidade").value = document.getElementById("responsabilidade").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//4
...
function contarCaracteresEtapa6(box1,valor1,campospan4){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("configuracao").value = document.getElementById("configuracao").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//5
...
function contarCaracteresEtapa7(box2,valor2,campospan5){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("prioridade").value = document.getElementById("prioridade").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//6
...
function contarCaracteresEtapa8(box6,valor6,campospan6){
	...
	if(box6.length >= valor6){
		...
		document.getElementById("coleta").value = document.getElementById("coleta").value.substr(0,valor6);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
...
function contarCaracteresEtapa9(box7,valor7,campospan7){
	...
	if(box7.length >= valor7){
		...
		document.getElementById("ratreabilidade").value = document.getElementById("ratreabilidade").value.substr(0,valor7);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//8
...
function contarCaracteresEtapa10(box8,valor8,campospan8){
	...
	if(box8.length >= valor8){
		...
		document.getElementById("metrica").value = document.getElementById("metrica").value.substr(0,valor8);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//9
