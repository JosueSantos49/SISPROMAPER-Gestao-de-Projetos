...
function contarCaracteresEtapa1(box0,valor0,campospan0){
	...
	if(box0.length >= valor0){
		...
		document.getElementById("produtos").value = document.getElementById("produtos").value.substr(0,valor0);
	}	
}
//---------------------------------------------------------------------------------------------------------------------------------------
//Projeto Compulsório 
...
function contarCaracteresEtapa2(box,valor,campospan){
	...
	if(box.length >= valor){
		...
		document.getElementById("marcas").value = document.getElementById("marcas").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//Projeto Qualitativo 
...
function contarCaracteresEtapa3(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("contratosocial").value = document.getElementById("contratosocial").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa4(box2,valor2,campospan2){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("cartaocnpj").value = document.getElementById("cartaocnpj").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa5(box,valor,campospan3){
	...
	if(box.length >= valor){
		...
		document.getElementById("fazendafederal").value = document.getElementById("fazendafederal").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//4
...
function contarCaracteresEtapa6(box1,valor1,campospan4){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("fazendaestadual").value = document.getElementById("fazendaestadual").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//5
...
function contarCaracteresEtapa7(box2,valor2,campospan5){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("fazendamunicipal").value = document.getElementById("fazendamunicipal").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//6
...
function contarCaracteresEtapa8(box6,valor6,campospan6){
	...
	if(box6.length >= valor6){
		...
		document.getElementById("inss").value = document.getElementById("inss").value.substr(0,valor6);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
...
function contarCaracteresEtapa9(box7,valor7,campospan7){
	...
	if(box7.length >= valor7){
		...
		document.getElementById("fgts").value = document.getElementById("fgts").value.substr(0,valor7);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//8
...
function contarCaracteresEtapa10(box8,valor8,campospan8){
	...
	if(box8.length >= valor8){
		...
		document.getElementById("capacidadetecnica").value = document.getElementById("capacidadetecnica").value.substr(0,valor8);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//9
...
function contarCaracteresEtapa11(box9,valor9,campospan9){
	...
	if(box9.length >= valor9){
		...
		document.getElementById("relacaocliente").value = document.getElementById("relacaocliente").value.substr(0,valor9);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//10
...
function contarCaracteresEtapa12(box10,valor10,campospan10){
	...
	if(box10.length >= valor10){
		...
		document.getElementById("referenciacomenrcail").value = document.getElementById("referenciacomenrcail").value.substr(0,valor10);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//11
...
function contarCaracteresEtapa13(box11,valor11,campospan11){
	...
	if(box11.length >= valor11){
		...
		document.getElementById("registro").value = document.getElementById("registro").value.substr(0,valor11);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//12
...
function contarCaracteresEtapa14(box12,valor12,campospan12){
	...
	if(box12.length >= valor12){
		...
		document.getElementById("certidaonegativa").value = document.getElementById("certidaonegativa").value.substr(0,valor12);
	}	
}
/*
//------------------------------------------------------------------------------------------------------------------------------------------------------
