...
function contarCaracteresEtapa1(box0,valor0,campospan0){
	...
	if(box0.length >= valor0){
		...
		document.getElementById("parteinteressada").value = document.getElementById("parteinteressada").value.substr(0,valor0);
	}	
}
//---------------------------------------------------------------------------------------------------------------------------------------
//Projeto Compulsório 
...
function contarCaracteresEtapa2(box,valor,campospan){
	...
	if(box.length >= valor){
		...
		document.getElementById("empresa").value = document.getElementById("empresa").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//Projeto Qualitativo 
...
function contarCaracteresEtapa3(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("funcaoprojeto").value = document.getElementById("funcaoprojeto").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa4(box2,valor2,campospan2){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("requisito").value = document.getElementById("requisito").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa6(box1,valor1,campospan4){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("expectativas").value = document.getElementById("expectativas").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//5
