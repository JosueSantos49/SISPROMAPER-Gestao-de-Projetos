...
//1
function mostrarResultadoNomedemanda(box0,num_max0,campospan0){
...
function contarCaracteresNomedemanda(box0,valor0,campospan0){
	...
	if(box0.length >= valor0){
		...
		document.getElementById("nomedemanda").value = document.getElementById("nomedemanda").value.substr(0,valor0);
	}	
}
//---------------------------------------------------------------------------------------------------------------------------------------
//2
function mostrarObjetivoDemanda(box1,num_max1,campospan1){
...
function contarCaracteresObjetivoDemanda(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("objetivodemanda").value = document.getElementById("objetivodemanda").value.substr(0,valor1);
	}	
}
//---------------------------------------------------------------------------------------------------------------------------------------
//3
function mostrarResultadoDescricaoProblema(box,num_max,campospan3){
...
function contarCaracteresDescricaoProblema(box,valor,campospan3){
	...
	if(box.length >= valor){
		...
		document.getElementById("decricaoproblema").value = document.getElementById("decricaoproblema").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//4
function mostrarResultadoDesenhoProcesso(box1,num_max1,campospan4){
	var contagem_carac1 = box1.length;
	if (contagem_carac1 != 0){
...
function contarCaracteresDesenhoProcesso(box1,valor1,campospan4){
	var conta1 = valor1 - box1.length;
	...
	if(box1.length >= valor1){
		...
		document.getElementById("desenhoprocesso").value = document.getElementById("desenhoprocesso").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//5
function mostrarResultadoFuncionalidade(box2,num_max2,campospan5){
...
function contarCaracteresFuncionalidade(box2,valor2,campospan5){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("funcionalidade").value = document.getElementById("funcionalidade").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//6
function mostrarResultadoParteenvolvida(box6,num_max6,campospan6){
...
function contarCaracteresParteenvolvida(box6,valor6,campospan6){
	...
	if(box6.length >= valor6){
		...
		document.getElementById("parteenvolvida").value = document.getElementById("parteenvolvida").value.substr(0,valor6);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
function mostrarResultadoParteenvolvidaRepresentante(box7,num_max7,campospan7){
...
function contarCaracteresParteenvolvidaRepresentante(box7,valor7,campospan7){
	...
	if(box7.length >= valor7){
		...
		document.getElementById("parteenvolvidarepresentante").value = document.getElementById("parteenvolvidarepresentante").value.substr(0,valor7);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//8
function mostrarResultadoParteenvolvidaFormaContato(box8,num_max8,campospan8){
...
function contarCaracteresParteenvolvidaFormaContato(box8,valor8,campospan8){
	...
	if(box8.length >= valor8){
		...
		document.getElementById("parteenvolvidaformacontato").value = document.getElementById("parteenvolvidaformacontato").value.substr(0,valor8);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//9
function mostrarResultadoEstimativacustoglobal(box9,num_max9,campospan9){
...
function contarCaracteresEstimativacustoglobal(box9,valor9,campospan9){
	...
	if(box9.length >= valor9){
		...
		document.getElementById("estimativacustoglobal").value = document.getElementById("estimativacustoglobal").value.substr(0,valor9);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//10
function mostrarResultadoFontefinaciamento(box10,num_max10,campospan10){
...
function contarCaracteresFontefinaciamento(box10,valor10,campospan10){
	...
	if(box10.length >= valor10){
		...
		document.getElementById("fontefinanciamento").value = document.getElementById("fontefinanciamento").value.substr(0,valor10);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//11
function mostrarResultadoMetodolevantamentocusto(box11,num_max11,campospan11){
...
function contarCaracteresMetodolevantamentocusto(box11,valor11,campospan11){
	...
	if(box11.length >= valor11){
		...
		document.getElementById("metodolevantamentocusto").value = document.getElementById("metodolevantamentocusto").value.substr(0,valor11);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//12
function mostrarResultadoNumerousuarioprevisto(box12,num_max12,campospan12){
...
function contarCaracteresNumerousuarioprevisto(box12,valor12,campospan12){
	...
	if(box12.length >= valor12){
		...
		document.getElementById("numerousuarioprevisto").value = document.getElementById("numerousuarioprevisto").value.substr(0,valor12);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//13
function mostrarResultadoRestricaoprojeto(box13,num_max13,campospan13){
...
function contarCaracteresRestricaoprojeto(box13,valor13,campospan13){
	...
	if(box13.length >= valor13){
		...
		document.getElementById("restricaoprojeto").value = document.getElementById("restricaoprojeto").value.substr(0,valor13);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//14
function mostrarResultadoNecessidadeusuario(box14,num_max14,campospan14){
...
function contarCaracteresNecessidadeusuario(box14,valor14,campospan14){
	...
	if(box14.length >= valor14){
		...
		document.getElementById("necessidadeusuario").value = document.getElementById("necessidadeusuario").value.substr(0,valor14);
	}	
}