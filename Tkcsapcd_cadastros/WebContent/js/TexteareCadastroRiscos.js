...
function contarCaracteresEtapa1(box0,valor0,campospan0){
	...
	if(box0.length >= valor0){
		...
		document.getElementById("etapa1").value = document.getElementById("etapa1").value.substr(0,valor0);
	}	
}
//---------------------------------------------------------------------------------------------------------------------------------------
//Projeto Compulsório 
...
function contarCaracteresEtapa2(box,valor,campospan){
	...
	if(box.length >= valor){
		...
		document.getElementById("etapa2").value = document.getElementById("etapa2").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//Projeto Qualitativo 
...
function contarCaracteresEtapa3(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("etapa3").value = document.getElementById("etapa3").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa4(box2,valor2,campospan2){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("etapa4").value = document.getElementById("etapa4").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//Projeto Status 
