...
function contarCaracteresEtapa1(box0,valor0,campospan0){
	...
	if(box0.length >= valor0){
		...
		document.getElementById("posicionamento").value = document.getElementById("posicionamento").value.substr(0,valor0);
	}	
}
//---------------------------------------------------------------------------------------------------------------------------------------
//Projeto Compulsório 
...
function contarCaracteresEtapa2(box,valor,campospan){
	...
	if(box.length >= valor){
		...
		document.getElementById("estrategiaproduto").value = document.getElementById("estrategiaproduto").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//Projeto Qualitativo 
...
function contarCaracteresEtapa3(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("produtooferecido").value = document.getElementById("produtooferecido").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa4(box2,valor2,campospan2){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("servicooferecido").value = document.getElementById("servicooferecido").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa5(box,valor,campospan3){
	...
	if(box.length >= valor){
		...
		document.getElementById("preco").value = document.getElementById("preco").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//4
...
function contarCaracteresEtapa6(box1,valor1,campospan4){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("distribuicao").value = document.getElementById("distribuicao").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//5
...
function contarCaracteresEtapa7(box2,valor2,campospan5){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("promocaovenda").value = document.getElementById("promocaovenda").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//6
...
function contarCaracteresEtapa8(box6,valor6,campospan6){
	...
	if(box6.length >= valor6){
		...
		document.getElementById("tecnologia").value = document.getElementById("tecnologia").value.substr(0,valor6);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
...
function contarCaracteresEtapa9(box7,valor7,campospan7){
	...
	if(box7.length >= valor7){
		...
		document.getElementById("acao").value = document.getElementById("acao").value.substr(0,valor7);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//8
...
function contarCaracteresEtapa10(box8,valor8,campospan8){
	...
	if(box8.length >= valor8){
		...
		document.getElementById("projetoresultado").value = document.getElementById("projetoresultado").value.substr(0,valor8);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//9
...
function contarCaracteresEtapa11(box9,valor9,campospan9){
	...
	if(box9.length >= valor9){
		...
		document.getElementById("controle").value = document.getElementById("controle").value.substr(0,valor9);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//10
...
function contarCaracteresEtapa12(box10,valor10,campospan10){
	...
	if(box10.length >= valor10){
		...
		document.getElementById("contigencia").value = document.getElementById("contigencia").value.substr(0,valor10);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//11
