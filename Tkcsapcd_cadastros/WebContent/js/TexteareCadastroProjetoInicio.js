...
function contarCaracteresEtapa1(box0,valor0,campospan0){
	...
	document.getElementById(campospan0).innerHTML = "Voce ainda pode digitar " + conta0 + " caracteres";
	if(box0.length >= valor0){
		document.getElementById(campospan0).innerHTML = "Opss.. voce nao pode mais digitar..";
...
function contarCaracteresEtapa2(box,valor,campospan){
	...
	document.getElementById(campospan).innerHTML = "Voce ainda pode digitar " + conta + " caracteres";
	if(box.length >= valor){
		document.getElementById(campospan).innerHTML = "Opss.. voce nao pode mais digitar..";
		document.getElementById("descricao").value = document.getElementById("descricao").value.substr(0,valor);
	}	
}
/*
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa3(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("processo").value = document.getElementById("processo").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa4(box2,valor2,campospan2){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("documento").value = document.getElementById("documento").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa5(box,valor,campospan3){
	...
	if(box.length >= valor){
		...
		document.getElementById("ferramenta").value = document.getElementById("ferramenta").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//4
...
function contarCaracteresEtapa6(box1,valor1,campospan4){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("papeis").value = document.getElementById("papeis").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//5
...
function contarCaracteresEtapa7(box2,valor2,campospan5){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("plano").value = document.getElementById("plano").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//6
...
function contarCaracteresEtapa8(box6,valor6,campospan6){
	...
	if(box6.length >= valor6){
		...
		document.getElementById("atividade").value = document.getElementById("atividade").value.substr(0,valor6);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
...
function contarCaracteresEtapa9(box7,valor7,campospan7){
	...
	if(box7.length >= valor7){
		...
		document.getElementById("sequenciar").value = document.getElementById("sequenciar").value.substr(0,valor7);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//8
...
function contarCaracteresEtapa10(box8,valor8,campospan8){
	...
	if(box8.length >= valor8){
		...
		document.getElementById("estimarrecuso").value = document.getElementById("estimarrecuso").value.substr(0,valor8);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//9
...
function contarCaracteresEtapa11(box9,valor9,campospan9){
	...
	if(box9.length >= valor9){
		...
		document.getElementById("estimarduracao").value = document.getElementById("estimarduracao").value.substr(0,valor9);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//10
...
function contarCaracteresEtapa12(box10,valor10,campospan10){
	...
	if(box10.length >= valor10){
		...
		document.getElementById("desenvolver").value = document.getElementById("desenvolver").value.substr(0,valor10);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//11
...
function contarCaracteresEtapa13(box11,valor11,campospan11){
	...
	if(box11.length >= valor11){
		...
		document.getElementById("#").value = document.getElementById("#").value.substr(0,valor11);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//12
...
function contarCaracteresEtapa14(box12,valor12,campospan12){
	...
	if(box12.length >= valor12){
		...
		document.getElementById("#").value = document.getElementById("#").value.substr(0,valor12);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//13
...
function contarCaracteresEtapa15(box14,valor14,campospan14){
	...
	if(box14.length >= valor14){
		...
		document.getElementById("#").value = document.getElementById("#").value.substr(0,valor14);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//6
...
function contarCaracteresEtapa16(box14,valor14,campospan14){
	...
	if(box14.length >= valor14){
		document.getElementById(campospan14).innerHTML = "Opss.. você não pode mais digitar..";
		document.getElementById("controlar").value = document.getElementById("controlar").value.substr(0,valor14);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
...
function contarCaracteresEtapa17(box15,valor15,campospan15){
	...
	if(box15.length >= valor15){
		...
		document.getElementById("#").value = document.getElementById("#").value.substr(0,valor15);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
