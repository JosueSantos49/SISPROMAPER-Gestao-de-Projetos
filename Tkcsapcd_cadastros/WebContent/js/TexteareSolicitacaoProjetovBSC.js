...
function contarCaracteresEtapa3(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("criterio").value = document.getElementById("criterio").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa4(box2,valor2,campospan2){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("descricaobeneficio").value = document.getElementById("descricaobeneficio").value.substr(0,valor2);
	}	
}
/*
//------------------------------------------------------------------------------------------------------------------------------------------------------
