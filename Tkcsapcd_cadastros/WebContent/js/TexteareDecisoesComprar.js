...
function contarCaracteresEtapa1(box0,valor0,campospan0){
	...
	if(box0.length >= valor0){
		...
		document.getElementById("itens").value = document.getElementById("itens").value.substr(0,valor0);
	}	
}
//---------------------------------------------------------------------------------------------------------------------------------------
//Projeto Compulsório 
...
function contarCaracteresEtapa2(box,valor,campospan){
	...
	if(box.length >= valor){
		...
		document.getElementById("motivodecisao").value = document.getElementById("motivodecisao").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//Projeto Qualitativo 
...
function contarCaracteresEtapa3(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("fornecedores").value = document.getElementById("fornecedores").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa4(box2,valor2,campospan2){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("previsao").value = document.getElementById("previsao").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa6(box1,valor1,campospan4){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("tipocontrato").value = document.getElementById("tipocontrato").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//5
