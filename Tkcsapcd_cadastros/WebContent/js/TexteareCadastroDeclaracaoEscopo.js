...
function contarCaracteresEtapa3(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("descricao").value = document.getElementById("descricao").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa4(box2,valor2,campospan2){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("lista").value = document.getElementById("lista").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa5(box,valor,campospan3){
	...
	if(box.length >= valor){
		...
		document.getElementById("ligacao").value = document.getElementById("ligacao").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//4
...
function contarCaracteresEtapa6(box1,valor1,campospan4){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("estrategia").value = document.getElementById("estrategia").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//5
...
function contarCaracteresEtapa7(box2,valor2,campospan5){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("responsabilidade").value = document.getElementById("responsabilidade").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//6
...
function contarCaracteresEtapa8(box6,valor6,campospan6){
	...
	if(box6.length >= valor6){
		...
		document.getElementById("macro").value = document.getElementById("macro").value.substr(0,valor6);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
...
function contarCaracteresEtapa9(box7,valor7,campospan7){
	...
	if(box7.length >= valor7){
		...
		document.getElementById("premissas").value = document.getElementById("premissas").value.substr(0,valor7);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//8
...
function contarCaracteresEtapa10(box8,valor8,campospan8){
	...
	if(box8.length >= valor8){
		...
		document.getElementById("restricoes").value = document.getElementById("restricoes").value.substr(0,valor8);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//9
...
function contarCaracteresEtapa11(box9,valor9,campospan9){
	...
	if(box9.length >= valor9){
		...
		document.getElementById("equipe").value = document.getElementById("equipe").value.substr(0,valor9);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//10
...
function contarCaracteresEtapa12(box10,valor10,campospan10){
	...
	if(box10.length >= valor10){
		...
		document.getElementById("obs").value = document.getElementById("obs").value.substr(0,valor10);
	}	
}
