...
function contarCaracteres(box,valor,campospan){
	...
	if(box.length >= valor){
		...
		document.getElementById("resumo").value = document.getElementById("resumo").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//Requerimento funcional 
function mostrarResultadoFuncional(box1,num_max1,campospan1){
...
function contarCaracteresFuncional(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("rqfuncional").value = document.getElementById("rqfuncional").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//Requerimento tecnologico
function mostrarResultadoTecnologico(box2,num_max2,campospan2){
...
function contarCaracteresTecnologico(box2,valor2,campospan2){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("rqtecnologico").value = document.getElementById("rqtecnologico").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//Projeto Status 
