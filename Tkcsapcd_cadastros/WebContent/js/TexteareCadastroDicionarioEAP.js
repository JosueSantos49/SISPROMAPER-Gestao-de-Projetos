...
function contarCaracteresEtapa1(box0,valor0,campospan0){
	...
	if(box0.length >= valor0){
		...
		document.getElementById("entregapacote").value = document.getElementById("entregapacote").value.substr(0,valor0);
	}	
}
//---------------------------------------------------------------------------------------------------------------------------------------
//Projeto Compulsório 
...
function contarCaracteresEtapa3(box1,valor1,campospan1){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("criterioaceitacao").value = document.getElementById("criterioaceitacao").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
...
function contarCaracteresEtapa5(box,valor,campospan3){
	...
	if(box.length >= valor){
		...
		document.getElementById("aprovado").value = document.getElementById("aprovado").value.substr(0,valor);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//4
...
function contarCaracteresEtapa6(box1,valor1,campospan4){
	...
	if(box1.length >= valor1){
		...
		document.getElementById("consultado").value = document.getElementById("consultado").value.substr(0,valor1);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//5
...
function contarCaracteresEtapa7(box2,valor2,campospan5){
	...
	if(box2.length >= valor2){
		...
		document.getElementById("informado").value = document.getElementById("informado").value.substr(0,valor2);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//6
...
function contarCaracteresEtapa8(box6,valor6,campospan6){
	...
	if(box6.length >= valor6){
		...
		document.getElementById("trabalhoenvolvido").value = document.getElementById("trabalhoenvolvido").value.substr(0,valor6);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
...
function contarCaracteresEtapa10(box8,valor8,campospan8){
	...
	if(box8.length >= valor8){
		...
		document.getElementById("recusos").value = document.getElementById("recusos").value.substr(0,valor8);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//9
...
function contarCaracteresEtapa11(box9,valor9,campospan9){
	...
	if(box9.length >= valor9){
		...
		document.getElementById("macros").value = document.getElementById("macros").value.substr(0,valor9);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//10
...
function contarCaracteresEtapa12(box10,valor10,campospan10){
	...
	if(box10.length >= valor10){
		...
		document.getElementById("previsao").value = document.getElementById("previsao").value.substr(0,valor10);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//11
...
function contarCaracteresEtapa16(box14,valor14,campospan14){
	...
	if(box14.length >= valor14){
		document.getElementById(campospan14).innerHTML = "Opss.. você não pode mais digitar..";
		document.getElementById("informacoes").value = document.getElementById("informacoes").value.substr(0,valor14);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
...
function contarCaracteresEtapa17(box15,valor15,campospan15){
	...
	if(box15.length >= valor15){
		...
		document.getElementById("comentarios").value = document.getElementById("comentarios").value.substr(0,valor15);
	}	
}
//------------------------------------------------------------------------------------------------------------------------------------------------------
//7
