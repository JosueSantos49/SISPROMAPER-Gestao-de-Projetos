<!-- 
	...
	Ano: 2015
 -->
<%@page import="br.com.tkcsapcd.model.bean.OrganogramaMapa"%>
...
<title>Consultar Organograma Mapa</title>	
...
<div class="container">
		...
		<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_organograma_mapa.jsp"
		...
		<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<OrganogramaMapa> organogramaMapas = (List<OrganogramaMapa>) request.getAttribute("organogramaMapas");
								for (OrganogramaMapa organogramaMapa : organogramaMapas) {
							%>
						<tr>							
							<td><%=organogramaMapa.getCodigoprojeto()%></td>
							<td><%=organogramaMapa.getData()%></td>
							<td><%=organogramaMapa.getDescricao()%></td>
							<td><a 	href='TkcsapcdController?cmd=editarOrganogramaMapaStatus&codigo=<%=organogramaMapa.getCodigo()%>'><img
									alt="" title="Consultar Status" height="20" width="27"
									src="img/ok.jpg"></a></td>
							
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarOrganogramaMapa&codigo=<%=organogramaMapa.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirOrganogramaMapa&codigo=<%=organogramaMapa.getCodigo()%>'><img
