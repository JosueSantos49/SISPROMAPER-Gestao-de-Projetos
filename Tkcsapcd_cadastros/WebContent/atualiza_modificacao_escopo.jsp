...
<title>Atualizar Solicitação de Modificação de Escopo</title>
...
<script>
	function show_confirm() {
		...
		if (r == true) {
			...
			location.href = "TkcsapcdController?cmd=consultarModificacaoEscopo";
	...
	<div align="center">
		...
		<form action="TkcsapcdController" id="formulario" name="formulario"	onsubmit="validaCadastrarRiscos()">
			...
			<fieldset>
				...
				<br> 
				<input type="hidden" name="cmd" value="atualizarModificacaoEscopo"></input>
				...
				<table border="0" cellspacing="3" cellpadding="3" width="100%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<td><p align="justify">
								<input id="codigoprojeto" name="codigoprojeto"
									...
									Placeholder=""
									value="${modificacaoEscopo.codigoprojeto}" class="input" required="true"
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa1(this.value,200,'spcontando0');contarCaracteresEtapa1(this.value,200,'sprestante0')">${modificacaoEscopo.descricao}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa2(this.value,200,'spcontando');contarCaracteresEtapa2(this.value,200,'sprestante')">${modificacaoEscopo.motivo}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa3(this.value,200,'spcontando1');contarCaracteresEtapa3(this.value,200,'sprestante1')">${modificacaoEscopo.impacto}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa4(this.value,200,'spcontando2');contarCaracteresEtapa4(this.value,200,'sprestante2')">${modificacaoEscopo.escopo}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa5(this.value,200,'spcontando3');contarCaracteresEtapa5(this.value,200,'sprestante3')">${modificacaoEscopo.custo}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa6(this.value,200,'spcontando4');contarCaracteresEtapa6(this.value,200,'sprestante4')">${modificacaoEscopo.prazo}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa7(this.value,200,'spcontando5');contarCaracteresEtapa7(this.value,200,'sprestante5')">${modificacaoEscopo.comentarios}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa8(this.value,200,'spcontando6');contarCaracteresEtapa8(this.value,200,'sprestante6')">${modificacaoEscopo.referencia}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa9(this.value,200,'spcontando7');contarCaracteresEtapa9(this.value,200,'sprestante7')">${modificacaoEscopo.anexo}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa10(this.value,200,'spcontando8');contarCaracteresEtapa10(this.value,200,'sprestante8')">${modificacaoEscopo.parecer}</textarea>
					...
					<tr class="field">
						...
						<td><p align="justify">
								...
								onkeyup="mostrarResultadoEtapa11(this.value,200,'spcontando9');contarCaracteresEtapa11(this.value,200,'sprestante9')">${modificacaoEscopo.aprovacao}</textarea>
