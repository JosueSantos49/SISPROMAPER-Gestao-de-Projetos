...
<title>Consultar Dicionário da EAP</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Dicionário da EAP</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_dicionario_eap.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							...
							%>
						<tr>							
							<td><%=dicionarioEAP.getProjetoinicio().getCodigo()%></td>
							<td><%=dicionarioEAP.getDicionarioeap()%></td>
							<td><%=dicionarioEAP.getCodigoeap()%></td>
							<td><%=dicionarioEAP.getVersao()%></td>
							<td><%=dicionarioEAP.getData()%></td>
							<td><%=dicionarioEAP.getAutor()%></td>
							<td><%=dicionarioEAP.getNotarevisao()%></td>
							<td><%=dicionarioEAP.getCustos()%></td>
							<td><%=dicionarioEAP.getStatus()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarDicionarioEAP&codigo=<%=dicionarioEAP.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirDicionarioEAP&codigo=<%=dicionarioEAP.getCodigo()%>'><img
