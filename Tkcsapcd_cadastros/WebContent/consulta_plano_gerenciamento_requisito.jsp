...
<%@page import="br.com.tkcsapcd.model.bean.PlanoGerenciamentoRequisito"%>
...
<title>Consultar Plano de Gerenciamento dos Requisitos</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Plano de Gerenciamento dos Requisitos</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_plano_gerenciamento_requisito.jsp"
				...
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					<thead>
						<tr>
							...
							<th>Plano Gerenciamento Requisito</th>
							<th>Versão</th>
							<th>Data</th>
							<th>Autor</th>
					...
					<tbody>
							<%
								List<PlanoGerenciamentoRequisito> planoGerenciamentoRequisitos = (List<PlanoGerenciamentoRequisito>) request.getAttribute("planoGerenciamentoRequisitos");
								for (PlanoGerenciamentoRequisito planoGerenciamentoRequisito : planoGerenciamentoRequisitos) {
							%>
						<tr>							
							<td><%=planoGerenciamentoRequisito.getProjetoinicio().getCodigo()%></td>
							<td><%=planoGerenciamentoRequisito.getPlanogerenciamentorequisito()%></td>
							<td><%=planoGerenciamentoRequisito.getVersao()%></td>
							<td><%=planoGerenciamentoRequisito.getData()%></td>
							<td><%=planoGerenciamentoRequisito.getAutor()%></td>
							<td><%=planoGerenciamentoRequisito.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarPlanoGerenciamentoRequisito&codigo=<%=planoGerenciamentoRequisito.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirPlanoGerenciamentoRequisito&codigo=<%=planoGerenciamentoRequisito.getCodigo()%>'><img
