			...
			<fieldset>
				...
				<div class="bs-example">
				    <div class="alert alert-info fade in">
				        ...
				        <strong>Nota!</strong> O plano de gerenciamento do projeto, é a principal referência para a equipe do projeto. Descreve, junto com seus planos auxiliares, como os processos serão executados, controlados, monitorados e encerrados. 
				    </div>
				            ...
				            <div class="modal-content">
				                ...
				                <div class="modal-body">
				                    ...
				                    <div class="lots-of-text" align="left">
				                    	O plano de gerenciamento do projeto integra e consolida todos os planos de gerenciamento auxiliares e linhas de base dos processos de planejamento, incluindo, mas não estando limitado a: <br>

										O ciclo de vida selecionado para o projeto e os processos que serão aplicados a cada fase;<br>
										Resultados das adequações feitas pela equipe de gerenciamento do projeto;<br>
										Como o trabalho será executado para completar os objetivos do projeto;<br>
										Um plano de gerenciamento de mudanças que documenta como as mudanças serão monitoradas e controladas;<br><br>
										
										Saída de: Desenvolver o plano de gerenciamento do projeto<br><br>
										
										Entrada para:<br>										
										Orientar e gerenciar o trabalho do projeto<br>
										Monitorar e controlar o trabalho do projeto<br>
										Realizar o controle integrado de mudanças<br>
										...
										Gerenciar as comunicações<br>
										Controlar as comunicações<br>
										Controlar os riscos<br>
										Conduzir as aquisições<br>
										Controlar as aquisições<br>
										Encerrar as aquisições<br>
				                    </div>
				                </div>
