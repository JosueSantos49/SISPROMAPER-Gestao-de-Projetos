<!-- 
	...
	Ano: 2015
 -->
<%@page import="br.com.tkcsapcd.model.bean.ListaMarcos"%>
...
<title>Consultar Lista dos Marcos</title>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000); tamanhooriginal(); setFocus();">
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Lista dos Marcos</font>
				</p>
			</div>
			<br>
			...
			<div align="left">
				...
				<form id="formConsProjeto" name="formConsProjeto" method="post"
					action="pesquisar_liesta_marcos.jsp"
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tbody>
							<%
								List<ListaMarcos> listaMarcoss = (List<ListaMarcos>) request.getAttribute("listaMarcoss");
								for (ListaMarcos listaMarcos : listaMarcoss) {
							%>
						<tr>							
							<td><%=listaMarcos.getCodigoprojeto()%></td>
							<td><%=listaMarcos.getProjeto()%></td>
							<td><%=listaMarcos.getListamarcos()%></td>
							<td><%=listaMarcos.getVersao()%></td>
							<td><%=listaMarcos.getData()%></td>
							<td><%=listaMarcos.getAutor()%></td>
							<td><%=listaMarcos.getNotarevisao()%></td>
							<td><a class="link_atualizar"
								href='TkcsapcdController?cmd=editarListaMarcos&codigo=<%=listaMarcos.getCodigo()%>'><img
									alt="" title="Atualizar" height="20" width="27"
									src="img/alterar.gif"></a></td>
							<td><a class="link_delete"
								href='TkcsapcdController?cmd=excluirListaMarcos&codigo=<%=listaMarcos.getCodigo()%>'><img
