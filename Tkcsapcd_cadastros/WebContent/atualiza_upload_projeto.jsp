...
<title>Atualizar Upload de Arquivo Projeto</title>
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#dataregistro").mask("9999-99-99"); //9999-99-99 
	});
</script>
...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 2000);" >
	...
	<div align="center">
		...
		<form action="AtualizarUploadProjeto.do" id="formulario" name="formulario" enctype="multipart/form-data" method="post"> 
		
		<input type="hidden" name="id" value="${param.id}"></input><!-- Parametro que veio na modificação -->	
			...
			<fieldset>
				...
				<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
					...
					<tr class="field">
						...
						<p align="justify">
								<input type="text" name="description" id="description" value="${fileBeanProjeto.description}"
								       required="true" style="height: 30px; width: 379px" maxlength="150" class="input"><br/>
					...
					<tr class="field">
						...
						<p align="justify">
								<input type="text" name="codigoprojeto" id="codigoprojeto" value="${fileBeanProjeto.codigoprojeto}" 
										required="true" style="height: 30px; width: 150px" maxlength="150" class="input"><br/>
					...
					<tr class="field">
						...
						<p align="justify">
								...
								onkeyup="mostrarResultadoEtapa1(this.value,400,'spcontando0');contarCaracteresEtapa1(this.value,400,'sprestante0')">${fileBeanProjeto.comentario}</textarea>
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="dataregistro" name="dataregistro" value="${fileBeanProjeto.dataregistro}"
					...
					<tr class="field">
						...
						<p align="justify">
								<input type="text" name="email" id="email" value="${fileBeanProjeto.email}"
				...
				<br>
				 <input type="submit" value="Atualizar" class="prev acao" onclick="show_confirm();"/>
			</fieldset>
		</form>
	</div>
