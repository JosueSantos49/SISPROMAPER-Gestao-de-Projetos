...
<script language="javascript" src="js/TexteareCadastroStatus.js"></script>
...
<%@include file="menuperantecssadm.jsp" %>
	...
	<div align="center">
		...
		<form  action="TkcsapcdController" id="formulario" name="formulario"	onSubmit="validaCadastroStatuss()" ><!-- onclick="validaCadastroStatuss()" --><br>
				
				<fieldset>	
				
				<table width="100%" class="table table-striped"><tr class="success"><th bgcolor="#FFFF00"><font size="3">STATUS DO PROJETO - PROJECT CHARTER</font></th></tr></table><br>	
				...
				<input type="hidden" name="cmd" value="atualizarStatuss"></input>
				...
				<table	border="0" cellspacing="3" cellpadding="3" width="80%" bgcolor="#FFFFFF">	
					...
					<tr class="field">
						...
						<p align="justify">
								<input id="codigodoprojeto" name="codigodoprojeto"
									style="height: 30px; width: 300px"
									Placeholder=""
									value="${statuss.codigodoprojeto}" class="input" required="true"
				...
				<tr>
					...
					<p align="justify"><input id="percentualevolucao" name="percentualevolucao" style="height: 30px; width: 379px" class="input"
				...
				<tr>
					...
					<p align="justify"><input id="percentualplanejado" name="percentualplanejado" style="height: 30px; width: 379px" class="input"
				...
				<tr>
				 ...
				 <tr>
				 	...
				 	<p align="justify">
				 		<textarea rows="5" cols="70" id="descricao" name="descricao" onkeyup="mostrarResultadoDescricao(this.value,400,'spcontando0');contarCaracteresDescricao(this.value,400,'sprestante0')" required="true">${statuss.descricao}</textarea>
				 		<br><br>
				...
				<tr>
					...
					<p align="justify">
							<textarea id="pontospositivos" rows="5" cols="70" name="pontospositivos" onkeyup="mostrarResultado(this.value,300,'spcontando');contarCaracteres(this.value,300,'sprestante')" required="true">${statuss.pontospositivos}</textarea>
					 		<br><br>
				...
				<tr>
					...
					<p align="justify">
						<textarea id="pontosnegativos" rows="5" cols="70" name="pontosnegativos" onkeyup="mostrarResultadoQualitativo(this.value,300,'spcontando1');contarCaracteresQualitativo(this.value,300,'sprestante1')" required="true">${statuss.pontosnegativos}</textarea>
				 		<h5 align="left"><font size="1" color="#6C7B8B"><span id="spcontando0" style="font-family:Arial;"></span></font></h5>
							<h5 align="left"><font size="1" color="#6C7B8B"><span id="sprestante0" style="font-family:Arial;"></span></font></h5>
				 	</td>
				</tr>
				...
				<tr>
					<td><p align="justify"><b>Tendência <font color="red">*</font></b>
					<p align="justify"><input id="tendencia" name="tendencia" style="height: 30px; width: 379px;" class="input"
						value="${statuss.tendencia}" required="true"></input>
					</td>
				</tr>
				<tr>
					<td><br></td>					
