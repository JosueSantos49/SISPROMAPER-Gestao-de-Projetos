...
<title>Solicitação Recuperar Acesso</title>
...
<div id="preloader"><h1><img src="img/loader.gif" height="70px"></h1></div>	
				...
				<div align="center" class="container">
					...
					<form class="rounded" action="TkcsapcdController"	id="formSolicitacaoCadastro" name="formSolicitacaoCadastro"  onsubmit="validaSolicitacaoAcesso();"><!-- onclick="valida_form();" onsubmit="valida_form();" -->
										
					<h3>Recuperar Acesso - SisproMaper</h3><br>
					
					<center><h5><font color="red"> ${mensagem}</font></h5></center><br>
