...
<body onload="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 3000);" >
       
       <button id="waitingDialog" type="button" class="btn btn-primary" onclick="waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 3000);">Show dialog</button>        
