...
<title>Consultar Lista de Arquivos Ajuda</title>
...
<body>
	...
	<div id="conteudo">
		...
		<div align="justify">
			...
			<div align="center">
				<p>
					<font color="red">Consultar Lista de Arquivo Ajuda</font>
				</p>
			</div>
			...
			<div class="table-responsive">
				<table id="tabela" cellspacing="5" cellspacing="5" class="display">
					...
					<tr>
						...
						<td><a class="link_delete" href='TkcsapcdController?cmd=excluirFileBeanAjuda&codigo=<%=fileBeanAjuda.getId()%>'><img alt="" title="Excluir" height="20" width="27" src="img/delete.gif"></a></td>
