...
<title>Atualizar Fornecedor Qualificado</title>
				        ...
				        <div class="col-md-10">                             
				          <div class="ajax" style="position: relative; overflow: hidden">            
							...
							Olá, 
				        		...
				        		<p class="muted"><font color="red">Clique para atualizar fornecedor qualificado!</font></p>           
				            	<button type="button" class="demo btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">Atualizar Fornecedor</button>
							...
							<!-- Modal Relatório -->
								<div class="container">							
								  ...
								  <form action="TkcsapcdController" id="formulario">
								       ...
								       <input type="hidden" name="cmd" value="atualizarFornecedorQualificado"></input>
								        			...
								        			<fieldset>
														...
														<table border="0" cellspacing="3" cellpadding="3" width="80%"	bgcolor="#FFFFFF">
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="razaosocial" name="razaosocial" value="${fornecedorQualificado.razaosocial}" required="true"
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="telefone" name="telefone" value="${fornecedorQualificado.telefone}"
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		<input id="fax" name="fax" value="${fornecedorQualificado.fax}"
																			style="height: 30px; width: 150px"
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="endereco" name="endereco" value="${fornecedorQualificado.endereco}"
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="bairro" name="bairro" value="${fornecedorQualificado.bairro}"
																			style="height: 30px; width: 379px"
																			Placeholder="" 
																			class="input" 
															...
															<tr class="field">
																...
																<p align="justify">
																		<select id="estado" name="estado" value="${fornecedorQualificado.estado}">${fornecedorQualificado.estado}</select>
															...
															<tr class="field">
																...
																<p align="justify">
																		<select id="cidade" name="cidade" value="${fornecedorQualificado.cidade}">${fornecedorQualificado.cidade}</select>
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="cep" name="cep" value="${fornecedorQualificado.cep}"
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="cnpj" name="cnpj" value="${fornecedorQualificado.cnpj}" 
																			required="true"
																			style="height: 30px; width: 150px"
																			class="input" 
																			onkeypress="return numbers(event);"></input>
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="inscricaoestadual" name="inscricaoestadual" value="${fornecedorQualificado.inscricaoestadual}"
																			style="height: 30px; width: 379px"
																			Placeholder=""
																			class="input" ></input>
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="inscricaomunicipal" name="inscricaomunicipal" value="${fornecedorQualificado.inscricaomunicipal}"
																			style="height: 30px; width: 379px"
																			Placeholder=""
																			class="input" ></input>
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="contato" name="contato" value="${fornecedorQualificado.contato}"
																			style="height: 30px; width: 379px"
																			class="input" ></input>
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="nomefantasia" name="nomefantasia" value="${fornecedorQualificado.nomefantasia}"
																			style="height: 30px; width: 379px"
																			class="input" ></input>
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="celular" name="celular" value="${fornecedorQualificado.celular}"
																			style="height: 30px; width: 150px"
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="email" name="email" value="${fornecedorQualificado.email}"
																			style="height: 30px; width: 379px"
																			class="input" ></input>
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="homepage" name="homepage" value="${fornecedorQualificado.homepage}"
																			style="height: 30px; width: 379px"
																			class="input" ></input>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa1(this.value,600,'spcontando0');contarCaracteresEtapa1(this.value,600,'sprestante0')">${fornecedorQualificado.produtos}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																	<font color="blue"></font>
																		...
																		onkeyup="mostrarResultadoEtapa2(this.value,600,'spcontando');contarCaracteresEtapa2(this.value,600,'sprestante')">${fornecedorQualificado.marcas}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa3(this.value,600,'spcontando1');contarCaracteresEtapa3(this.value,600,'sprestante1')">${fornecedorQualificado.contratosocial}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="banco" name="banco" value="${fornecedorQualificado.banco}"
																			style="height: 30px; width: 150px"
																			class="input" onkeypress="return numbers(event);"></input>
																	<p class="hint">[Informar o Celular.]</p>
															</tr>
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="agencia" name="agencia" value="${fornecedorQualificado.agencia}"
																			style="height: 30px; width: 150px"
																			class="input" onkeypress="return numbers(event);"></input>
																	<p class="hint">[Informar o Celular.]</p>
															</tr>
															...
															<tr class="field">
																...
																<p align="justify">
																		<input id="conta" name="conta" value="${fornecedorQualificado.conta}"
																			style="height: 30px; width: 150px"
																			class="input" onkeypress="return numbers(event);"></input>
																	<p class="hint">[Informar o Celular.]</p>
															</tr>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa4(this.value,600,'spcontando2');contarCaracteresEtapa4(this.value,600,'sprestante2')">${fornecedorQualificado.cartaocnpj}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa5(this.value,600,'spcontando3');contarCaracteresEtapa5(this.value,600,'sprestante3')">${fornecedorQualificado.fazendafederal}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa6(this.value,600,'spcontando4');contarCaracteresEtapa6(this.value,600,'sprestante4')">${fornecedorQualificado.fazendaestadual}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa7(this.value,600,'spcontando5');contarCaracteresEtapa7(this.value,600,'sprestante5')">${fornecedorQualificado.fazendamunicipal}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa8(this.value,600,'spcontando6');contarCaracteresEtapa8(this.value,600,'sprestante6')">${fornecedorQualificado.inss}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa9(this.value,600,'spcontando7');contarCaracteresEtapa9(this.value,600,'sprestante7')">${fornecedorQualificado.fgts}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa10(this.value,600,'spcontando8');contarCaracteresEtapa10(this.value,600,'sprestante8')">${fornecedorQualificado.capacidadetecnica}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa11(this.value,600,'spcontando9');contarCaracteresEtapa11(this.value,600,'sprestante9')">${fornecedorQualificado.relacaocliente}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa12(this.value,600,'spcontando10');contarCaracteresEtapa12(this.value,600,'sprestante10')">${fornecedorQualificado.referenciacomenrcail}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa16(this.value,600,'spcontando14');contarCaracteresEtapa16(this.value,600,'sprestante14')">${fornecedorQualificado.registro}</textarea>
															...
															<tr class="field">
																...
																<p align="justify">
																		...
																		onkeyup="mostrarResultadoEtapa17(this.value,600,'spcontando15');contarCaracteresEtapa17(this.value,600,'sprestante15')">${fornecedorQualificado.certidaonegativa}</textarea>
														...
														<br>
														<br> 
														<input class="prev acao" type="submit" value="Atualizar" onclick="show_confirm();" onchange="validaCadastrarRiscos();"/>													
